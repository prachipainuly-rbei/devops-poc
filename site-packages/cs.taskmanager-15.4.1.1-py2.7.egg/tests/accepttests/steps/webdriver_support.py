...
__revision__ = "$Id: webdriver_support.py 182922 2018-08-28 08:44:43Z cso $"
...
class WebDriver(object):
    ...
    def WaitUntilModalClosed(self):
        ...
        timeout = 1
        modal = self.GetElement(byClass="modal", timeout=timeout)
        if modal:
            try:
                self.WaitUntilInvisible(modal, timeout=timeout)
    ...
    def WaitUntilVisible(self, element):
        """
    ...
    def GetElement(self, timeout=None, multi=None, **kwargs):
        ...
        +---------------+---------------------+---------------------+
        | Key           | find_element_by_... | find_element_by_... |
