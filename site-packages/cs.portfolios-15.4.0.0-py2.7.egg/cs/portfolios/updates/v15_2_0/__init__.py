...
class UpdateCatalogs(object):
    ...
    def update_catalogs(self):
        self.reset_catalog(classname='cdb_portfolio', attrs_to_update=['name_de', 'name_en'])
        self.reset_catalog(classname='cdb_portfolio_category', attrs_to_update=['name_de', 'name_en'])
