...
class UpdateCatalogs(object):
    ...
    def update_catalogs(self):
        self.reset_catalog(classname='cdb_mod_event', attrs_to_update=['event_de', 'event_en'])
        self.reset_catalog(classname='cdb_mod_kind', attrs_to_update=['kind_de', 'kind_en'])
        self.reset_catalog(classname='cdb_mod_source', attrs_to_update=['source_de', 'source_en'])
...
class UpdateRelshipAccessProfiles(object):
    ...
    def update_rs_acc_prof(self):
        # cs.documents
        self._update_rs_acc_prof("Änderungsmitteilung", "Change Notification")
