...
__revision__ = "$Id: __init__.py 140374 2016-04-26 09:36:31Z cso $"
...
class InitNotificationSettings(object):
    ...
    def run(self):
        """
        copy defaults and user settings from user.email_daily_as (cs.shared)
        """
            ...
            for table in self.__tables__:
                ...
                try:
                    sqlapi.SQLinsert(
                        ...
                        "WHERE setting_id='user.email_daily_as'"
