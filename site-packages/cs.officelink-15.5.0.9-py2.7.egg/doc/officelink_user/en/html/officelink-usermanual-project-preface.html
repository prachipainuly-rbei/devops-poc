...
<head>
  ...
  <title>Introduction &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Editing documents" href="officelink-usermanual-project-documents.html"/>
...
<span id="officelink-usermanual-project-intro"></span><h1>Introduction<a class="headerlink" href="#einfuhrung" title="Permalink to this headline">¶</a></h1>
<ul>
<li><p class="first"><span class="guilabel">Project interface:</span></p>
<p>The installation extends the Project application by adding the OfficeLink toolbar.</p>
...
<p class="caption"><span class="caption-text">Project: OfficeLink menu bar</span></p>
</div>
</li>
<li><p class="first"><span class="guilabel">Standard operations:</span></p>
<p>The system Microsoft Office integration provides Project with the option of searching for documents in the system, opening them for editing and then saving changes in the database. Moreover, it is possible to change the document status or properties, or create new documents in the system directly from Project.</p>
</li>
<li><p class="first"><span class="guilabel">Project synchronization:</span></p>
<p>The system integration for Microsoft Office enables projects that are managed by the system PCS to be edited from Microsoft Project. Project data is synchronized partly bidirectionally in the process.</p>
</li>
...
<div class="toctree-wrapper compound">
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-project-documents.html" class="btn btn-neutral float-right" title="Editing documents" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
