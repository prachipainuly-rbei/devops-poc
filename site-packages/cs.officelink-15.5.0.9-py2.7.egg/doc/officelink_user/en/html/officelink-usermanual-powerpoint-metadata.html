...
<head>
  ...
  <title>Synchronizing data &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="PowerPoint" href="officelink-usermanual-powerpoint.html"/>
        <link rel="next" title="Metadata takeover from the system" href="officelink-usermanual-powerpoint-metadata-syncread.html"/>
        <link rel="prev" title="Opening master data change dialog in the system" href="officelink-usermanual-powerpoint-documents-properties.html"/> 
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Synchronizing data</a></li>
</ul>
</li>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Synchronizing data</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Synchronizing data</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-usermanual-powerpoint-metadata.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="daten-abgleichen">
<span id="officelink-usermanual-powerpoint-metadata"></span><h1>Synchronizing data<a class="headerlink" href="#daten-abgleichen" title="Permalink to this headline">¶</a></h1>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-powerpoint-metadata-syncread.html">Metadata takeover from the system</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-powerpoint-metadata-syncwrite.html">Metadata synchronization with the system</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-powerpoint-metadata-template.html">Create templates for data synchronization</a><ul>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-powerpoint-metadata-template.html#formatbeschreibung-fur-system-variablen">Format description for system variables</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-powerpoint-metadata-template.html#definition-von-system-variablen">Definition of system variables</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-powerpoint-metadata-template.html#andern-von-system-variablen">Modifying system variables</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-powerpoint-metadata-template.html#verwendung-von-system-variablen-im-dokument">Using system variables in the document</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-powerpoint-metadata-template.html#automatisches-aktualisieren-von-metadaten">Updating metadata automatically</a></li>
</ul>
</li>
</ul>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-powerpoint-metadata-syncread.html" class="btn btn-neutral float-right" title="Metadata takeover from the system" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-powerpoint-documents-properties.html" class="btn btn-neutral" title="Opening master data change dialog in the system" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
