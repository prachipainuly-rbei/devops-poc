...
<head>
  ...
  <title>Editing documents &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Searching for documents in the system" href="officelink-usermanual-word-documents-load.html"/>
        <link rel="prev" title="Introduction" href="officelink-usermanual-word-preface.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Editing documents</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-usermanual-word-documents.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-usermanual-word-documents"></span><h1>Editing documents<a class="headerlink" href="#dokumente-bearbeiten" title="Permalink to this headline">¶</a></h1>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-word-documents-load.html">Searching for documents in the system</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-word-documents-save.html">Save in the system</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-word-documents-create.html">Create in the system</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-word-documents-createindex.html">Create index in the system</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-word-documents-status.html">Change document status</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-word-documents-properties.html">Opening master data change dialog in the system</a></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-word-documents-load.html" class="btn btn-neutral float-right" title="Searching for documents in the system" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-word-preface.html" class="btn btn-neutral" title="Introduction" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
