...
<head>
  ...
  <title>Publishing Microsoft Project plans to the PCS system &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Project synchronization" href="officelink-usermanual-project-sync.html"/>
        <link rel="next" title="Updating of task attributes from the system PCS" href="officelink-usermanual-project-sync-updating.html"/>
        <link rel="prev" title="Function" href="officelink-usermanual-project-sync-preface.html"/> 
...
<li class="toctree-l2 current"><a class="reference internal" href="officelink-usermanual-project-sync.html">Project synchronization</a></li>
</ul>
</li>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Synchronizing data</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="officelink-usermanual-project-sync.html">Project synchronization</a> &raquo;</li>
      
    <li>Publishing Microsoft Project plans to the PCS system</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-usermanual-project-sync-publishing.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="veroffentlichen-von-microsoft-project-projektplanen-im-system-pcs">
<span id="officelink-usermanual-project-sync-publishing"></span><h1>Publishing Microsoft Project plans to the PCS system<a class="headerlink" href="#veroffentlichen-von-microsoft-project-projektplanen-im-system-pcs" title="Permalink to this headline">¶</a></h1>
<p>By &#8220;Publish&#8221; the project structure stored in the PCS system can be updated by the Microsoft Project plan. The changes to the project plan are transferred to the configured system relations, new tasks are created accordingly and deleted tasks are removed from the project structure. After successfully importing resp. updating in the PCS system, both project plans have the same status.</p>
<p>During this data reconciliation, the changed Microsoft Project plan is stored in the system and is also exported in Microsoft Project XML format and stored as an XML file next to the project plan in the system. Afterwards, an import process is automatically executed in the system using the XML file just created. For more information about the preview dialog that now opens, refer to the Projects User Manual.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-project-sync-updating.html" class="btn btn-neutral float-right" title="Updating of task attributes from the system PCS" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-project-sync-preface.html" class="btn btn-neutral" title="Function" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
