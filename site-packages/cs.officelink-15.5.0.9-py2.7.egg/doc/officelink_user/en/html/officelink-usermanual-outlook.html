...
<head>
  ...
  <title>Outlook &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="next" title="Introduction" href="officelink-usermanual-outlook-preface.html"/>
        <link rel="prev" title="Running PowerReports" href="officelink-usermanual-excel-powerreports-execution.html"/> 
...
<span id="officelink-usermanual-outlook"></span><span id="helpid-officelink-usermanual-outlook"></span><h1>Outlook<a class="headerlink" href="#outlook" title="Permalink to this headline">¶</a></h1>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-outlook-preface.html">Introduction</a><ul class="simple">
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-outlook-mails.html">E-mails and attachments</a><ul>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-outlook-archivemail.html">Create messages in the system</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-outlook-attachdoc.html">Append system documents as message attachment</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-outlook-cdbclient-mailexport.html">Messages from the document export function of CIM Database/WIN</a></li>
</ul>
</li>
</ul>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-outlook-preface.html" class="btn btn-neutral float-right" title="Introduction" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-excel-powerreports-execution.html" class="btn btn-neutral" title="Running PowerReports" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
