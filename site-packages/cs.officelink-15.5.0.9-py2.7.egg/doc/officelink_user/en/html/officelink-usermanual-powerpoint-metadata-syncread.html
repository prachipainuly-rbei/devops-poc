...
<head>
  ...
  <title>Metadata takeover from the system &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Metadata synchronization with the system" href="officelink-usermanual-powerpoint-metadata-syncwrite.html"/>
        <link rel="prev" title="Synchronizing data" href="officelink-usermanual-powerpoint-metadata.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Synchronizing data</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Metadata takeover from the system</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-usermanual-powerpoint-metadata-syncread.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="metadatenubernahme-aus-dem-system">
<span id="officelink-usermanual-powerpoint-metadata-syncread"></span><h1>Metadata takeover from the system<a class="headerlink" href="#metadatenubernahme-aus-dem-system" title="Permalink to this headline">¶</a></h1>
<p>By pressing the <span class="guilabel">[ Transfer [read] ]</span> button, the values of all system variables with read access are updated with the corresponding values of the associated system attributes. This overwrites system variables with read access changed by the user in the document. If an error exists in the expression of a variable, the referenced object does not exist or the relationship is not unique, the value is set to a space character.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-powerpoint-metadata-syncwrite.html" class="btn btn-neutral float-right" title="Metadata synchronization with the system" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-powerpoint-metadata.html" class="btn btn-neutral" title="Synchronizing data" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
