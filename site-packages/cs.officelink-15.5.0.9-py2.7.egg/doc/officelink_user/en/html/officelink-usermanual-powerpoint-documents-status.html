...
<head>
  ...
  <title>Change document status &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Opening master data change dialog in the system" href="officelink-usermanual-powerpoint-documents-properties.html"/>
        <link rel="prev" title="Create index in the system" href="officelink-usermanual-powerpoint-documents-createindex.html"/> 
...
<span id="officelink-usermanual-powerpoint-documents-status"></span><h1>Change document status<a class="headerlink" href="#dokumentenstatus-andern" title="Permalink to this headline">¶</a></h1>
<p>The <span class="guilabel">[ Change status ]</span> button carries out a status change operation in the system for the active document.</p>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">Since the user potentially loses the rights to re-save the document in the system by changing the status, the link saves the document automatically before calling up the status change operation. If necessary, a corresponding message is displayed here that you have to confirm.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-powerpoint-documents-properties.html" class="btn btn-neutral float-right" title="Opening master data change dialog in the system" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-powerpoint-documents-createindex.html" class="btn btn-neutral" title="Create index in the system" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
