...
<head>
  ...
  <title>Create index in the system &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Change document status" href="officelink-usermanual-project-documents-status.html"/>
        <link rel="prev" title="Create in the system" href="officelink-usermanual-project-documents-create.html"/> 
...
<span id="officelink-usermanual-project-documents-createindex"></span><h1>Create index in the system<a class="headerlink" href="#index-erzeugen-im-system" title="Permalink to this headline">¶</a></h1>
<p>The <span class="guilabel">[ Create index ]</span> button creates a new index in the system for the active document. This process initially opens the mask for creating indices. After filling out and confirming the index mask, the current changes are backed up in the new document index in the system.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-project-documents-status.html" class="btn btn-neutral float-right" title="Change document status" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-project-documents-create.html" class="btn btn-neutral" title="Create in the system" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
