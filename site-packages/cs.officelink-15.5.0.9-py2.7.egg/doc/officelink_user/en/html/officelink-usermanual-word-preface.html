...
<head>
  ...
  <title>Introduction &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Editing documents" href="officelink-usermanual-word-documents.html"/>
...
<span id="officelink-usermanual-word-intro"></span><h1>Introduction<a class="headerlink" href="#einfuhrung" title="Permalink to this headline">¶</a></h1>
<ul>
<li><p class="first"><span class="guilabel">Word interface:</span></p>
<p>The installation expands the Word application by adding the OfficeLink toolbar.</p>
...
<p class="caption"><span class="caption-text">Word: OfficeLink menu bar</span></p>
</div>
</li>
<li><p class="first"><span class="guilabel">Standard operations:</span></p>
<p>The system Microsoft Office integration provides Word with the option of searching for documents in the system, opening them for editing and then saving changes in the database. Moreover, it is possible to change the document status or properties, or create new documents in the system directly from Word.</p>
</li>
<li><p class="first"><span class="guilabel">Data synchronization:</span></p>
<p>The link gives you the ability to synchronize data with the system. A prerequisite for this is the use of prepared document templates which contain corresponding system variables (see <a class="reference internal" href="officelink-usermanual-word-metadata-template.html#officelink-usermanual-word-metadata-template"><span class="std std-ref">Create templates for data synchronization</span></a>). Data synchronization is always carried out for the active document. The active document has to have been opened from the system for editing.</p>
</li>
...
<div class="toctree-wrapper compound">
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-word-documents.html" class="btn btn-neutral float-right" title="Editing documents" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
