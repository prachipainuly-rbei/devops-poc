...
<head>
  ...
  <title>Create templates for data synchronization &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Synchronizing data" href="officelink-usermanual-powerpoint-metadata.html"/>
        <link rel="next" title="Project" href="officelink-usermanual-project.html"/>
        <link rel="prev" title="Metadata synchronization with the system" href="officelink-usermanual-powerpoint-metadata-syncwrite.html"/> 
...
<li class="toctree-l1 current"><a class="reference internal" href="officelink-usermanual-powerpoint.html">PowerPoint</a><ul class="current">
...
<li class="toctree-l2 current"><a class="reference internal" href="officelink-usermanual-powerpoint-metadata.html">Synchronizing data</a></li>
</ul>
</li>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Synchronizing data</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="officelink-usermanual-powerpoint.html">PowerPoint</a> &raquo;</li>
      
          <li><a href="officelink-usermanual-powerpoint-metadata.html">Synchronizing data</a> &raquo;</li>
      
    <li>Create templates for data synchronization</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-usermanual-powerpoint-metadata-template.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-usermanual-powerpoint-metadata-template"></span><h1>Create templates for data synchronization<a class="headerlink" href="#vorlagen-zum-datenabgleich-erstellen" title="Permalink to this headline">¶</a></h1>
...
<span id="officelink-usermanual-powerpoint-metadata-template-format"></span><h2>Format description for system variables<a class="headerlink" href="#formatbeschreibung-fur-system-variablen" title="Permalink to this headline">¶</a></h2>
<p>System variables in PowerPoint documents have the following format: cdb.&lt;Mode&gt;.&lt;Relation&gt;.&lt;Attribute&gt;.&lt;Cardinality&gt;</p>
<dl class="docutils">
...
<p>If a <em>s</em> is added to the above-mentioned mode values (i. e. <em>rs</em>, <em>ws</em> or <em>rws</em>), then the same rules apply as for the respective values without <em>s</em>, but the read/write actions run completely on the server side. The <em>Parameter</em> field can be used optionally. You might, however, you need administrative customizing to use server-side editing of variables, which is explained in the OfficeLink Administration Manual.</p>
</li>
</ul>
</dd>
...
<li><p class="first"><span class="guilabel">Name of a relationship configured in the system</span></p>
...
<p class="rubric">PowerPoint: data synchronization - subject characteristics qualified</p>
...
<div class="example container">
<p class="rubric">PowerPoint: data synchronization - subject characteristics unqualified</p>
...
<dd><p class="first">This field can be used to pass additional constant values specific to the respective variable when processing variables on the server side. These can be identifiers, for example, that allow you to link results from 1: N relationships with individual document fields instead of dynamic lists. For example, the parameter <em>PRIMARY</em> is added to the following variable, which tells a user exit that you want to have the original source name of the document&#8217;s primary file.</p>
...
<span id="officelink-usermanual-powerpoint-metadata-template-definition"></span><h2>Definition of system variables<a class="headerlink" href="#definition-von-system-variablen" title="Permalink to this headline">¶</a></h2>
<p>System variables are defined using a wizard that calls up the OfficeLink toolbar using the <span class="guilabel">[ Manage ]</span> button. The button has to have been enabled beforehand in the settings dialog so that the button is available. The dialog provides the option of creating new variables in the system format on the left side (see <a class="reference internal" href="#officelink-usermanual-powerpoint-metadata-template-format"><span class="std std-ref">Format description for system variables</span></a>). On the right side, all system variables contained in the document are displayed. By marking a variable, the corresponding text field is marked in the PowerPoint document at the same time. The marked variables are removed from the document by pressing the <span class="guilabel">[ Delete variable ]</span> button.</p>
<div class="figure align-center" id="id1">
<span id="officelink-usermanual-powerpoint-metadata-template-definition-dialog"></span><img alt="_images/powerpoint2007_docvar_dialog.png" src="_images/powerpoint2007_docvar_dialog.png" />
<p class="caption"><span class="caption-text">PowerPoint: data synchronization - dialog for creating system variables</span></p>
</div>
<ul>
...
<p>r: read only</p>
<p>w: write only</p>
<p>rw: read and write access in the system</p>
<p>rs: server-side read only</p>
<p>ws: server-side write only</p>
<p>rws: server-side read and write access in the system</p>
</li>
<li><p class="first"><span class="guilabel">Parameter:</span></p>
<p>Optional value used only for server-side editing of variables.</p>
</li>
...
<p class="first admonition-title">Important</p>
<p class="last">The system variables can be positioned only in simple PowerPoint &#8216;forms&#8217;. Furthermore, only one system variable can be defined per PowerPoint form. An error message appears if there is an attempt to define a new variable without the simple form being enabled, or if the currently enabled form already contains a variable.</p>
</div>
</div>
<div class="section" id="andern-von-system-variablen">
<span id="officelink-usermanual-powerpoint-metadata-template-change"></span><h2>Modifying system variables<a class="headerlink" href="#andern-von-system-variablen" title="Permalink to this headline">¶</a></h2>
...
<span id="officelink-usermanual-powerpoint-metadata-template-usage"></span><h2>Using system variables in the document<a class="headerlink" href="#verwendung-von-system-variablen-im-dokument" title="Permalink to this headline">¶</a></h2>
...
<span id="officelink-usermanual-powerpoint-metadata-template-autoupdate"></span><h2>Updating metadata automatically<a class="headerlink" href="#automatisches-aktualisieren-von-metadaten" title="Permalink to this headline">¶</a></h2>
...
<li><p class="first">Is not a template (i.e. &#8220;vorlage_kz=0&#8221;)</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-project.html" class="btn btn-neutral float-right" title="Project" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-powerpoint-metadata-syncwrite.html" class="btn btn-neutral" title="Metadata synchronization with the system" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
