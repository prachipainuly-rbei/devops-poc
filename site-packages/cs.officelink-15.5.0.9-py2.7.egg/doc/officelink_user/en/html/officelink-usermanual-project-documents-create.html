...
<head>
  ...
  <title>Create in the system &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Create index in the system" href="officelink-usermanual-project-documents-createindex.html"/>
        <link rel="prev" title="Save in the system" href="officelink-usermanual-project-documents-save.html"/> 
...
<span id="officelink-usermanual-project-documents-create"></span><h1>Create in the system<a class="headerlink" href="#neuanlage-im-system" title="Permalink to this headline">¶</a></h1>
<p>The <span class="guilabel">[ Create ]</span> button carries out a document creation in the system for the active document. This process initially opens the mask for creating documents. After filling out and confirming the create mask, the document is committed to the system and finally re-opened from the system for editing. The original document is closed after the create is successful. In the case of an error, for example due to deficient authorizations in the system, the document remains open.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-project-documents-createindex.html" class="btn btn-neutral float-right" title="Create index in the system" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-project-documents-save.html" class="btn btn-neutral" title="Save in the system" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
