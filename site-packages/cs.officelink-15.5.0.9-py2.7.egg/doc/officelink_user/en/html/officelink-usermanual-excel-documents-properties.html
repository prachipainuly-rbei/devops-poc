...
<head>
  ...
  <title>Opening master data change dialog in the system &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Synchronizing data" href="officelink-usermanual-excel-metadata.html"/>
        <link rel="prev" title="Change document status" href="officelink-usermanual-excel-documents-status.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Opening master data change dialog in the system</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-usermanual-excel-documents-properties.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-usermanual-excel-documents-properties"></span><h1>Opening master data change dialog in the system<a class="headerlink" href="#stammdatenanderungsdialog-im-system-offnen" title="Permalink to this headline">¶</a></h1>
<p>The <span class="guilabel">[ Master data ]</span> button opens the dialog in the system for changing the master data for the active document. This button is divided into two parts. The bottom part can be used in the system to open an information dialog for the active document instead of the modify dialog.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-excel-metadata.html" class="btn btn-neutral float-right" title="Synchronizing data" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-excel-documents-status.html" class="btn btn-neutral" title="Change document status" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
