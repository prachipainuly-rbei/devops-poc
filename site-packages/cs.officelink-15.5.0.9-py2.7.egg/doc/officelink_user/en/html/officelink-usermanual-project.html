...
<head>
  ...
  <title>Project &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="next" title="Introduction" href="officelink-usermanual-project-preface.html"/>
        <link rel="prev" title="Create templates for data synchronization" href="officelink-usermanual-powerpoint-metadata-template.html"/> 
...
<span id="officelink-usermanual-project"></span><span id="helpid-officelink-usermanual-project"></span><h1>Project<a class="headerlink" href="#project" title="Permalink to this headline">¶</a></h1>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-project-preface.html">Introduction</a><ul class="simple">
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-project-documents.html">Editing documents</a><ul>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-documents-load.html">Searching for documents in the system</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-documents-save.html">Save in the system</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-documents-create.html">Create in the system</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-documents-createindex.html">Create index in the system</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-documents-status.html">Change document status</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-documents-properties.html">Opening master data change dialog in the system</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-project-sync.html">Project synchronization</a><ul>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-sync-preface.html">Function</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-sync-publishing.html">Publishing Microsoft Project plans to the PCS system</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-sync-updating.html">Updating of task attributes from the system PCS</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-sync-notes.html">General tips</a></li>
</ul>
</li>
</ul>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-project-preface.html" class="btn btn-neutral float-right" title="Introduction" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-powerpoint-metadata-template.html" class="btn btn-neutral" title="Create templates for data synchronization" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
