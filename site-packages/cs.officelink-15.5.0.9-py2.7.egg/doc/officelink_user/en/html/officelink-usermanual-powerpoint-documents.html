...
<head>
  ...
  <title>Editing documents &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Searching for documents in the system" href="officelink-usermanual-powerpoint-documents-load.html"/>
        <link rel="prev" title="Introduction" href="officelink-usermanual-powerpoint-preface.html"/> 
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Editing documents</a></li>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Synchronizing data</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Editing documents</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-usermanual-powerpoint-documents.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="dokumente-bearbeiten">
<span id="officelink-usermanual-powerpoint-documents"></span><h1>Editing documents<a class="headerlink" href="#dokumente-bearbeiten" title="Permalink to this headline">¶</a></h1>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-powerpoint-documents-load.html">Searching for documents in the system</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-powerpoint-documents-save.html">Save in the system</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-powerpoint-documents-create.html">Create in the system</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-powerpoint-documents-createindex.html">Create index in the system</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-powerpoint-documents-status.html">Change document status</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-powerpoint-documents-properties.html">Opening master data change dialog in the system</a></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-powerpoint-documents-load.html" class="btn btn-neutral float-right" title="Searching for documents in the system" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-powerpoint-preface.html" class="btn btn-neutral" title="Introduction" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
