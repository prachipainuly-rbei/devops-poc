...
<head>
  ...
  <title>Create in the system &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Editing documents" href="officelink-usermanual-word-documents.html"/>
        <link rel="next" title="Create index in the system" href="officelink-usermanual-word-documents-createindex.html"/>
        <link rel="prev" title="Save in the system" href="officelink-usermanual-word-documents-save.html"/> 
...
<li class="toctree-l2 current"><a class="reference internal" href="officelink-usermanual-word-documents.html">Editing documents</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Synchronizing data</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="officelink-usermanual-word-documents.html">Editing documents</a> &raquo;</li>
...
<span id="officelink-usermanual-word-documents-create"></span><h1>Create in the system<a class="headerlink" href="#neuanlage-im-system" title="Permalink to this headline">¶</a></h1>
...
<p class="last">Since multiple file formats from the system are supported with Microsoft Word, the save format is determined there first, before the the system document management create mask is opened: <span class="guilabel">Use as default format:</span> Enabling this check box defines the selected format as the default save format. The selection dialog is no longer shown when creating documents in the future and the default save format is used instead. The default save format can be changed or removed in the settings dialog at any time. <span class="guilabel">Word Open XML file format and macros:</span> No macros can be saved in the .docx Open XML file format of Word. When attempting to save documents with macros in this format, a corresponding message is displayed.</p>
</div>
...
<p class="caption"><span class="caption-text">Microsoft Word: Save format selection dialog</span></p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-word-documents-createindex.html" class="btn btn-neutral float-right" title="Create index in the system" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-word-documents-save.html" class="btn btn-neutral" title="Save in the system" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
