...
<head>
  ...
  <title>General tips &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="prev" title="Updating of task attributes from the system PCS" href="officelink-usermanual-project-sync-updating.html"/> 
...
<h1>General tips<a class="headerlink" href="#allgemeine-hinweise" title="Permalink to this headline">¶</a></h1>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">If you edit a project plan the first time using the Microsoft Project integration, synchronization information is saved in the Microsoft Project file. Even without manual changes, therefore, Microsoft Project asks whether changes to the file should be saved upon quitting.</p>
</div>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">Relationships between tasks of different projects are not synchronized. The synchronization of projects with such relationships is possible, but they are not visible in MS Project and are ignored during synchronization. If a task is deleted in MS Project, all relationships will be deleted in the system during synchronization. No separate message is displayed.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-project-sync-updating.html" class="btn btn-neutral" title="Updating of task attributes from the system PCS" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
