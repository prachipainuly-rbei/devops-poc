...
<head>
  ...
  <title>Introduction &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Editing documents" href="officelink-usermanual-excel-documents.html"/>
...
<span id="officelink-usermanual-excel-intro"></span><h1>Introduction<a class="headerlink" href="#einfuhrung" title="Permalink to this headline">¶</a></h1>
<ul>
<li><p class="first"><span class="guilabel">Excel user interface:</span></p>
<p>The installation extends the Excel application by adding the OfficeLink toolbar.</p>
...
<p class="caption"><span class="caption-text">Excel: OfficeLink menu bar</span></p>
</div>
</li>
<li><p class="first"><span class="guilabel">Standard operations:</span></p>
<p>The system Microsoft Office integration provides Excel with the option of searching for documents in the system, opening them for editing and then saving changes in the database. Moreover, it is possible to change the document status or properties, or create new documents in the system directly from Excel.</p>
</li>
<li><p class="first"><span class="guilabel">Data synchronization:</span></p>
<p>The link gives you the ability to synchronize data with the system. A prerequisite for this is the use of prepared document templates which contain corresponding system variables (see <a class="reference internal" href="officelink-usermanual-excel-metadata-template.html#officelink-usermanual-excel-metadata-template"><span class="std std-ref">Create templates for data synchronization</span></a>). Data synchronization is always carried out for the active document. The active document has to have been opened from the system for editing.</p>
</li>
<li><p class="first"><span class="guilabel">PowerReports:</span></p>
<p>PowerReports provide an infrastructure to create reports with Microsoft Excel quickly and easily. The architecture enables the far-reaching use of Microsoft Excel functions in system reports. A great advantage of the PowerReports architecture, for example, is the ability to integrate graphics and diagrams in system reports to visualize information based on the product and project data automatically and appealingly.</p>
</li>
<li><p class="first"><span class="guilabel">Settings:</span></p>
<p>The OfficeLink administration manual includes the settings options in the option dialog. Contact your system administrator if you have questions.</p>
</li>
</ul>
<div class="toctree-wrapper compound">
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-excel-documents.html" class="btn btn-neutral float-right" title="Editing documents" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
