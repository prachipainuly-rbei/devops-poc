...
<head>
  ...
  <title>Append system documents as message attachment &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="E-mails and attachments" href="officelink-usermanual-outlook-mails.html"/>
        <link rel="next" title="Messages from the document export function of CIM Database/WIN" href="officelink-usermanual-outlook-cdbclient-mailexport.html"/>
        <link rel="prev" title="Create messages in the system" href="officelink-usermanual-outlook-archivemail.html"/> 
...
<li class="toctree-l1 current"><a class="reference internal" href="officelink-usermanual-outlook.html">Outlook</a><ul class="current">
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-outlook-preface.html">Introduction</a></li>
<li class="toctree-l2 current"><a class="reference internal" href="officelink-usermanual-outlook-mails.html">E-mails and attachments</a></li>
</ul>
</li>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Synchronizing data</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="officelink-usermanual-outlook.html">Outlook</a> &raquo;</li>
      
          <li><a href="officelink-usermanual-outlook-mails.html">E-mails and attachments</a> &raquo;</li>
      
    <li>Append system documents as message attachment</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-usermanual-outlook-attachdoc.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="system-dokumente-als-nachrichtenanlage-anhangen">
<span id="officelink-usermanual-outlook-attachdoc"></span><h1>Append system documents as message attachment<a class="headerlink" href="#system-dokumente-als-nachrichtenanlage-anhangen" title="Permalink to this headline">¶</a></h1>
<p class="rubric">In general, system documents can be appended to a message to be composed from Outlook with the following steps:</p>
<ol class="arabic">
<li><p class="first">Create a new e-mail message via the Outlook main menu or the corresponding button in the default toolbar.</p>
</li>
<li><div class="first figure align-center" id="id1">
<img alt="_images/outlook2010_attach.png" src="_images/outlook2010_attach.png" />
<p class="caption"><span class="caption-text">Outlook: &#8216;Append&#8217; control element</span></p>
</div>
<p>Pressing this button initiates a system document search and the document search mask appears. Here you can configure parameters for the search mask as usual with corresponding search criteria. After confirming the mask you get a dialog with the resulting document result list.</p>
<p>Select one or more documents from the result list you want to send.</p>
<p>Since documents can be assigned multiple files, it is possible that you will get another selection dialog. The selection process for documents with additionally assigned files can be further automated in the settings dialog (see OfficeLink administration manual).</p>
</li>
</ol>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">The export right is checked for the selected system documents.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-outlook-cdbclient-mailexport.html" class="btn btn-neutral float-right" title="Messages from the document export function of CIM Database/WIN" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-outlook-archivemail.html" class="btn btn-neutral" title="Create messages in the system" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
