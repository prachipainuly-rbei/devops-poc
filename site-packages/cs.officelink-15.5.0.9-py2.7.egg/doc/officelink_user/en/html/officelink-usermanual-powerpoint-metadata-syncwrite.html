...
<head>
  ...
  <title>Metadata synchronization with the system &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Create templates for data synchronization" href="officelink-usermanual-powerpoint-metadata-template.html"/>
        <link rel="prev" title="Metadata takeover from the system" href="officelink-usermanual-powerpoint-metadata-syncread.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Synchronizing data</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Metadata synchronization with the system</li>
...
<span id="officelink-usermanual-powerpoint-metadata-syncwrite"></span><h1>Metadata synchronization with the system<a class="headerlink" href="#metadatensynchronisation-mit-dem-system" title="Permalink to this headline">¶</a></h1>
<p>By pressing the <span class="guilabel">[ Transfer [write] ]</span> button, the values of all variables with write access are checked for changes. If values have been changed in the document, the affected objects are opened in the system sequentially. The changes are shown in the modify dialogs and have to be confirmed for each object. After completing the data transfer to the system, a metadata acceptance is carried out for system variables with read access.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-powerpoint-metadata-template.html" class="btn btn-neutral float-right" title="Create templates for data synchronization" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-powerpoint-metadata-syncread.html" class="btn btn-neutral" title="Metadata takeover from the system" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
