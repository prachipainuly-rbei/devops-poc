.. _`officelink-usermanual-powerpoint-metadata-template`:
...
.. _`officelink-usermanual-powerpoint-metadata-template-format`:

Formatbeschreibung für System-Variablen
=======================================

System-Variablen in PowerPoint Dokumenten haben folgendes Format:
...
:guilabel:`Attribut`
   ...
   - :guilabel:`Sachmerkmale qualifiziert:`
     ...
     .. container:: example
        ...
        .. rubric:: PowerPoint: Datenabgleich - Sachmerkmale qualifiziert
   ...
   - :guilabel:`Sachmerkmale unqualifiziert:`
     ...
     .. container:: example
        ...
        .. rubric:: PowerPoint: Datenabgleich - Sachmerkmale unqualifiziert
...
.. _`officelink-usermanual-powerpoint-metadata-template-definition`:
...
(siehe :ref:`officelink-usermanual-powerpoint-metadata-template-format` ). Auf der rechten 
...
.. _`officelink-usermanual-powerpoint-metadata-template-definition-dialog`:

.. figure:: images/powerpoint2007_docvar_dialog.png
   :align: center

   PowerPoint: Datenabgleich - Dialog zur Erstellung von System-Variablen
...
.. important:: 
   ...
   Die System-Variablen können nur in einfachen PowerPoint 'Formen' plaziert werden.
...
.. _`officelink-usermanual-powerpoint-metadata-template-change`:
...
.. _`officelink-usermanual-powerpoint-metadata-template-usage`:
...
.. _`officelink-usermanual-powerpoint-metadata-template-autoupdate`:
