...
<head>
  ...
  <title>Word &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="next" title="Introduction" href="officelink-usermanual-word-preface.html"/>
        <link rel="prev" title="Create templates for data synchronization" href="officelink-usermanual-visio-metadata-template.html"/> 
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Word</a><ul>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Word</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-usermanual-word.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-usermanual-word"></span><span id="helpid-officelink-usermanual-word"></span><h1>Word<a class="headerlink" href="#word" title="Permalink to this headline">¶</a></h1>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-word-preface.html">Introduction</a><ul class="simple">
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-word-documents.html">Editing documents</a><ul>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-documents-load.html">Searching for documents in the system</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-documents-save.html">Save in the system</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-documents-create.html">Create in the system</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-documents-createindex.html">Create index in the system</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-documents-status.html">Change document status</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-documents-properties.html">Opening master data change dialog in the system</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Synchronizing data</a><ul>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata-syncread.html">Metadata takeover from the system</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata-syncwrite.html">Metadata synchronization with the system</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata-template.html">Create templates for data synchronization</a></li>
</ul>
</li>
</ul>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-word-preface.html" class="btn btn-neutral float-right" title="Introduction" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-visio-metadata-template.html" class="btn btn-neutral" title="Create templates for data synchronization" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
