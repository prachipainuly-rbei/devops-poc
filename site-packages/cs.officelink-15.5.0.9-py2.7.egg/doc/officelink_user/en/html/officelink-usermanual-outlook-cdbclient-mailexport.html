...
<head>
  ...
  <title>Messages from the document export function of CIM Database/WIN &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="prev" title="Append system documents as message attachment" href="officelink-usermanual-outlook-attachdoc.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Synchronizing data</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Messages from the document export function of CIM Database/WIN</li>
...
<span id="officelink-usermanual-outlook-cdbclient-mailexport"></span><h1>Messages from the document export function of CIM Database/WIN<a class="headerlink" href="#nachrichten-aus-der-dokumentenexport-funktion-von-cdbwin" title="Permalink to this headline">¶</a></h1>
<p>With the system operation &#8216;Export documents as e-mail&#8217;, a cdbinfo file, which is given to the message to be sent as an additional attachment, is also exported in the XML format in addition to the selected documents. Messages that were originally sent this way can likewise be archived. Based on the cdbinfo file, the link identifies which attachments come from the system and does not offer these again for archiving. After the outgoing message has been archived, the references between the message and the attachments already in the system are written.</p>
<div class="figure align-center" id="id1">
<img alt="_images/outlook2007_cdbexport_as_mail.png" src="_images/outlook2007_cdbexport_as_mail.png" />
<p class="caption"><span class="caption-text">Outlook: &#8216;Export as e-mail&#8217; in CIM Database/WIN</span></p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-outlook-attachdoc.html" class="btn btn-neutral" title="Append system documents as message attachment" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
