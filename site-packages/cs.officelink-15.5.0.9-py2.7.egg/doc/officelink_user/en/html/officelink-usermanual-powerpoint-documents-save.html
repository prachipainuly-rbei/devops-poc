...
<head>
  ...
  <title>Save in the system &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Create in the system" href="officelink-usermanual-powerpoint-documents-create.html"/>
        <link rel="prev" title="Searching for documents in the system" href="officelink-usermanual-powerpoint-documents-load.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Synchronizing data</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Save in the system</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-usermanual-powerpoint-documents-save.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="im-system-speichern">
<span id="officelink-usermanual-powerpoint-documents-save"></span><h1>Save in the system<a class="headerlink" href="#im-system-speichern" title="Permalink to this headline">¶</a></h1>
<p>The <span class="guilabel">[ Save ]</span> button saves the changes to the active document directly in the system.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-powerpoint-documents-create.html" class="btn btn-neutral float-right" title="Create in the system" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-powerpoint-documents-load.html" class="btn btn-neutral" title="Searching for documents in the system" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
