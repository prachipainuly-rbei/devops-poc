...
<head>
  ...
  <title>Metadatensynchronisation mit dem System &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Vorlagen zum Datenabgleich erstellen" href="officelink-usermanual-powerpoint-metadata-template.html"/>
        <link rel="prev" title="Metadatenübernahme aus dem System" href="officelink-usermanual-powerpoint-metadata-syncread.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Daten abgleichen</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Metadatensynchronisation mit dem System</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-usermanual-powerpoint-metadata-syncwrite.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="metadatensynchronisation-mit-dem-system">
<span id="officelink-usermanual-powerpoint-metadata-syncwrite"></span><h1>Metadatensynchronisation mit dem System<a class="headerlink" href="#metadatensynchronisation-mit-dem-system" title="Link zu dieser Überschrift">¶</a></h1>
<p>Durch Betätigung der Schaltfläche <span class="guilabel">[ Übergeben ]</span> werden die Werte
aller Variablen mit schreibenden Zugriff auf Änderungen überprüft. Wurden Werte im
Dokument verändert, werden die betroffenen Objekte nacheinander im System geöffnet.
Die Änderungen werden in den Änderungsdialogen vorgeblendet und müssen für jedes
Objekt bestätigt werden. Nach Abschluss der Datenübernahme in das System wird eine
Metadatenübernahme für System-Variablen mit lesendem Zugriff durchgeführt.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-powerpoint-metadata-template.html" class="btn btn-neutral float-right" title="Vorlagen zum Datenabgleich erstellen" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-powerpoint-metadata-syncread.html" class="btn btn-neutral" title="Metadatenübernahme aus dem System" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
