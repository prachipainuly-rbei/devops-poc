...
<head>
  ...
  <title>Funktionalität &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Veröffentlichen von Microsoft Project Projektplänen im System PCS" href="officelink-usermanual-project-sync-publishing.html"/>
        <link rel="prev" title="Projekt-Synchronisation" href="officelink-usermanual-project-sync.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Funktionalität</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-usermanual-project-sync-preface.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-usermanual-project-sync-intro"></span><h1>Funktionalität<a class="headerlink" href="#funktionalitat" title="Link zu dieser Überschrift">¶</a></h1>
<p>Die Microsoft Project-Integration ermöglicht die Bearbeitung von Projektplänen, die durch das System PCS verwaltet werden,
in Microsoft Project. Dazu wird Microsoft Project um die folgenden Funktionen erweitert:</p>
<ul class="simple">
<li>Veröffentlichen der Projektstruktur im System ausgehend vom Projektplan</li>
<li>Aktualisieren bestimmter Aufgabenattribute mit aktuellen Informationen aus dem System</li>
<li>Anzeige von Projekt- und Aufgabenübersichten aus dem System zu geladenen Projektplänen in Microsoft Project</li>
<li>Anzeige von Aufgabeninformationsblatt im System von selektierten Aufgaben in Microsoft Project</li>
</ul>
<p>Beim Veröffentlichen und Aktualisieren von Projektplänen findet ein teilweise bidirektionaler Abgleich von Projektdaten sowie
Aufgaben statt. Dazu gehören u.a. Projektname, Projektterminierung, Aufgabenstruktur und -beziehungen sowie Meilensteine, so dass
die gemeinsame Teilmenge aller Datenfelder zwischen dem System und Microsoft Project vollständig abgedeckt werden kann.</p>
<div class="admonition important">
<p class="first admonition-title">Wichtig</p>
<p class="last">Es ist zudem erforderlich, weiterführende Hinweise im Projects Anwenderhandbuch nachzuschlagen.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-project-sync-publishing.html" class="btn btn-neutral float-right" title="Veröffentlichen von Microsoft Project Projektplänen im System PCS" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-project-sync.html" class="btn btn-neutral" title="Projekt-Synchronisation" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
