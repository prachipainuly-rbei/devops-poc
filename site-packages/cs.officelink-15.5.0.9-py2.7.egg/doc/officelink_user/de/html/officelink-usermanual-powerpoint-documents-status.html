...
<head>
  ...
  <title>Dokumentenstatus ändern &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Stammdatenänderungsdialog im System öffnen" href="officelink-usermanual-powerpoint-documents-properties.html"/>
        <link rel="prev" title="Index erzeugen im System" href="officelink-usermanual-powerpoint-documents-createindex.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Daten abgleichen</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Dokumentenstatus ändern</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-usermanual-powerpoint-documents-status.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="dokumentenstatus-andern">
<span id="officelink-usermanual-powerpoint-documents-status"></span><h1>Dokumentenstatus ändern<a class="headerlink" href="#dokumentenstatus-andern" title="Link zu dieser Überschrift">¶</a></h1>
<p>Die Schaltfläche <span class="guilabel">[ Status ändern ]</span> führt für das aktive Dokument
eine System-Statusänderungsoperation durch.</p>
<div class="admonition note">
<p class="first admonition-title">Bemerkung</p>
<p class="last">Da der Anwender durch die Statusänderung ggf. die Rechte im System verliert, das
Dokument erneut zu speichern, speichert die Kopplung das Dokument automatisch,
bevor die Statusänderungsoperation aufgerufen wird. Dabei wird ggf. eine
entsprechende Meldung angezeigt, die bestätigt werden muss.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-powerpoint-documents-properties.html" class="btn btn-neutral float-right" title="Stammdatenänderungsdialog im System öffnen" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-powerpoint-documents-createindex.html" class="btn btn-neutral" title="Index erzeugen im System" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
