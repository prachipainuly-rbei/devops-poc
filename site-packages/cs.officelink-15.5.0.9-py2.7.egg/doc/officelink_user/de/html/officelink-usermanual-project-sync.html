...
<head>
  ...
  <title>Projekt-Synchronisation &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Funktionalität" href="officelink-usermanual-project-sync-preface.html"/>
        <link rel="prev" title="Stammdatenänderungsdialog im System öffnen" href="officelink-usermanual-project-documents-properties.html"/> 
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Projekt-Synchronisation</a></li>
</ul>
</li>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Daten abgleichen</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Projekt-Synchronisation</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-usermanual-project-sync.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="projekt-synchronisation">
<span id="officelink-usermanual-project-sync"></span><h1>Projekt-Synchronisation<a class="headerlink" href="#projekt-synchronisation" title="Link zu dieser Überschrift">¶</a></h1>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-project-sync-preface.html">Funktionalität</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-project-sync-publishing.html">Veröffentlichen von Microsoft Project Projektplänen im System PCS</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-project-sync-updating.html">Aktualisieren von Aufgabenattributen aus dem System PCS</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-project-sync-notes.html">Allgemeine Hinweise</a></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-project-sync-preface.html" class="btn btn-neutral float-right" title="Funktionalität" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-project-documents-properties.html" class="btn btn-neutral" title="Stammdatenänderungsdialog im System öffnen" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
