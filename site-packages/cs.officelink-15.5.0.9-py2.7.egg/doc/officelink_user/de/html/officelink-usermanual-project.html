...
<head>
  ...
  <title>Project &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="next" title="Einführung" href="officelink-usermanual-project-preface.html"/>
        <link rel="prev" title="Vorlagen zum Datenabgleich erstellen" href="officelink-usermanual-powerpoint-metadata-template.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Project</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-usermanual-project.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-usermanual-project"></span><span id="helpid-officelink-usermanual-project"></span><h1>Project<a class="headerlink" href="#project" title="Link zu dieser Überschrift">¶</a></h1>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-project-preface.html">Einführung</a><ul class="simple">
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-project-documents.html">Dokumente bearbeiten</a><ul>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-documents-load.html">Dokumentensuche im System</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-documents-save.html">Im System speichern</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-documents-create.html">Neuanlage im System</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-documents-createindex.html">Index erzeugen im System</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-documents-status.html">Dokumentenstatus ändern</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-documents-properties.html">Stammdatenänderungsdialog im System öffnen</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="officelink-usermanual-project-sync.html">Projekt-Synchronisation</a><ul>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-sync-preface.html">Funktionalität</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-sync-publishing.html">Veröffentlichen von Microsoft Project Projektplänen im System PCS</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-sync-updating.html">Aktualisieren von Aufgabenattributen aus dem System PCS</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-project-sync-notes.html">Allgemeine Hinweise</a></li>
</ul>
</li>
</ul>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-project-preface.html" class="btn btn-neutral float-right" title="Einführung" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-powerpoint-metadata-template.html" class="btn btn-neutral" title="Vorlagen zum Datenabgleich erstellen" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
