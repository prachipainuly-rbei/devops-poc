...
<head>
  ...
  <title>Vorlagen zum Datenabgleich erstellen &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Daten abgleichen" href="officelink-usermanual-powerpoint-metadata.html"/>
        <link rel="next" title="Project" href="officelink-usermanual-project.html"/>
        <link rel="prev" title="Metadatensynchronisation mit dem System" href="officelink-usermanual-powerpoint-metadata-syncwrite.html"/> 
...
<li class="toctree-l2 current"><a class="reference internal" href="officelink-usermanual-powerpoint-metadata.html">Daten abgleichen</a></li>
</ul>
</li>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Daten abgleichen</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="officelink-usermanual-powerpoint-metadata.html">Daten abgleichen</a> &raquo;</li>
...
<span id="officelink-usermanual-powerpoint-metadata-template"></span><h1>Vorlagen zum Datenabgleich erstellen<a class="headerlink" href="#vorlagen-zum-datenabgleich-erstellen" title="Link zu dieser Überschrift">¶</a></h1>
...
<span id="officelink-usermanual-powerpoint-metadata-template-format"></span><h2>Formatbeschreibung für System-Variablen<a class="headerlink" href="#formatbeschreibung-fur-system-variablen" title="Link zu dieser Überschrift">¶</a></h2>
<p>System-Variablen in PowerPoint Dokumenten haben folgendes Format:
...
<p class="rubric">PowerPoint: Datenabgleich - Sachmerkmale qualifiziert</p>
...
<div class="example container">
<p class="rubric">PowerPoint: Datenabgleich - Sachmerkmale unqualifiziert</p>
...
<span id="officelink-usermanual-powerpoint-metadata-template-definition"></span><h2>Definition von System-Variablen<a class="headerlink" href="#definition-von-system-variablen" title="Link zu dieser Überschrift">¶</a></h2>
...
(siehe <a class="reference internal" href="#officelink-usermanual-powerpoint-metadata-template-format"><span class="std std-ref">Formatbeschreibung für System-Variablen</span></a> ). Auf der rechten
Seite werden alle im Dokument enthaltenen System-Variablen angezeigt. Durch Markierung einer
Variablen wird gleichzeitig das entsprechende Textfeld in der PowerPoint Dokument markiert. Durch
...
<p class="caption"><span class="caption-text">PowerPoint: Datenabgleich - Dialog zur Erstellung von System-Variablen</span></p>
</div>
<ul>
...
<p class="first admonition-title">Wichtig</p>
<p class="last">Die System-Variablen können nur in einfachen PowerPoint &#8216;Formen&#8217; plaziert werden.
Desweiteren kann nur jeweils eine System-Variable pro PowerPoint Form definiert werden.
...
<span id="officelink-usermanual-powerpoint-metadata-template-change"></span><h2>Ändern von System-Variablen<a class="headerlink" href="#andern-von-system-variablen" title="Link zu dieser Überschrift">¶</a></h2>
...
<span id="officelink-usermanual-powerpoint-metadata-template-usage"></span><h2>Verwendung von System-Variablen im Dokument<a class="headerlink" href="#verwendung-von-system-variablen-im-dokument" title="Link zu dieser Überschrift">¶</a></h2>
...
<span id="officelink-usermanual-powerpoint-metadata-template-autoupdate"></span><h2>Automatisches Aktualisieren von Metadaten<a class="headerlink" href="#automatisches-aktualisieren-von-metadaten" title="Link zu dieser Überschrift">¶</a></h2>
...
<li>keine Vorlage ist (d.h. &#8220;vorlage_kz=0&#8221;)</li>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-powerpoint-metadata-syncwrite.html" class="btn btn-neutral" title="Metadatensynchronisation mit dem System" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
