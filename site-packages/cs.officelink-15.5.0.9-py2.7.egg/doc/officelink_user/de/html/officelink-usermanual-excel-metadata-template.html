...
<head>
  ...
  <title>Vorlagen zum Datenabgleich erstellen &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Daten abgleichen" href="officelink-usermanual-excel-metadata.html"/>
        <link rel="next" title="PowerReports" href="officelink-usermanual-excel-powerreports.html"/>
        <link rel="prev" title="Metadatensynchronisation mit dem System" href="officelink-usermanual-excel-metadata-syncwrite.html"/> 
...
<li class="toctree-l2 current"><a class="reference internal" href="officelink-usermanual-excel-metadata.html">Daten abgleichen</a></li>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Daten abgleichen</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="officelink-usermanual-excel-metadata.html">Daten abgleichen</a> &raquo;</li>
      
    <li>Vorlagen zum Datenabgleich erstellen</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-usermanual-excel-metadata-template.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-usermanual-excel-metadata-template"></span><h1>Vorlagen zum Datenabgleich erstellen<a class="headerlink" href="#vorlagen-zum-datenabgleich-erstellen" title="Link zu dieser Überschrift">¶</a></h1>
<p>Dieser Abschnitt beschreibt die Erstellung von Dokumentvorlagen mit System-
...
<li>Übernahme von 1:N referenzierten Objekten (z.B. Liste mit Offenen Punkten)</li>
</ul>
<div class="section" id="formatbeschreibung-fur-system-variablen">
<span id="officelink-usermanual-excel-metadata-template-format"></span><h2>Formatbeschreibung für System-Variablen<a class="headerlink" href="#formatbeschreibung-fur-system-variablen" title="Link zu dieser Überschrift">¶</a></h2>
<p>System-Variablen in Excel Dokumenten haben folgendes Format:
...
<li><p class="first"><span class="guilabel">*s</span></p>
<p>Wenn oben genannten Modewerten ein <em>s</em> hinzugefügt wird (d.h. <em>rs</em>, <em>ws</em> oder <em>rws</em>), dann
gelten zwar die gleichen Regeln wie bei den jeweiligen beschriebenen Werten ohne <em>s</em>, jedoch
laufen die Lese- bzw. Schreibeaktionen vollständig serverseitig ab. Dabei kann optional
das Feld <em>Parameter</em> verwendet werden. U.U. bedarf es allerdings für die Verwendung der
serverseitigen Bearbeitung von Variablen vorbereitend administratives Customizing, welches im
OfficeLink Administrationshandbuch erläutert wird.</p>
</li>
</ul>
</dd>
...
<li><p class="first"><span class="guilabel">Name einer im System konfigurierten Beziehung</span></p>
...
<p class="rubric">Excel: Datenabgleich - Sachmerkmale qualifiziert</p>
...
<div class="example container">
<p class="rubric">Excel: Datenabgleich - Sachmerkmale unqualifiziert</p>
...
<li><p class="first"><span class="guilabel">N</span></p>
<p>Für n-stellige homogene Beziehungen. Variablen, die n-stellige Beziehungen verwenden,
...
der ersten Spalte.</p>
<div class="example container">
<p class="rubric">Excel: Datenabgleich - System-Variablen</p>
<p>Zeichnungsnummer des Dokuments:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>&quot;cdb.r.this.z_nummer&quot;
</pre></div>
</div>
<p>Übernahme und Abgleich der Bemerkung des Dokuments:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>&quot;cdb.rw.this.z_bemerkung&quot;
</pre></div>
</div>
<p>Übernahme der Artikelnummer des zugeordneten Artikels:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>&quot;cdb.r.cdb_doc_to_part.teilenummer&quot;
</pre></div>
</div>
<p>Übernahme und Abgleich der Artikelbenennung des zugeordneten Artikels:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>&quot;cdb.rw.cdb_doc_to_part.benennung&quot;
</pre></div>
</div>
<p>Übernahme der Begründung aus der Änderungshistorie mittels impliziter Beziehung:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>&quot;cdb.r.BY_ZNUM_ZIDX_FROM_aenderung.begruend&quot;
</pre></div>
</div>
</div>
</li>
...
<dt><span class="guilabel">Abgleich von Gleitkommazahlen ins System</span></dt>
<dd><p class="first">Das Excel Dezimaltrennzeichen ist abhängig von den in der Windows Systemsteuerung eingestellten Regions- und
Sprachoptionen. Für Attribute, die im System als <span class="guilabel">float</span> definiert sind, muss vor dem Abgleich
das Dezimaltrennzeichen ggf. von Komma auf Punkt geändert werden. Damit die Kopplung solche Attribute erkennen
und das Dezimaltrennzeichen korrigieren kann, muss an den Variablenausdruck der Dokumentenvariablen
<span class="guilabel">.numeric</span> angehängt werden.</p>
<div class="last highlight-none"><div class="highlight"><pre><span></span>cdb.rw.cdbpcs_doc2project.effort_plan.1.numeric
</pre></div>
</div>
</dd>
<dt><span class="guilabel">Parameter</span></dt>
<dd><p class="first">Über dieses Feld können bei der serverseitigen Bearbeitung von Variablen zusätzliche für die
...
Variable der Parameter <em>PRIMARY</em> hinzugefügt, welches einem zuvor speziell dafür bereitgestelltem
Userexit übermittelt, dass man den Ursprungsnamen der Primärdatei des Dokuments haben möchte.</p>
<div class="last highlight-none"><div class="highlight"><pre><span></span>cdb.rs.document2cdb_file.cdbf_original_name.N.string.PRIMARY
</pre></div>
</div>
</dd>
</dl>
...
<span id="officelink-usermanual-excel-metadata-template-definition"></span><h2>Definition von System-Variablen<a class="headerlink" href="#definition-von-system-variablen" title="Link zu dieser Überschrift">¶</a></h2>
...
(siehe <a class="reference internal" href="#officelink-usermanual-excel-metadata-template-format"><span class="std std-ref">Formatbeschreibung für System-Variablen</span></a> ). Auf der rechten
Seite werden alle im Dokument enthaltenen System-Variablen angezeigt. Durch Markierung einer
Variablen wird gleichzeitig die entsprechende Zelle in der Excel Tabelle markiert. Durch
...
<span id="officelink-usermanual-excel-metadata-template-definition-dialog"></span><img alt="_images/excel2007_docvar_dialog.png" src="_images/excel2007_docvar_dialog.png" />
<p class="caption"><span class="caption-text">Excel: Datenabgleich - Dialog zur Erstellung von System-Variablen</span></p>
</div>
<ul>
...
<p>rw: lesender und schreibender Zugriff im System</p>
<p>rs: nur serverseitig lesend</p>
<p>ws: nur serverseitig schreibend</p>
<p>rws: serverseitig lesender und schreibender Zugriff im System</p>
</li>
<li><p class="first"><span class="guilabel">Parameter:</span></p>
<p>Optionaler nur für das serverseitige Bearbeiten von Variablen verwendeter Wert.</p>
</li>
<li><p class="first"><span class="guilabel">Bezieht sich auf:</span></p>
<p>In diesem Feld muss die Zelle angegeben werden, in der die System-Variable
angezeigt werden soll. Die Excel Zelle sollte aus dem Katalog ausgewählt
werden. Beim Öffnen des Katalogs wird der Dialog zur Variablenkonfiguration
ausgeblendet und ein Auswahlfenster für die Excel Zelle angezeigt. Die Excel
Zelle kann durch Mausklick auf die gewünschte Zelle ausgewählt und anschließend
übernommen werden.</p>
<div class="figure align-center" id="id2">
<span id="officelink-usermanual-excel-metadata-template-definition-cellselection"></span><img alt="_images/excel2007_cell_selection.png" src="_images/excel2007_cell_selection.png" />
<p class="caption"><span class="caption-text">Excel: Datenabgleich - Zelle auswählen</span></p>
</div>
</li>
<li><p class="first"><span class="guilabel">System Variable:</span></p>
...
<p>Beim Hinzufügen der Variablen durch Betätigung der Schaltfläche <span class="guilabel">[ Variable hinzufügen ]</span>
...
<code class="docutils literal"><span class="pre">&lt;Attribut&gt;</span></code> als Platzhalter initialisiert. Zellen, auf die
sich ein Name bezieht, nehmen bei Aktualisierung den Wert des zugehörigen System-
Attributs an. Ein Name kann zusätzlich von weiteren Zellen referenziert werden.
Diese Zellen nehmen ebenfalls diesen Wert an.</p>
</div>
<div class="section" id="verwendung-von-system-variablen-im-dokument">
<span id="officelink-usermanual-excel-metadata-template-usage"></span><h2>Verwendung von System-Variablen im Dokument<a class="headerlink" href="#verwendung-von-system-variablen-im-dokument" title="Link zu dieser Überschrift">¶</a></h2>
<p>System-Variablen sollten im Dokument für den Anwender kenntlich gemacht werden,
um versehentliches Löschen oder Überschreiben zu vermeiden. Dokumentenvariablen
können unter Microsoft Office Excel durch das Sperren der entsprechenden Zellen
geschützt werden. Damit dieser Schutz aktiv wird, muss der Blattschutz aktiviert
werden. Dabei darf kein Passwort vergeben werden, da die Kopplung beim Datenabgleich
diesen Blattschutz temporär aufhebt. Ist bei der Aktivierung des Blattschutzes ein
Passwort angegeben worden, wird der Anwender beim Datenabgleich zur Passworteingabe
aufgefordert. Wird das Passwort nicht oder falsch angegeben, schlägt der Datenabgleich fehl.</p>
...
<p>System-Variablen, die n-stellige Beziehungen verwenden, müssen unter Excel spaltenweise
in der Kopfzeile einer Liste platziert werden. Beim Abgleich mit dem System wird die Liste auf
die zur Darstellung des Ergebnisses benötigte Anzahl Zeilen angepasst. Die erste Zeile
nach der Kopfzeile dient dabei als Formatvorlage. Die Sortierung der Liste erfolgt anhand
der ersten Spalte.</p>
<p class="rubric">Listen/Tabellen in Microsoft Office Excel für n-stellige Beziehungen:</p>
<ol class="arabic simple">
<li>Liste/Tabelle mit zwei Zeilen und der gewünschten Anzahl Spalten einfügen.</li>
<li>System-Variablen mit dem Assistenten in die erste Zeile einfügen (siehe    <a class="reference internal" href="#officelink-usermanual-excel-metadata-template-definition"><span class="std std-ref">Definition von System-Variablen</span></a> ).
Alle Variablen müssen dabei dieselbe Beziehung verwenden und von der Kardinalität
N sein.</li>
<li>Platzhalter der System-Variablen in die gewünschten Spaltentitel ändern und    wie gewünscht formatieren.</li>
<li>Zweite Zeile formatieren. Diese Zeile dient als Kopiervorlage zum Einfügen    weiterer Zeilen beim Datenabgleich.</li>
</ol>
<div class="figure align-center" id="id3">
<span id="officelink-usermanual-excel-metadata-template-usage-list-empty"></span><img alt="_images/excel2007_docvar_list_empty.png" src="_images/excel2007_docvar_list_empty.png" />
<p class="caption"><span class="caption-text">Excel: Datenabgleich - List/Tabelle für n-stellige Beziehungen [leer]</span></p>
</div>
<p>Bei Durchführung einer Datenübernahme wird die Tabelle auf die benötigte Anzahl
Zeilen expandiert und mit der Ergebnismenge der verwendeten Beziehung gefüllt.</p>
<div class="figure align-center" id="id4">
<span id="officelink-usermanual-excel-metadata-template-usage-list-filled"></span><img alt="_images/excel2007_docvar_list_filled.png" src="_images/excel2007_docvar_list_filled.png" />
<p class="caption"><span class="caption-text">Excel: Datenabgleich - List/Tabelle für n-stellige Beziehungen [gefüllt]</span></p>
</div>
</div>
<div class="section" id="automatisches-aktualisieren-von-metadaten">
<span id="officelink-usermanual-excel-metadata-template-autoupdate"></span><h2>Automatisches Aktualisieren von Metadaten<a class="headerlink" href="#automatisches-aktualisieren-von-metadaten" title="Link zu dieser Überschrift">¶</a></h2>
...
<li>keine Vorlage ist (d.h. &#8220;vorlage_kz=0&#8221;)</li>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-excel-powerreports.html" class="btn btn-neutral float-right" title="PowerReports" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-excel-metadata-syncwrite.html" class="btn btn-neutral" title="Metadatensynchronisation mit dem System" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
