...
<head>
  ...
  <title>Einführung &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Dokumente bearbeiten" href="officelink-usermanual-excel-documents.html"/>
        <link rel="prev" title="Excel" href="officelink-usermanual-excel.html"/> 
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Einführung</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Einführung</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-usermanual-excel-preface.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-usermanual-excel-intro"></span><h1>Einführung<a class="headerlink" href="#einfuhrung" title="Link zu dieser Überschrift">¶</a></h1>
<ul>
<li><p class="first"><span class="guilabel">Excel-Oberfläche:</span></p>
<p>Die Excel-Anwendung wird durch die Installation um die OfficeLink-Symbolleiste
erweitert.</p>
<div class="figure align-center" id="id1">
<span id="officelink-usermanual-excel-intro-toolbar"></span><img alt="_images/excel2010_toolbar.png" src="_images/excel2010_toolbar.png" />
<p class="caption"><span class="caption-text">Excel: OfficeLink-Menüleiste</span></p>
</div>
</li>
<li><p class="first"><span class="guilabel">Standardoperationen:</span></p>
<p>Die System Microsoft Office Integration bietet für Excel die Möglichkeit, Dokumente im
System zu suchen, zur Bearbeitung zu öffnen und daraufhin Änderungen in der Datenbank
zu speichern. Weiterhin können Dokument-Status oder -Eigenschaften geändert, oder direkt
aus Excel heraus neue Dokumente im System angelegt werden.</p>
</li>
<li><p class="first"><span class="guilabel">Datenabgleich:</span></p>
<p>Die Kopplung bietet die Möglichkeit des Datenabgleichs mit dem System. Voraussetzung dafür
ist die Verwendung von vorbereiteten Dokumentvorlagen, die entsprechende System-Variablen
enthalten (siehe <a class="reference internal" href="officelink-usermanual-excel-metadata-template.html#officelink-usermanual-excel-metadata-template"><span class="std std-ref">Vorlagen zum Datenabgleich erstellen</span></a> ).
Der Datenabgleich wird immer für das aktive Dokument durchgeführt. Das aktive Dokument
muss aus dem System zur Bearbeitung geöffnet worden sein.</p>
</li>
<li><p class="first"><span class="guilabel">PowerReports:</span></p>
<p>PowerReports stellen eine Infrastruktur zur einfachen und schnellen Erstellung von
Reports mit Microsoft Excel bereit. Die Architektur ermöglicht die weitreichende
Nutzung von Microsoft Excel Funktionen in System-Reports. Ein großer Vorteil der
PowerReports Architektur ist beispielsweise die Möglichkeit, Graphiken und Diagramme
in System-Reports einzubinden, um Informationen automatisch und ansprechend anhand der
Produkt- und Projektdaten zu visualisieren.</p>
</li>
<li><p class="first"><span class="guilabel">Einstellungen:</span></p>
<p>Auf die Einstellungsmöglichkeiten im Optionsdialog wird im OfficeLink Administrationsbuch
eingegangen. Wenden Sie sich bei Fragen an ihren System-Administrator.</p>
</li>
</ul>
<div class="toctree-wrapper compound">
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-excel-documents.html" class="btn btn-neutral float-right" title="Dokumente bearbeiten" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-excel.html" class="btn btn-neutral" title="Excel" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
