...
<head>
  ...
  <title>Metadatenübernahme aus dem System &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Metadatensynchronisation mit dem System" href="officelink-usermanual-word-metadata-syncwrite.html"/>
        <link rel="prev" title="Daten abgleichen" href="officelink-usermanual-word-metadata.html"/> 
...
<li class="toctree-l2 current"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Daten abgleichen</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Metadatenübernahme aus dem System</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-usermanual-word-metadata-syncread.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-usermanual-word-metadata-syncread"></span><h1>Metadatenübernahme aus dem System<a class="headerlink" href="#metadatenubernahme-aus-dem-system" title="Link zu dieser Überschrift">¶</a></h1>
<p>Durch Betätigung der Schaltfläche <span class="guilabel">[ Übernehmen ]</span> werden die Werte
aller System-Variablen mit lesendem Zugriff mit den entsprechenden Werten der
zugehörigen System-Attribute aktualisiert. Vom Anwender im Dokument geänderte System-
Variablen mit lesendem Zugriff werden dabei überschrieben. Falls ein Fehler im
Ausdruck einer Variablen vorliegt, das referenzierte Objekt nicht existiert oder
die Beziehung nicht eindeutig ist, wird der Wert auf ein Leerzeichen gesetzt.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-word-metadata-syncwrite.html" class="btn btn-neutral float-right" title="Metadatensynchronisation mit dem System" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-word-metadata.html" class="btn btn-neutral" title="Daten abgleichen" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
