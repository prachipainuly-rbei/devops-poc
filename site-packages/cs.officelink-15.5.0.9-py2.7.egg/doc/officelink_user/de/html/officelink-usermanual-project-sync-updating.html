...
<head>
  ...
  <title>Aktualisieren von Aufgabenattributen aus dem System PCS &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Projekt-Synchronisation" href="officelink-usermanual-project-sync.html"/>
        <link rel="next" title="Allgemeine Hinweise" href="officelink-usermanual-project-sync-notes.html"/>
        <link rel="prev" title="Veröffentlichen von Microsoft Project Projektplänen im System PCS" href="officelink-usermanual-project-sync-publishing.html"/> 
...
<li class="toctree-l1 current"><a class="reference internal" href="officelink-usermanual-project.html">Project</a><ul class="current">
...
<li class="toctree-l2 current"><a class="reference internal" href="officelink-usermanual-project-sync.html">Projekt-Synchronisation</a></li>
</ul>
</li>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-usermanual-word-metadata.html">Daten abgleichen</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="officelink-usermanual-project.html">Project</a> &raquo;</li>
      
          <li><a href="officelink-usermanual-project-sync.html">Projekt-Synchronisation</a> &raquo;</li>
      
    <li>Aktualisieren von Aufgabenattributen aus dem System PCS</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-usermanual-project-sync-updating.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="aktualisieren-von-aufgabenattributen-aus-dem-system-pcs">
<span id="officelink-usermanual-project-sync-updating"></span><h1>Aktualisieren von Aufgabenattributen aus dem System PCS<a class="headerlink" href="#aktualisieren-von-aufgabenattributen-aus-dem-system-pcs" title="Link zu dieser Überschrift">¶</a></h1>
<p>Beim &#8220;Attribute aktualisieren&#8221; wird der Projektplan mit bestimmten im System aktuell gespeicherten
Aufgabenattributen aktualisiert. Ein Datentransfer in Richtung System findet hierbei nicht statt.
Standardmäßig werden nur einige wenige Attribute aus dem System nach Microsoft Project übertragen:</p>
<table border="1" class="docutils" id="id1">
<caption><span class="caption-text">Aktualisierte Aufgabenattribute</span><a class="headerlink" href="#id1" title="Link zu dieser Tabelle">¶</a></caption>
<colgroup>
<col width="50%" />
<col width="50%" />
</colgroup>
<thead valign="bottom">
<tr class="row-odd"><th class="head">MSP Aufgabenfeld</th>
<th class="head">PCS Aufgabenfeld</th>
</tr>
</thead>
<tbody valign="top">
<tr class="row-even"><td>Number10</td>
<td>Status</td>
</tr>
<tr class="row-odd"><td>Text12</td>
<td>Referenz-ID</td>
</tr>
<tr class="row-even"><td>Text14</td>
<td>Verantwortlich</td>
</tr>
<tr class="row-odd"><td>Text15</td>
<td>Status (Text)</td>
</tr>
</tbody>
</table>
<p>Wie die Liste dieser aktualisierten Aufgabenattribute angepasst werden kann, wird im OfficeLink
Administrationshandbuch beschrieben.</p>
<div class="admonition important">
<p class="first admonition-title">Wichtig</p>
<p class="last">Es kann kein konsistenter beidseitiger Datenabgleich gewährleistet werden, wenn die Liste durch
Aufgabenattribute erweitert wird, welche die Projektstruktur erneut indirekt verändern, wie z.B.
Aufgabenstart, -dauer, -ende, Vorgänger, Nachfolger o.ä.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-project-sync-notes.html" class="btn btn-neutral float-right" title="Allgemeine Hinweise" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-project-sync-publishing.html" class="btn btn-neutral" title="Veröffentlichen von Microsoft Project Projektplänen im System PCS" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
