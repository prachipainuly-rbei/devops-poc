...
<head>
  ...
  <title>Allgemeine Hinweise &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Visio" href="officelink-usermanual-visio.html"/>
        <link rel="prev" title="Aktualisieren von Aufgabenattributen aus dem System PCS" href="officelink-usermanual-project-sync-updating.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Allgemeine Hinweise</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-usermanual-project-sync-notes.txt" rel="nofollow"> View page source</a>
...
<h1>Allgemeine Hinweise<a class="headerlink" href="#allgemeine-hinweise" title="Link zu dieser Überschrift">¶</a></h1>
<div class="admonition note">
<p class="first admonition-title">Bemerkung</p>
<p class="last">Falls Sie einen Projektplan das erste Mal mit Hilfe der Microsoft Project-Integration bearbeiten, werden Abgleichsinformationen in
der Microsoft Project-Datei gespeichert. Auch ohne manuelle Änderungen fragt daher Microsoft Project beim Beenden, ob Änderungen
an der Datei gespeichert werden sollen.</p>
</div>
<div class="admonition note">
<p class="first admonition-title">Bemerkung</p>
<p class="last">Projektübergreifende Anordnungsbeziehungen zwischen Aufgaben werden nicht synchronisiert. Sie können ein Projekt mit diesen
Beziehungen zwar synchronisieren, jedoch sind sie in MS Project nicht sichtbar und werden beim Abgleich ignoriert. Wird
eine Aufgabe in MS Project gelöscht, wird beim Abgleich die Aufgabe mit allen Anordnungsbeziehungen im System gelöscht.
Es erscheint keine gesonderte Benachrichtigung.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-usermanual-visio.html" class="btn btn-neutral float-right" title="Visio" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-usermanual-project-sync-updating.html" class="btn btn-neutral" title="Aktualisieren von Aufgabenattributen aus dem System PCS" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
