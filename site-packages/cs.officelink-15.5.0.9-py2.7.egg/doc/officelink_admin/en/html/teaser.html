...
<head>
  ...
  <title>Introduction &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="next" title="General" href="officelink-adminmanual-preface-abstract.html"/>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Introduction</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/teaser.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-adminmanual-intro"></span><h1>Introduction<a class="headerlink" href="#einleitung" title="Permalink to this headline">¶</a></h1>
<p id="officelink-teaser"><em>CONTACT OfficeLink</em> provides a high level of integration for the Microsoft Office tools Word, Excel, PowerPoint, Outlook, Visio and Project. This integration allows you, for example, to search the system for documents, open the documents in order to edit them and then save the changes in the database. Document status and attributess can also be modified and new documents can be created in the system directly from Microsoft Office.</p>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-preface-abstract.html">General</a><ul class="simple">
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-preface-requirements.html">System requirements</a><ul class="simple">
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-preface-security.html">Security settings</a><ul>
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-preface-security.html#microsoft-office">Microsoft Office</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-preface-security.html#microsoft-windows">Microsoft Windows</a></li>
</ul>
</li>
</ul>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-preface-abstract.html" class="btn btn-neutral float-right" title="General" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
