...
<head>
  ...
  <title>System client &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Server" href="officelink-adminmanual-config-common-server.html"/>
        <link rel="prev" title="Language" href="officelink-adminmanual-config-common-client-language.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbook</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>System client</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-adminmanual-config-common-client-set-cdbwin.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="system-client">
<span id="officelink-adminmanual-config-common-client-set-cdbwin"></span><h1>System client<a class="headerlink" href="#system-client" title="Permalink to this headline">¶</a></h1>
<p>With this setting it is possible to specify the executable of the system client that is to be used when establishing a connection. If no complete path to an executable is defined, then the client to be started gets resolved as described in the chapter <em>Common logic of connections</em> of the <em>TalkAPI Reference Manual</em>.</p>
<div class="toctree-wrapper compound">
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-common-server.html" class="btn btn-neutral float-right" title="Server" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-common-client-language.html" class="btn btn-neutral" title="Language" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
