...
<head>
  ...
  <title>Language &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Client" href="officelink-adminmanual-config-common-client.html"/>
        <link rel="next" title="System client" href="officelink-adminmanual-config-common-client-set-cdbwin.html"/>
        <link rel="prev" title="Client" href="officelink-adminmanual-config-common-client.html"/> 
...
<li class="toctree-l2 current"><a class="reference internal" href="officelink-adminmanual-config-common.html">Common settings</a></li>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbook</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="officelink-adminmanual-config-common.html">Common settings</a> &raquo;</li>
      
          <li><a href="officelink-adminmanual-config-common-client.html">Client</a> &raquo;</li>
      
    <li>Language</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-adminmanual-config-common-client-language.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="sprache">
<span id="officelink-adminmanual-config-common-client-language"></span><h1>Language<a class="headerlink" href="#sprache" title="Permalink to this headline">¶</a></h1>
<p>In general, users have the option to configure the language of the user interface elements of the Microsoft Office integration in the settings dialog in accordance with their preference. If the language is changed in an Office application, the change applies to the Office integration globally. This means the language changes accordingly in all other supported Office applications.</p>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">Changing the language setting takes effect after restarting the Office application.</p>
</div>
<div class="toctree-wrapper compound">
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-common-client-set-cdbwin.html" class="btn btn-neutral float-right" title="System client" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-common-client.html" class="btn btn-neutral" title="Client" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
