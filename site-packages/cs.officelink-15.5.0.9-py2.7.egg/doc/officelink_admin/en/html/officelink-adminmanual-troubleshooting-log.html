...
<head>
  ...
  <title>Logbook &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Troubleshooting" href="officelink-adminmanual-troubleshooting.html"/>
        <link rel="prev" title="Troubleshooting" href="officelink-adminmanual-troubleshooting-table.html"/> 
...
<li class="toctree-l1 current"><a class="reference internal" href="officelink-adminmanual-troubleshooting.html">Troubleshooting</a><ul class="current">
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Logbook</a></li>
</ul>
</li>
</ul>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="officelink-adminmanual-troubleshooting.html">Troubleshooting</a> &raquo;</li>
      
    <li>Logbook</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-adminmanual-troubleshooting-log.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="logbuch">
<span id="officelink-adminmanual-troubleshooting-log"></span><h1>Logbook<a class="headerlink" href="#logbuch" title="Permalink to this headline">¶</a></h1>
<p>The system logbook allows the system behavior to be logged centrally for the analysis of software or configuration errors. In general, the logging is controlled using environment variables. For the general configuration and control of a system logbook, refer to the system administration and configuration manual. In the context of the system logbook configuration, the identification of the system application (CLIENT) for the Microsoft Office integration is <code class="docutils literal"><span class="pre">OfficeLink</span></code>.</p>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">The logbook can be activated resp. configured in the file <code class="file docutils literal"><span class="pre">OfficeLink.conf</span></code> which is located in the installation directory.</p>
</div>
<div class="toctree-wrapper compound">
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-troubleshooting-table.html" class="btn btn-neutral" title="Troubleshooting" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
