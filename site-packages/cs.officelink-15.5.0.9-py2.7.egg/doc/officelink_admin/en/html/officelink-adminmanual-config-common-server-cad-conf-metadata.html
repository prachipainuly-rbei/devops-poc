...
<head>
  ...
  <title>CAD switch: Metadata synchronization &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Server-side metadata synchronization" href="officelink-adminmanual-config-common-server-metadata-sync.html"/>
        <link rel="prev" title="Server" href="officelink-adminmanual-config-excel-server.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbook</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>CAD switch: Metadata synchronization</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-adminmanual-config-common-server-cad-conf-metadata.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="cad-schalter-metadatenabgleich">
<span id="officelink-adminmanual-config-common-server-cad-conf-metadata"></span><h1>CAD switch: Metadata synchronization<a class="headerlink" href="#cad-schalter-metadatenabgleich" title="Permalink to this headline">¶</a></h1>
<dl class="docutils">
<dt><code class="docutils literal"><span class="pre">Allow</span> <span class="pre">Metadata</span> <span class="pre">Write</span></code></dt>
<dd><p class="first last">Authorizes metadata synchronization to be written. For administrators, set to TRUE by default.</p>
</dd>
<dt><code class="docutils literal"><span class="pre">Allow</span> <span class="pre">Metadata</span> <span class="pre">Manage</span></code></dt>
<dd><p class="first last">Authorizes to use the system variables dialog. For administrators, set to TRUE by default.</p>
</dd>
</dl>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-common-server-metadata-sync.html" class="btn btn-neutral float-right" title="Server-side metadata synchronization" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-excel-server.html" class="btn btn-neutral" title="Server" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
