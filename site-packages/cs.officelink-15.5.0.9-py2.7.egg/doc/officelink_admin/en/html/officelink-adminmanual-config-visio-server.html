...
<head>
  ...
  <title>Server &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Visio" href="officelink-adminmanual-config-visio.html"/>
        <link rel="next" title="Word" href="officelink-adminmanual-config-word.html"/>
        <link rel="prev" title="Standard save format" href="officelink-adminmanual-config-visio-saveformat.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Server</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-adminmanual-config-visio-server.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-adminmanual-config-visio-server"></span><h1>Server<a class="headerlink" href="#server" title="Permalink to this headline">¶</a></h1>
...
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-server-fileproperties-preset-mask.html">File properties: Presetting masks</a></li>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-word.html" class="btn btn-neutral float-right" title="Word" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-visio-saveformat.html" class="btn btn-neutral" title="Standard save format" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
