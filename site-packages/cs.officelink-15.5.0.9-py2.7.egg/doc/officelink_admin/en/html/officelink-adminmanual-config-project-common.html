...
<head>
  ...
  <title>General tips (synchronization) &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Client" href="officelink-adminmanual-config-project-client.html"/>
        <link rel="next" title="Server" href="officelink-adminmanual-config-project-server.html"/>
        <link rel="prev" title="Client" href="officelink-adminmanual-config-project-client.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbook</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="officelink-adminmanual-config-project-client.html">Client</a> &raquo;</li>
      
    <li>General tips (synchronization)</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-adminmanual-config-project-common.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="allgemeine-hinweise-synchronisation">
<span id="officelink-adminmanual-config-project-common"></span><h1>General tips (synchronization)<a class="headerlink" href="#allgemeine-hinweise-synchronisation" title="Permalink to this headline">¶</a></h1>
<div class="admonition important">
<p class="first admonition-title">Important</p>
<p class="last">The operation in combination with MS Office Project Server is not supported.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-project-server.html" class="btn btn-neutral float-right" title="Server" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-project-client.html" class="btn btn-neutral" title="Client" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
