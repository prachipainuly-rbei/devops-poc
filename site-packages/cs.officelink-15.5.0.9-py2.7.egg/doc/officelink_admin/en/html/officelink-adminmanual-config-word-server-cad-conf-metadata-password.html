...
<head>
  ...
  <title>CAD switch: Metadata synchronization (II) &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Server" href="officelink-adminmanual-config-word-server.html"/>
        <link rel="next" title="DCS plug-in" href="officelink-adminmanual-dcs-plugin.html"/>
        <link rel="prev" title="Server" href="officelink-adminmanual-config-word-server.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbook</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="officelink-adminmanual-config-word-server.html">Server</a> &raquo;</li>
      
    <li>CAD switch: Metadata synchronization (II)</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-adminmanual-config-word-server-cad-conf-metadata-password.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="cad-schalter-metadatenabgleich-ii">
<span id="officelink-adminmanual-config-word-server-cad-conf-metadata-password"></span><h1>CAD switch: Metadata synchronization (II)<a class="headerlink" href="#cad-schalter-metadatenabgleich-ii" title="Permalink to this headline">¶</a></h1>
<dl class="docutils">
<dt><code class="docutils literal"><span class="pre">Force</span> <span class="pre">Metadata</span> <span class="pre">Write</span></code></dt>
<dd><p class="first last">If this switch is set to TRUE, any password protection of the document is NOT taken into account during a metadata synchronization. This means the password does not have to be entered in these cases to lift the protection temporarily. Set to FALSE by default.</p>
</dd>
</dl>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-dcs-plugin.html" class="btn btn-neutral float-right" title="DCS plug-in" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-word-server.html" class="btn btn-neutral" title="Server" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
