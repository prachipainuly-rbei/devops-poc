...
<head>
  ...
  <title>File properties: Presetting masks &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Outlook" href="officelink-adminmanual-config-outlook.html"/>
        <link rel="prev" title="CAD switch: Presetting masks" href="officelink-adminmanual-config-common-server-cad-conf-preset-mask.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbook</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>File properties: Presetting masks</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-adminmanual-config-common-server-fileproperties-preset-mask.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="dateieigenschaften-maskenvorbelegung">
<span id="officelink-adminmanual-config-common-server-fileproperties-preset-mask"></span><h1>File properties: Presetting masks<a class="headerlink" href="#dateieigenschaften-maskenvorbelegung" title="Permalink to this headline">¶</a></h1>
<p>If the creation of a new document is initiated, file properties of the document can be used to configure the creation dialog. To do so, the Microsoft Windows file properties have to be mapped to system attributes. You can configure this mapping in the system client in the menu tree under <span class="menuselection">Administration/Configuration ‣ Administration ‣ Desktop/WIN ‣ File properties</span>.</p>
<p>(For more information, refer to <span class="guilabel">Commit Microsoft Windows file attributes</span> in the manual <span class="guilabel">CONTACT Elements Administration and Configuration</span>).</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-outlook.html" class="btn btn-neutral float-right" title="Outlook" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-common-server-cad-conf-preset-mask.html" class="btn btn-neutral" title="CAD switch: Presetting masks" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
