...
<head>
  ...
  <title>Client &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Standard save format" href="officelink-adminmanual-config-visio-saveformat.html"/>
        <link rel="prev" title="Visio" href="officelink-adminmanual-config-visio.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Client</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-adminmanual-config-visio-client.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-adminmanual-config-visio-client"></span><h1>Client<a class="headerlink" href="#client" title="Permalink to this headline">¶</a></h1>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-visio-saveformat.html">Standard save format</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-metadata-toolbarbuttons.html">Toolbar buttons: Metadata synchronization</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-watch-local-filesave.html">Monitoring local save procedures</a><ul class="simple">
</ul>
</li>
</ul>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-visio-saveformat.html" class="btn btn-neutral float-right" title="Standard save format" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-visio.html" class="btn btn-neutral" title="Visio" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
