...
<head>
  ...
  <title>Common settings &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Client" href="officelink-adminmanual-config-common-client.html"/>
        <link rel="prev" title="Configuration" href="officelink-adminmanual-config.html"/> 
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Common settings</a></li>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbook</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Common settings</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-adminmanual-config-common.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="allgemeine-einstellungen">
<span id="officelink-adminmanual-config-common"></span><h1>Common settings<a class="headerlink" href="#allgemeine-einstellungen" title="Permalink to this headline">¶</a></h1>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-client.html">Client</a><ul>
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-config-common-client-language.html">Language</a></li>
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-config-common-client-set-cdbwin.html">System client</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-server.html">Server</a><ul>
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-config-common-server-cad-systems.html">Global CAD configuration</a></li>
</ul>
</li>
</ul>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-common-client.html" class="btn btn-neutral float-right" title="Client" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config.html" class="btn btn-neutral" title="Configuration" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
