...
<head>
  ...
  <title>CAD switch: Drawing &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="CAD property: esif" href="officelink-adminmanual-config-outlook-server-property-esif.html"/>
        <link rel="prev" title="CAD switch: Duplicate check" href="officelink-adminmanual-config-outlook-server-cad-conf-dup-check.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbook</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>CAD switch: Drawing</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-adminmanual-config-outlook-server-cad-conf-zeichnung.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="cad-schalter-zeichnung">
<span id="officelink-adminmanual-config-outlook-server-cad-conf-zeichnung"></span><h1>CAD switch: Drawing<a class="headerlink" href="#cad-schalter-zeichnung" title="Permalink to this headline">¶</a></h1>
<dl class="docutils">
<dt><code class="docutils literal"><span class="pre">ZVS</span> <span class="pre">Zeichnung</span> <span class="pre">Endung</span></code></dt>
<dd><p class="first">The file extension is evaluated for each attachment to be archived. At least one <code class="docutils literal"><span class="pre">ZVS</span> <span class="pre">Zeichnung</span> <span class="pre">Endung</span></code> CAD switch has to exist in the system for each of these file extensions.</p>
<div class="last admonition important">
<p class="first admonition-title">Important</p>
<p class="last">If no entry exists for a file extension, an empty selection dialog appears when attempting to archive the attachment. This means that this document category is not yet registered properly in the system. The procedure must be canceled at this point.</p>
</div>
</dd>
</dl>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-outlook-server-property-esif.html" class="btn btn-neutral float-right" title="CAD property: esif" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-outlook-server-cad-conf-dup-check.html" class="btn btn-neutral" title="CAD switch: Duplicate check" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
