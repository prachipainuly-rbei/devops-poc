...
<head>
  ...
  <title>Server &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Excel" href="officelink-adminmanual-config-excel.html"/>
        <link rel="next" title="CAD switch: Metadata synchronization" href="officelink-adminmanual-config-common-server-cad-conf-metadata.html"/>
        <link rel="prev" title="Monitoring local save procedures" href="officelink-adminmanual-config-common-watch-local-filesave.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Server</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-adminmanual-config-excel-server.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-adminmanual-config-excel-server"></span><h1>Server<a class="headerlink" href="#server" title="Permalink to this headline">¶</a></h1>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-server-cad-conf-metadata.html">CAD switch: Metadata synchronization</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-server-metadata-sync.html">Server-side metadata synchronization</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-server-cad-conf-preset-mask.html">CAD switch: Presetting masks</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-server-fileproperties-preset-mask.html">File properties: Presetting masks</a></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-common-server-cad-conf-metadata.html" class="btn btn-neutral float-right" title="CAD switch: Metadata synchronization" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-common-watch-local-filesave.html" class="btn btn-neutral" title="Monitoring local save procedures" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
