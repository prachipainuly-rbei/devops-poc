...
<head>
  ...
  <title>CAD property: esif &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="PowerPoint" href="officelink-adminmanual-config-powerpoint.html"/>
        <link rel="prev" title="CAD switch: Drawing" href="officelink-adminmanual-config-outlook-server-cad-conf-zeichnung.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbook</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>CAD property: esif</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-adminmanual-config-outlook-server-property-esif.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="cad-property-esif">
<span id="officelink-adminmanual-config-outlook-server-property-esif"></span><h1>CAD property: esif<a class="headerlink" href="#cad-property-esif" title="Permalink to this headline">¶</a></h1>
<dl class="docutils">
<dt><code class="docutils literal"><span class="pre">esif</span></code></dt>
<dd><p class="first">Archiving e-mails in the system which have been created via the document export function of the system client.</p>
<p class="last">If this property is configured and assigned the value &#8216;true&#8217;, the system client adds an accompanying system info file to the attachment list of this e-mail when exporting documents as e-mail. This info file contains information about the exported documents. If attempting to archive an e-mail in the system after completing the e-mail, the respective system documents are removed automatically from the list of documents to be archived. This prevents a redundant archiving of documents.</p>
</dd>
</dl>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-powerpoint.html" class="btn btn-neutral float-right" title="PowerPoint" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-outlook-server-cad-conf-zeichnung.html" class="btn btn-neutral" title="CAD switch: Drawing" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
