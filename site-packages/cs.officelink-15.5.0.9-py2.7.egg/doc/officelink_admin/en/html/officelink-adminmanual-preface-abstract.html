...
<head>
  ...
  <title>General &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Introduction" href="teaser.html"/>
        <link rel="next" title="System requirements" href="officelink-adminmanual-preface-requirements.html"/>
  ...
  <form id="rtd-search-form" class="wy-form" action="search.html" method="get">
    ...
    <input type="hidden" name="area" value="default" />
      ...
      <div class="wy-menu wy-menu-vertical" data-spy="affix" role="navigation" aria-label="main navigation">
              ...
              <ul class="current">
<li class="toctree-l1 current"><a class="reference internal" href="teaser.html">Introduction</a><ul class="current">
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbook</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="teaser.html">Introduction</a> &raquo;</li>
      
    <li>General</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-adminmanual-preface-abstract.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-adminmanual-preface-abstract"></span><h1>General<a class="headerlink" href="#allgemeines" title="Permalink to this headline">¶</a></h1>
<p>This manual outlines the requirements and necessary administrative configuration steps for using the Microsoft Office integration and the plug-ins for the DCS conversion server. Specifically, the system requirements, individual components and their potentially necessary customer-specific adjustments are described.</p>
<p>The Microsoft Office integration is implemented as a <em>COM Add-In</em> and is used as a system-specific expansion for Microsoft Office . The COM Add-In is primarily represented by a <code class="file docutils literal"><span class="pre">DLL</span></code> file and provides functions for selected Office applications.</p>
<div class="toctree-wrapper compound">
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-preface-requirements.html" class="btn btn-neutral float-right" title="System requirements" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
