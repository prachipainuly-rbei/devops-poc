...
<head>
  ...
  <title>CAD-Schalter: Maskenvorbelegung &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Dateieigenschaften: Maskenvorbelegung" href="officelink-adminmanual-config-common-server-fileproperties-preset-mask.html"/>
        <link rel="prev" title="Serverseitiger Metadatenabgleich" href="officelink-adminmanual-config-common-server-metadata-sync.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbuch</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>CAD-Schalter: Maskenvorbelegung</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-adminmanual-config-common-server-cad-conf-preset-mask.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="cad-schalter-maskenvorbelegung">
<span id="officelink-adminmanual-config-common-server-cad-conf-preset-mask"></span><h1>CAD-Schalter: Maskenvorbelegung<a class="headerlink" href="#cad-schalter-maskenvorbelegung" title="Link zu dieser Überschrift">¶</a></h1>
<dl class="docutils">
<dt><code class="docutils literal"><span class="pre">Preset</span> <span class="pre">new</span> <span class="pre">list</span> <span class="pre">CAD2CDB</span></code></dt>
<dd><p class="first">Die Vorbelegungen von Maskenattributen mit Metadaten können pro CAD-System und Anwender
anhand dieses CAD-Schalters konfiguriert werden.
Die in diesen CAD-Schaltern konfigurierten Abbildungen überschreiben diejenigen aus den
an anderer Stelle erwähnten <span class="menuselection">Dateieigenschaften</span> im System-Client.</p>
<p>Der Wert dieses Schalters enthält die Vorbelegungen. Die einzelnen Vorbelegungen werden
mit einem Semikolon getrennt. Die Konfiguration einer Vorbelegung richtet sich nach
folgendem Syntax:</p>
<p><span class="target" id="index-0"></span><code class="xref std std-envvar docutils literal"><span class="pre">System</span> <span class="pre">Attributname</span></code> =$(<span class="target" id="index-1"></span><code class="xref std std-envvar docutils literal"><span class="pre">Variable</span></code>)</p>
<p>Oder:</p>
<p><span class="target" id="index-2"></span><code class="xref std std-envvar docutils literal"><span class="pre">System</span> <span class="pre">Attributname</span></code> =Fester Wert</p>
<p>Beispiel:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>titel=My Prefix: $(Title);z_bemerkung=$(Subject)
</pre></div>
</div>
<div class="last admonition note">
<p class="first admonition-title">Bemerkung</p>
<p class="last">Für eine vollständige Liste möglicher Variablen siehe <span class="guilabel">Übernahme von Microsoft Windows-Dateiattributen</span> im CONTACT Elements Handbuch <span class="guilabel">Administration und Konfiguration</span>.</p>
</div>
</dd>
</dl>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-common-server-fileproperties-preset-mask.html" class="btn btn-neutral float-right" title="Dateieigenschaften: Maskenvorbelegung" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-common-server-metadata-sync.html" class="btn btn-neutral" title="Serverseitiger Metadatenabgleich" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
