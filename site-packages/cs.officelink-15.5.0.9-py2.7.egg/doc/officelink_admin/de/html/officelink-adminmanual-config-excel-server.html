...
<head>
  ...
  <title>Server &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="CAD-Schalter: Metadatenabgleich" href="officelink-adminmanual-config-common-server-cad-conf-metadata.html"/>
        <link rel="prev" title="Überwachen lokaler Speichervorgänge" href="officelink-adminmanual-config-common-watch-local-filesave.html"/> 
...
<span id="officelink-adminmanual-config-excel-server"></span><h1>Server<a class="headerlink" href="#server" title="Link zu dieser Überschrift">¶</a></h1>
...
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-server-fileproperties-preset-mask.html">Dateieigenschaften: Maskenvorbelegung</a></li>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-common-server-cad-conf-metadata.html" class="btn btn-neutral float-right" title="CAD-Schalter: Metadatenabgleich" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-common-watch-local-filesave.html" class="btn btn-neutral" title="Überwachen lokaler Speichervorgänge" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
