...
<head>
  ...
  <title>Toolbarbuttons: Metadatenabgleich &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Überwachen lokaler Speichervorgänge" href="officelink-adminmanual-config-common-watch-local-filesave.html"/>
        <link rel="prev" title="Standardspeicherformat" href="officelink-adminmanual-config-excel-saveformat.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbuch</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Toolbarbuttons: Metadatenabgleich</li>
...
<span id="officelink-adminmanual-config-common-metadata-toolbarbuttons"></span><h1>Toolbarbuttons: Metadatenabgleich<a class="headerlink" href="#toolbarbuttons-metadatenabgleich" title="Link zu dieser Überschrift">¶</a></h1>
<p>In dem Einstellungsdialog können für den Metaddatenabgleich optionale Funktionen der Toolbar ein- und
ausgeblendet werden. Zur Zeit ist dies für die Funktionen &#8220;Übergeben&#8221; von Metadaten und
&#8220;Verwalten&#8221; von Dokumentvariablen möglich, da diese Funktionen nur dann benötigt werden,
wenn Änderungen am Dokumentinhalt auch in das System übernommen werden sollen (siehe
Metadatensynchronisation mit dem System), oder wenn Dokumentvariablen hinzugefügt,
verändert oder gelöscht werden sollen (siehe Vorlagen zum Datenabgleich erstellen).
Zusätzlich ist die Ausführbarkeit diese beider Funtionen an 2 CAD-Schalter gebunden
(siehe <a class="reference internal" href="officelink-adminmanual-config-common-server-cad-conf-metadata.html#officelink-adminmanual-config-common-server-cad-conf-metadata"><span class="std std-ref">CAD-Schalter: Metadatenabgleich</span></a>).</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-common-watch-local-filesave.html" class="btn btn-neutral float-right" title="Überwachen lokaler Speichervorgänge" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-excel-saveformat.html" class="btn btn-neutral" title="Standardspeicherformat" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
