...
<head>
  ...
  <title>Allgemeines &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Einleitung" href="teaser.html"/>
        <link rel="next" title="Systemvoraussetzungen" href="officelink-adminmanual-preface-requirements.html"/>
  ...
  <form id="rtd-search-form" class="wy-form" action="search.html" method="get">
    ...
    <input type="hidden" name="area" value="default" />
      ...
      <div class="wy-menu wy-menu-vertical" data-spy="affix" role="navigation" aria-label="main navigation">
              ...
              <ul class="current">
<li class="toctree-l1 current"><a class="reference internal" href="teaser.html">Einleitung</a><ul class="current">
<li class="toctree-l2 current"><a class="current reference internal" href="#">Allgemeines</a></li>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbuch</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="teaser.html">Einleitung</a> &raquo;</li>
...
<span id="officelink-adminmanual-preface-abstract"></span><h1>Allgemeines<a class="headerlink" href="#allgemeines" title="Link zu dieser Überschrift">¶</a></h1>
<p>Dieses Handbuch beschreibt die Voraussetzungen und notwendigen administrativen Konfigurationsschritte für den
Einsatz der Microsoft Office-Integration und der Plug-Ins für den DCS-Konvertierungsserver.
Konkret werden die Systemvoraussetzungen, die einzelnen Komponenten und
deren gegebenenfalls notwendigen kundenspezifischen Anpassungen beschrieben.</p>
<p>Die Microsoft Office-Integration ist als <em>COM Add-In</em> realisiert und dient als
System-spezifische Erweiterung für Microsoft Office .
Das COM Add-In wird primär durch eine <code class="file docutils literal"><span class="pre">DLL</span></code> -Datei repräsentiert und
bietet Funktionalitäten für ausgewählte Office-Anwendungen.</p>
<div class="toctree-wrapper compound">
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-preface-requirements.html" class="btn btn-neutral float-right" title="Systemvoraussetzungen" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
