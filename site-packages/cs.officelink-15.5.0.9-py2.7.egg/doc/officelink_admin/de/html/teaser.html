...
<head>
  ...
  <title>Einleitung &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="next" title="Allgemeines" href="officelink-adminmanual-preface-abstract.html"/>
  ...
  <form id="rtd-search-form" class="wy-form" action="search.html" method="get">
    ...
    <input type="hidden" name="area" value="default" />
      ...
      <div class="wy-menu wy-menu-vertical" data-spy="affix" role="navigation" aria-label="main navigation">
              ...
              <ul class="current">
<li class="toctree-l1 current"><a class="current reference internal" href="#">Einleitung</a><ul>
...
<span id="officelink-adminmanual-intro"></span><h1>Einleitung<a class="headerlink" href="#einleitung" title="Link zu dieser Überschrift">¶</a></h1>
<p id="officelink-teaser"><em>CONTACT OfficeLink</em> stellt eine tiefe Integration der Microsoft Office Werkzeuge Word, Excel, PowerPoint, Outlook, Visio und Project zur Verfügung. Die Integrationen bieten zum Beispiel die Möglichkeit, Dokumente im System zu suchen, zur Bearbeitung zu öffnen und daraufhin Änderungen in der Datenbank zu speichern. Weiterhin können Dokumentstatus oder -eigenschaften geändert oder direkt aus der Microsoft-Office-Anwendung heraus neue Dokumente im System angelegt werden.</p>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-preface-abstract.html">Allgemeines</a><ul class="simple">
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-preface-requirements.html">Systemvoraussetzungen</a><ul class="simple">
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-preface-security.html">Sicherheitseinstellungen</a><ul>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-preface-security.html#microsoft-windows">Microsoft Windows</a></li>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-preface-abstract.html" class="btn btn-neutral float-right" title="Allgemeines" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
