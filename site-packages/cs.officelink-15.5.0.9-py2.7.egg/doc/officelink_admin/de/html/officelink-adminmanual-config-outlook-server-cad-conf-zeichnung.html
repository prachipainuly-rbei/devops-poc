...
<head>
  ...
  <title>CAD-Schalter: Zeichnung &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="prev" title="CAD-Schalter: Duplikatsprüfung" href="officelink-adminmanual-config-outlook-server-cad-conf-dup-check.html"/> 
...
<span id="officelink-adminmanual-config-outlook-server-cad-conf-zeichnung"></span><h1>CAD-Schalter: Zeichnung<a class="headerlink" href="#cad-schalter-zeichnung" title="Link zu dieser Überschrift">¶</a></h1>
<dl class="docutils">
<dt><code class="docutils literal"><span class="pre">ZVS</span> <span class="pre">Zeichnung</span> <span class="pre">Endung</span></code></dt>
<dd><p class="first">Für jede zu archivierende Anlage wird die Dateiendung ausgewertet. Zu jeder
dieser Dateiendungen muss mindestens einen CAD-Schalter <code class="docutils literal"><span class="pre">ZVS</span> <span class="pre">Zeichnung</span> <span class="pre">Endung</span></code> im System existieren.</p>
<div class="last admonition important">
<p class="first admonition-title">Wichtig</p>
<p class="last">Sollte kein Eintrag zu einer Dateiendung existieren, erscheint beim
Archivierungsversuch der Anlage mit dieser Dateiendung ein leerer
Auswahldialog. D.h. diese Dokumentkategorie ist noch nicht ordnungsgemäß
im System registriert. Der Vorgang muss an dieser Stelle abgebrochen werden.</p>
</div>
</dd>
</dl>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-outlook-server-cad-conf-dup-check.html" class="btn btn-neutral" title="CAD-Schalter: Duplikatsprüfung" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
