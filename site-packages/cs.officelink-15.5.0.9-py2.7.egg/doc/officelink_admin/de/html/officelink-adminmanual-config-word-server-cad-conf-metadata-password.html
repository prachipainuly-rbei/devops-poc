...
<head>
  ...
  <title>CAD-Schalter: Metadatenabgleich (II) &mdash; OfficeLink</title>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbuch</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>CAD-Schalter: Metadatenabgleich (II)</li>
...
<span id="officelink-adminmanual-config-word-server-cad-conf-metadata-password"></span><h1>CAD-Schalter: Metadatenabgleich (II)<a class="headerlink" href="#cad-schalter-metadatenabgleich-ii" title="Link zu dieser Überschrift">¶</a></h1>
<dl class="docutils">
<dt><code class="docutils literal"><span class="pre">Force</span> <span class="pre">Metadata</span> <span class="pre">Write</span></code></dt>
<dd>Falls dieser Schalter auf TRUE gesetzt ist, wird bei einem Metadatenabgeleich ein
eventueller Passwortschutz des Dokumentes NICHT berücksichtigt. D.h. muss in solchen
Fällen nicht das Passwort eingeben werden, um den Schutz temporär aufzuheben.
Standardmäßig auf FALSE gesetzt.</dd>
</dl>
</div>
