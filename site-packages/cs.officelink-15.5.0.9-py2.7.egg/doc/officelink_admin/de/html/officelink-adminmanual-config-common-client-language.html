...
<head>
  ...
  <title>Sprache &mdash; OfficeLink</title>
...
<li class="toctree-l2 current"><a class="reference internal" href="officelink-adminmanual-config-common.html">Allgemeine Einstellungen</a></li>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbuch</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="officelink-adminmanual-config-common.html">Allgemeine Einstellungen</a> &raquo;</li>
...
<span id="officelink-adminmanual-config-common-client-language"></span><h1>Sprache<a class="headerlink" href="#sprache" title="Link zu dieser Überschrift">¶</a></h1>
<p>Generell hat der Benutzer die Möglichkeit, die Sprache der Oberflächenelemente
der Microsoft Office-Integration im Einstellungsdialog gemäß seiner Präferenz einzustellen.
Wird die Sprache in einer der Office Anwendungen geändert, wirkt sich diese Änderung global
auf die Office Integration aus. D.h. die Sprache ändert sich dementsprechend in allen anderen
unterstützen Office Anwendungen.</p>
<div class="admonition note">
<p class="first admonition-title">Bemerkung</p>
<p class="last">Das Ändern der Spracheinstellung tritt erst nach einem Neustart der Office Anwendung in Kraft.</p>
</div>
