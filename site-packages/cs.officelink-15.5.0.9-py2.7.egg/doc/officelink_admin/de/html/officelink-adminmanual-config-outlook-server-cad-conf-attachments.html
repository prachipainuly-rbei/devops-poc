...
<head>
  ...
  <title>CAD-Schalter: Dateianhänge &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="CAD-Schalter: Duplikatsprüfung" href="officelink-adminmanual-config-outlook-server-cad-conf-dup-check.html"/>
        <link rel="prev" title="CAD-Schalter: Maskenvorbelegung" href="officelink-adminmanual-config-outlook-server-cad-conf-preset-mask.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbuch</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>CAD-Schalter: Dateianhänge</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-adminmanual-config-outlook-server-cad-conf-attachments.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="cad-schalter-dateianhange">
<span id="officelink-adminmanual-config-outlook-server-cad-conf-attachments"></span><h1>CAD-Schalter: Dateianhänge<a class="headerlink" href="#cad-schalter-dateianhange" title="Link zu dieser Überschrift">¶</a></h1>
<dl class="docutils">
<dt><code class="docutils literal"><span class="pre">Disable</span> <span class="pre">Attach</span> <span class="pre">Document</span></code></dt>
<dd>Anhand dieses Schalters kann die Funktion &#8220;Dokument anhängen&#8221; explizit deaktiviert werden.
Standardmäßig ist diese Funktion verfügbar.</dd>
<dt><code class="docutils literal"><span class="pre">Disallow</span> <span class="pre">Delete</span> <span class="pre">Attachment</span></code></dt>
<dd>Mit diesem Schalter kann das Entfernen von Anhängen aus Emails vor dem
Archivieren verhindert werden. Standardmäßig ist diese Funktion deaktiviert.</dd>
</dl>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-outlook-server-cad-conf-dup-check.html" class="btn btn-neutral float-right" title="CAD-Schalter: Duplikatsprüfung" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-outlook-server-cad-conf-preset-mask.html" class="btn btn-neutral" title="CAD-Schalter: Maskenvorbelegung" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
