...
<head>
  ...
  <title>Auswahldialog ‘Im System zu speichernde Dokumente’ &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="prev" title="Anhängen von System Dokumenten" href="officelink-adminmanual-config-outlook-attach-cdb-doc.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbuch</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Auswahldialog &#8216;Im System zu speichernde Dokumente&#8217;</li>
...
<span id="officelink-adminmanual-config-outlook-savedialog"></span><h1>Auswahldialog &#8216;Im System zu speichernde Dokumente&#8217;<a class="headerlink" href="#auswahldialog-im-system-zu-speichernde-dokumente" title="Link zu dieser Überschrift">¶</a></h1>
<p>Der beim Archivierungsvorgang erscheinende (und standardmäßig aktivierte) Auswahldialog
kann im Einstellungsdialog deaktiviert werden. Desweiteren können die Standard-Archivierungs-
Aktionen getrennt für Emails und Anhänge festgelegt werden. Falls der Dialog aktiviert ist,
werden Emails und Anhänge mit diesen Standardaktionen im Dialog vorbelegt. Falls er
deaktiviert ist, werden immer für alle Emails und Anhänge diese Standardaktionen ausgeführt.</p>
<div class="admonition important">
<p class="first admonition-title">Wichtig</p>
<p class="last">Falls in Outlook eine oder mehrere Emails, welche keine Anhänge beinhalten, für das
Archivieren selektiert werden, erscheint der Auswahldialog nicht.</p>
</div>
<div class="admonition note">
<p class="first admonition-title">Bemerkung</p>
<p class="last">Das Löschen von Anhängen aus zu archivierenden Emails über den Auswahldialog oder über das
Festlegen dieser Standardaktion bei deaktiviertem Auswahldialog, kann durch den
CAD-Schalter &#8220;Disallow Delete Attachment&#8221; (siehe <a class="reference internal" href="officelink-adminmanual-config-outlook-server.html#officelink-adminmanual-config-outlook-server"><span class="std std-ref">Server</span></a> ) verhindert werden.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-outlook-attach-cdb-doc.html" class="btn btn-neutral" title="Anhängen von System Dokumenten" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
