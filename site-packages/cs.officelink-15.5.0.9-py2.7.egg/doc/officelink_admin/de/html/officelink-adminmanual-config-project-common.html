...
<head>
  ...
  <title>Allgemeine Hinweise (Synchronisation) &mdash; OfficeLink</title>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbuch</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Allgemeine Hinweise (Synchronisation)</li>
...
<span id="officelink-adminmanual-config-project-common"></span><h1>Allgemeine Hinweise (Synchronisation)<a class="headerlink" href="#allgemeine-hinweise-synchronisation" title="Link zu dieser Überschrift">¶</a></h1>
<div class="admonition important">
<p class="first admonition-title">Wichtig</p>
<p class="last">Der Betrieb in Kombination mit MS Office Project Server wird nicht unterstützt.</p>
</div>
</div>
