...
<head>
  ...
  <title>Server &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="CAD-Schalter: Metadatenabgleich (II)" href="officelink-adminmanual-config-word-server-cad-conf-metadata-password.html"/>
        <link rel="prev" title="Standardspeicherformat" href="officelink-adminmanual-config-word-saveformat.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Server</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/officelink-adminmanual-config-word-server.txt" rel="nofollow"> View page source</a>
...
<span id="officelink-adminmanual-config-word-server"></span><h1>Server<a class="headerlink" href="#server" title="Link zu dieser Überschrift">¶</a></h1>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-server-cad-conf-metadata.html">CAD-Schalter: Metadatenabgleich</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-server-metadata-sync.html">Serverseitiger Metadatenabgleich</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-word-server-cad-conf-metadata-password.html">CAD-Schalter: Metadatenabgleich (II)</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-server-cad-conf-preset-mask.html">CAD-Schalter: Maskenvorbelegung</a></li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-server-fileproperties-preset-mask.html">Dateieigenschaften: Maskenvorbelegung</a></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-word-server-cad-conf-metadata-password.html" class="btn btn-neutral float-right" title="CAD-Schalter: Metadatenabgleich (II)" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-word-saveformat.html" class="btn btn-neutral" title="Standardspeicherformat" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
