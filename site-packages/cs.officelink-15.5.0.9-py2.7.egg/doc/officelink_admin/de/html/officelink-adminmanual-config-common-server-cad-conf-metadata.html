...
<head>
  ...
  <title>CAD-Schalter: Metadatenabgleich &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Serverseitiger Metadatenabgleich" href="officelink-adminmanual-config-common-server-metadata-sync.html"/>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbuch</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>CAD-Schalter: Metadatenabgleich</li>
...
<span id="officelink-adminmanual-config-common-server-cad-conf-metadata"></span><h1>CAD-Schalter: Metadatenabgleich<a class="headerlink" href="#cad-schalter-metadatenabgleich" title="Link zu dieser Überschrift">¶</a></h1>
<dl class="docutils">
<dt><code class="docutils literal"><span class="pre">Allow</span> <span class="pre">Metadata</span> <span class="pre">Write</span></code></dt>
<dd>Berechtigt zu schreibendem Metadatenabgleich. Standardmäßig für Administratoren auf TRUE gesetzt.</dd>
<dt><code class="docutils literal"><span class="pre">Allow</span> <span class="pre">Metadata</span> <span class="pre">Manage</span></code></dt>
<dd>Berechtigt zur Benutzung des System-Variablen-Dialogs. Standardmäßig für Administratoren auf TRUE gesetzt.</dd>
</dl>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-common-server-metadata-sync.html" class="btn btn-neutral float-right" title="Serverseitiger Metadatenabgleich" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
