...
<head>
  ...
  <title>Anhängen von System Dokumenten &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Auswahldialog ‘Im System zu speichernde Dokumente’" href="officelink-adminmanual-config-outlook-savedialog.html"/>
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbuch</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Anhängen von System Dokumenten</li>
...
<span id="officelink-adminmanual-config-outlook-attach-cdb-doc"></span><h1>Anhängen von System Dokumenten<a class="headerlink" href="#anhangen-von-system-dokumenten" title="Link zu dieser Überschrift">¶</a></h1>
<p>Falls beim Anhängen von Dokumenten aus dem System an eine Email gleich mehrere Dateien an einem dieser Dokumente anhaften, dann
kann der zusätzlich folgende Auswahldialog automatisch übersprungen werden. Bedingung ist dabei jedoch, dass alle ausgewählten
Dokumente nur eine Hauptdatei enthalten. Falls ein ausgewähltes Dokument mit keiner oder mehreren Hauptdateien behaftet ist,
dann erscheint wiederum zwingendermaßen der zusätzliche Auswahldialog.</p>
<p>Desweiteren kann eine bevorzugte Auswahl von Sekundärformaten eingestellt werden. Falls z.B. Dokumente mit einer
PDF-Version der Hauptdatei behaftet sind, und man in der Regel die jeweilige PDF-Version anstatt der Hauptdatei versenden möchte,
dann kann diese Auswahl automatisiert werden. Falls nun also im Einstellungsdialog &#8221;.pdf&#8221; als bevorzugtes Sekundärformat
eingetragen wird, dann werden intern jeweils die PDF-Datei anstelle der Hauptdatei ausgewählt. Dies würde zum einen bedeuten,
dass beim Erscheinen des zusätzlichen Auswahldialoges die PDF-Datei bereits anstelle der Hauptdatei vorselektiert ist. Zum anderen
würde bei einem automatischen Überspringen des Auswahldialoges die PDF-Datei anstelle der Hauptdatei an die Email geheftet werden.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-outlook-savedialog.html" class="btn btn-neutral float-right" title="Auswahldialog ‘Im System zu speichernde Dokumente’" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
