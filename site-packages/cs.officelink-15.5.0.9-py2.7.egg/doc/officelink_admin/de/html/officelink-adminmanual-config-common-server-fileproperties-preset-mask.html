...
<head>
  ...
  <title>Dateieigenschaften: Maskenvorbelegung &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="prev" title="CAD-Schalter: Maskenvorbelegung" href="officelink-adminmanual-config-common-server-cad-conf-preset-mask.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbuch</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Dateieigenschaften: Maskenvorbelegung</li>
...
<span id="officelink-adminmanual-config-common-server-fileproperties-preset-mask"></span><h1>Dateieigenschaften: Maskenvorbelegung<a class="headerlink" href="#dateieigenschaften-maskenvorbelegung" title="Link zu dieser Überschrift">¶</a></h1>
<p>Wird eine Neuanlage eines Dokuments ausgelöst, können Dateieigenschaften des Dokuments benutzt werden,
um den Neuanlagedialog zu parametrisieren. Dazu müssen die Microsoft Windows-Dateieigenschaften auf
System-Attribute abgebildet werden. Diese Abbildung konfigurieren Sie im System-Client im Menübaum unter <span class="menuselection">Administration/Konfiguration ‣ Administration ‣ Desktop/WIN ‣ Dateieigenschaften</span>.</p>
<p>(Näheres dazu unter <span class="guilabel">Übernahme von Microsoft Windows-Dateiattributen</span> im Handbuch <span class="guilabel">CONTACT Elements Administrations- und Konfiguration</span>).</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-common-server-cad-conf-preset-mask.html" class="btn btn-neutral" title="CAD-Schalter: Maskenvorbelegung" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
