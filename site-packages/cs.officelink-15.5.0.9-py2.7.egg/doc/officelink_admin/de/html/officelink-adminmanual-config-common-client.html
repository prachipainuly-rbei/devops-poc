...
<head>
  ...
  <title>Client &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        <link rel="up" title="Allgemeine Einstellungen" href="officelink-adminmanual-config-common.html"/>
        <link rel="next" title="Sprache" href="officelink-adminmanual-config-common-client-language.html"/>
        <link rel="prev" title="Allgemeine Einstellungen" href="officelink-adminmanual-config-common.html"/> 
...
<span id="officelink-adminmanual-config-common-client"></span><h1>Client<a class="headerlink" href="#client" title="Link zu dieser Überschrift">¶</a></h1>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-client-language.html">Sprache</a><ul class="simple">
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="officelink-adminmanual-config-common-client-set-cdbwin.html">System-Client</a><ul class="simple">
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-common-client-language.html" class="btn btn-neutral float-right" title="Sprache" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-common.html" class="btn btn-neutral" title="Allgemeine Einstellungen" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
