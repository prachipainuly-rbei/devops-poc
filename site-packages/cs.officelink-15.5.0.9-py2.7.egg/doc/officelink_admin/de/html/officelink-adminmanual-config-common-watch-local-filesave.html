...
<head>
  ...
  <title>Überwachen lokaler Speichervorgänge &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="next" title="Server" href="officelink-adminmanual-config-excel-server.html"/>
        <link rel="prev" title="Toolbarbuttons: Metadatenabgleich" href="officelink-adminmanual-config-common-metadata-toolbarbuttons.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="officelink-adminmanual-troubleshooting-log.html">Logbuch</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Überwachen lokaler Speichervorgänge</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/officelink-adminmanual-config-common-watch-local-filesave.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="uberwachen-lokaler-speichervorgange">
<span id="officelink-adminmanual-config-common-watch-local-filesave"></span><h1>Überwachen lokaler Speichervorgänge<a class="headerlink" href="#uberwachen-lokaler-speichervorgange" title="Link zu dieser Überschrift">¶</a></h1>
<p>Durch Auswahl der Option <span class="guilabel">Lokales Speichern von System Dokumenten überwachen</span>
wird die Kopplung angewiesen, beim Speichern oder Schließen von Office-Dokumenten, welche im
System zum Bearbeiten geöffnet wurden, durch einen Dialog auf eventuelle Änderungen aufmerksam
zu machen und gleichzeitig die Möglichkeit zu geben, diese direkt im System zu speichern.</p>
<div class="toctree-wrapper compound">
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-excel-server.html" class="btn btn-neutral float-right" title="Server" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="officelink-adminmanual-config-common-metadata-toolbarbuttons.html" class="btn btn-neutral" title="Toolbarbuttons: Metadatenabgleich" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
