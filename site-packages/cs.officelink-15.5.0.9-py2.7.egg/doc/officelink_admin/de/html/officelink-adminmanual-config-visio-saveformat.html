...
<head>
  ...
  <title>Standardspeicherformat &mdash; OfficeLink</title>
...
<span id="officelink-adminmanual-config-visio-saveformat"></span><h1>Standardspeicherformat<a class="headerlink" href="#standardspeicherformat" title="Link zu dieser Überschrift">¶</a></h1>
<p>Dieser Menüpunkt ist nur dann relevant, wenn für Microsoft Visio
mehrere Speicherformate im System eingerichtet sind (siehe <a class="reference internal" href="officelink-adminmanual-config-common-server-cad-systems.html#officelink-adminmanual-config-common-server-cad-systems"><span class="std std-ref">Allgemeine CAD-Konfiguration</span></a>).
Unter Visio 2010 ist diese Einstellung
irrelevant, da für diese Visio Versionen ausschließlich das System MS-Visio (.vsd)
unterstützt wird. Ab Visio 2013 stehen je nach Konfiguration mehrere Speicherformate
zur Auswahl. Das hier eingestellte Standardspeicherformat wird bei der Dokumentenneuanlage
von ungespeicherten Dokumenten zur Formatermittlung verwendet (siehe Neuanlage im System).</p>
<div class="admonition note">
<p class="first admonition-title">Bemerkung</p>
<p>Administrativ kann das Speicherformat z.B. über eine Registrydatei (.REG) verteilt und
dadurch vorbelegt werden. Beispielinhalt einer Registrydatei:</p>
...
<p class="rubric">Speicherformate</p>
