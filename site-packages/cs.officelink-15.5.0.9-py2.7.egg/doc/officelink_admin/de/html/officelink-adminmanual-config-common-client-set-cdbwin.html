...
<head>
  ...
  <title>System-Client &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="prev" title="Sprache" href="officelink-adminmanual-config-common-client-language.html"/> 
...
<span id="officelink-adminmanual-config-common-client-set-cdbwin"></span><h1>System-Client<a class="headerlink" href="#system-client" title="Link zu dieser Überschrift">¶</a></h1>
<p>Mit Hilfe dieser Einstellung ist es möglich die ausführbare Datei vom System-Client anzugeben,
die bei einem Verbindungsaufbau genutzt werden soll. Insofern hier kein vollständiger
Pfad zu einer ausführbaren Datei definiert ist, so wird der zu startende Client wie
im Abschnitt <em>Allgemeine Logik beim Verbindungsaufbau</em> des <em>TalkAPI Referenz Handbuches</em>
beschrieben verwendet.</p>
<div class="toctree-wrapper compound">
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-common-client-language.html" class="btn btn-neutral" title="Sprache" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
