...
<head>
  ...
  <title>CAD-Property: esif &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="prev" title="CAD-Schalter: Zeichnung" href="officelink-adminmanual-config-outlook-server-cad-conf-zeichnung.html"/> 
...
<span id="officelink-adminmanual-config-outlook-server-property-esif"></span><h1>CAD-Property: esif<a class="headerlink" href="#cad-property-esif" title="Link zu dieser Überschrift">¶</a></h1>
<dl class="docutils">
<dt><code class="docutils literal"><span class="pre">esif</span></code></dt>
<dd><p class="first">Archivieren von Emails im System, welche über die Dokument-Export-Funktion des System Clients erstellt wurden.</p>
<p class="last">Falls diese Property konfiguriert und mit dem Wert &#8216;true&#8217; belegt ist, dann fügt der System Client beim
Exportieren von Dokumenten als Email der Anlagenliste dieser Email eine begleitende System Info-Datei hinzu.
Diese Info-Datei enthält Informationen über die exportierten Dokumente. Wenn nach dem Fertigstellen
der Email versucht wird, sie im System zu archivieren, werden die jeweiligen System Dokumente automatisch
aus der Liste der zu archivierenden Dokumente entfernt. Dadurch wird ein redundantes Archivieren
von Dokumenten verhindert.</p>
</dd>
</dl>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-config-outlook-server-cad-conf-zeichnung.html" class="btn btn-neutral" title="CAD-Schalter: Zeichnung" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
