...
<head>
  ...
  <title>Logbuch &mdash; OfficeLink</title>
    ...
    <link rel="top" title="OfficeLink" href="index.html"/>
        ...
        <link rel="prev" title="Fehler-Ursachen-Lösungen" href="officelink-adminmanual-troubleshooting-table.html"/> 
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Logbuch</a></li>
</ul>
</li>
</ul>
...
<span id="officelink-adminmanual-troubleshooting-log"></span><h1>Logbuch<a class="headerlink" href="#logbuch" title="Link zu dieser Überschrift">¶</a></h1>
<p>Das System-Logbuch ermöglicht eine zentrale Protokollierung des Systemverhaltens zur Analyse von Software-
oder Konfigurierungsfehlern. Grundsätzlich wird die Protokollierung über Umgebungsvariable gesteuert. Die
allgemeine Konfiguration und Steuerung eines System-Logbuchs entnehmen Sie bitte dem System-Administrations- und
Konfigurationshandbuch. Im Kontext der System-Logbuch-Konfiguration lautet die Kennung der System-Anwendung
(CLIENT) für die Microsoft Office-Integration <code class="docutils literal"><span class="pre">OfficeLink</span></code> .</p>
<div class="admonition note">
<p class="first admonition-title">Bemerkung</p>
<p class="last">Das Logbuch lässt sich auch über die sich im Installationsverzeichnis befindliche Datei
<code class="file docutils literal"><span class="pre">OfficeLink.conf</span></code> aktivieren bzw. konfigurieren.</p>
</div>
<div class="toctree-wrapper compound">
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="officelink-adminmanual-troubleshooting-table.html" class="btn btn-neutral" title="Fehler-Ursachen-Lösungen" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
