...
<head>
  ...
  <title>DashboardItem &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        <link rel="up" title="cs-web-dashboard" href="__package_index__.html"/>
        <link rel="next" title="ObjectListWidget" href="ObjectListWidget.html"/>
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="../../index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="__package_index__.html">cs-web-dashboard</a> &raquo;</li>
      
    <li>DashboardItem</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-dashboard/DashboardItem.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="dashboarditem">
<span id="cs-web-dashboard-dashboarditem-dashboarditem"></span><h1>DashboardItem<a class="headerlink" href="#dashboarditem" title="Permalink to this headline">¶</a></h1>
...
<p>A DashboardItem must be used by every widget implementation to render the
outer frame of an element. The react children of the DashboardItem will be
rendered as the element’s body.</p>
</div>
...
<td>Data to be displayed in the element</td>
</tr>
...
<td>A string to be rendered as the element’s title</td>
</tr>
<tr class="row-even"><td>configCallback</td>
<td>function</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>Configuration callback to store settings</td>
</tr>
<tr class="row-odd"><td>appLink</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>A string containing an application url. If specified
a button in the upright corner will be shown to
this application.</td>
</tr>
<tr class="row-even"><td>appNewWindow</td>
<td>bool</td>
<td>false</td>
<td>Specifies wether or not to open the linked
application in a new tab / window.</td>
</tr>
</tbody>
</table>
<p>The <code class="xref py py-obj docutils literal"><span class="pre">item</span></code> holds some system defined properties for use by the framework, and a
key <code class="xref py py-obj docutils literal"><span class="pre">settings</span></code> that is also an Immutable.Map, and contains the data for a
specific element. This property is passed to the widget implementation by the
framework, and must be forwarded as is to the DashboardItem.</p>
<p>If <code class="xref py py-obj docutils literal"><span class="pre">configCallback</span></code> is present, the DashboardItem will render a configuration
...
action method <code class="xref py py-obj docutils literal"><span class="pre">setSettings</span></code> to store the configuration.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="ObjectListWidget.html" class="btn btn-neutral float-right" title="ObjectListWidget" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
