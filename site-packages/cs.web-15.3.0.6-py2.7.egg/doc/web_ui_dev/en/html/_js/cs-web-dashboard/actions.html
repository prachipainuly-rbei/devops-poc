...
<head>
  ...
  <title>actions &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="DashboardItem" href="DashboardItem.html"/>
        <link rel="prev" title="cs-web-dashboard" href="__package_index__.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>actions</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-dashboard/actions.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-dashboard-actions-module"></span><h1>actions<a class="headerlink" href="#actions" title="Permalink to this headline">¶</a></h1>
...
<div class="section" id="setsettings">
<span id="cs-web-dashboard-actions-setsettings"></span><h4>setSettings<a class="headerlink" href="#setsettings" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">setSettings</span><span class="p">(</span><span class="nx">item</span><span class="o">:</span> <span class="nx">Immutable</span><span class="p">.</span><span class="nx">Map</span><span class="p">,</span> <span class="nx">settings</span><span class="o">:</span> <span class="nx">Immutable</span><span class="p">.</span><span class="nx">Map</span><span class="p">)</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>item</em>: The item represented by the dashboard element</li>
<li><em>settings</em>: The data for the element</li>
</ul>
<p>Redux action method to store the settings for a dashboard element.</p>
</div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="DashboardItem.html" class="btn btn-neutral float-right" title="DashboardItem" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="__package_index__.html" class="btn btn-neutral" title="cs-web-dashboard" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
