...
<head>
  ...
  <title>SplitterLayout &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="Bar" href="Tab-1.html"/>
        <link rel="prev" title="FixedSidebarWithEditor" href="FixedSidebarWithEditor.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>SplitterLayout</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/SplitterLayout.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="splitterlayout">
<span id="cs-web-components-base-layouts-splitterlayout-default"></span><h1>SplitterLayout<a class="headerlink" href="#splitterlayout" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#react-properties" id="id4">React Properties</a><ul>
<li><a class="reference internal" href="#id1" id="id5">SplitterLayout</a></li>
<li><a class="reference internal" href="#splitterlayout-primarypane" id="id6">SplitterLayout.PrimaryPane</a></li>
<li><a class="reference internal" href="#splitterlayout-secondarypane" id="id7">SplitterLayout.SecondaryPane</a></li>
</ul>
</li>
</ul>
</div>
...
<p>This component serves as a container for horizontally or vertically split panes.</p>
<p>There are 2 types of panes: primary and secondary panes.
...
allow resizing(by dragging) and collapsing(by clicking) manually.</p>
<div class="section" id="examples">
<h3><a class="toc-backref" href="#id3">Examples</a><a class="headerlink" href="#examples" title="Permalink to this headline">¶</a></h3>
<div class="highlight-none"><div class="highlight"><pre><span></span>&lt;SplitterLayout&gt;
...
<h3><a class="toc-backref" href="#id5">SplitterLayout</a><a class="headerlink" href="#id1" title="Permalink to this headline">¶</a></h3>
...
<td>bool</td>
<td>false</td>
<td>Whether the panes are layed out vertically</td>
</tr>
</tbody>
</table>
</div>
<div class="section" id="splitterlayout-primarypane">
<h3><a class="toc-backref" href="#id6">SplitterLayout.PrimaryPane</a><a class="headerlink" href="#splitterlayout-primarypane" title="Permalink to this headline">¶</a></h3>
<table border="1" class="docutils">
<colgroup>
<col width="15%" />
<col width="10%" />
...
<tbody valign="top">
<tr class="row-even"><td>fixSizing</td>
<td>bool</td>
<td>true</td>
<td>Whether to force the content taking exact size of
the pane area (and being cut off by overflow)</td>
</tr>
</tbody>
</table>
</div>
<div class="section" id="splitterlayout-secondarypane">
<h3><a class="toc-backref" href="#id7">SplitterLayout.SecondaryPane</a><a class="headerlink" href="#splitterlayout-secondarypane" title="Permalink to this headline">¶</a></h3>
<table border="1" class="docutils">
<colgroup>
<col width="20%" />
<col width="9%" />
...
<td>bool</td>
<td>true</td>
<td>Whether to allow resizing the pane manually</td>
</tr>
<tr class="row-even"><td>collapsible</td>
<td>bool</td>
<td>true</td>
<td>Whether to allow collapsing the pane manually</td>
</tr>
<tr class="row-odd"><td>defaultSize</td>
<td>string</td>
<td>10rem</td>
<td>Default size for the pane</td>
</tr>
<tr class="row-even"><td>hidingBreakPoint</td>
<td>number</td>
<td>-</td>
<td>Size in px, if specified, the pane will be collapsed
automatically if its size is less than this value</td>
</tr>
<tr class="row-odd"><td>initCollapsed</td>
<td>bool</td>
<td>false</td>
<td>Whether to collapse the pane initially</td>
</tr>
<tr class="row-even"><td>onChange</td>
<td>func</td>
<td>-</td>
<td>Callback function, which will be called after
resizing or collapsing the pane, with an object
{collapsed, size} as argument</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Tab-1.html" class="btn btn-neutral float-right" title="Bar" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="FixedSidebarWithEditor.html" class="btn btn-neutral" title="FixedSidebarWithEditor" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
