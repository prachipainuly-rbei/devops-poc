...
<head>
  ...
  <title>Thumbnail &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="WithOperations" href="WithOperations.html"/>
        <link rel="prev" title="components/TableWrapper" href="TableWrapper.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Thumbnail</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/Thumbnail.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-components-thumbnail-module"></span><h1>Thumbnail<a class="headerlink" href="#thumbnail" title="Permalink to this headline">¶</a></h1>
...
<p>The component displays images and fallbacks in predefined sizes and a consistent format.</p>
...
<tbody valign="top">
<tr class="row-even"><td>imgSrc</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>URL to load the image</td>
</tr>
<tr class="row-odd"><td>fallbackSrc</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>URL to load the fallback</td>
</tr>
...
<p class="last">If <code class="docutils literal"><span class="pre">imgSrc</span></code> is given, it will be used to load the image. Otherwise <code class="docutils literal"><span class="pre">fallbackSrc</span></code> will be used to load the fallbackImg.
If <code class="docutils literal"><span class="pre">imgSrc</span></code> and <code class="docutils literal"><span class="pre">fallbackSrc</span></code> are not given, the component renders a placeholder image.</p>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="WithOperations.html" class="btn btn-neutral float-right" title="WithOperations" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="TableWrapper.html" class="btn btn-neutral" title="components/TableWrapper" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
