...
<head>
  ...
  <title>actions/fetching &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="notification" href="notification.html"/>
        <link rel="prev" title="context-objects" href="context-objects.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>actions/fetching</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/fetching.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="actions-fetching">
<span id="cs-web-components-base-actions-fetching-module"></span><h1>actions/fetching<a class="headerlink" href="#actions-fetching" title="Permalink to this headline">¶</a></h1>
...
<div class="section" id="singlefetch">
<span id="cs-web-components-base-actions-fetching-singlefetch"></span><h4>singleFetch<a class="headerlink" href="#singlefetch" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">singleFetch</span><span class="p">(</span><span class="nx">url</span><span class="o">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">callOnce</span><span class="o">:</span> <span class="nx">func</span><span class="p">)</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>url</em>: URL to fetch from</li>
<li><em>callOnce</em>: Callback that is invoked on successful fetching</li>
</ul>
<p>Wrapper around getJSON that manages multiple simultaneous GET
requests for a URL. A request is uniquely identified by its URL and
may be in three states:</p>
<ul class="simple">
<li>Unknown: There is currently no pending request for this state.</li>
<li>Pending: A request is pending, subsequent calls to singleFetch
yield the Promise associated with this URL</li>
<li>Error: A request was done for the URL and failed.</li>
</ul>
<p>Since each call to the returned promise’s then will be executed
...
<p>The signature of callOnce is as follows:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>callOnce(data) =&gt; result|Promise
</pre></div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="notification.html" class="btn btn-neutral float-right" title="notification" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="context-objects.html" class="btn btn-neutral" title="context-objects" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
