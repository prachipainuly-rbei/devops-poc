...
<head>
  ...
  <title>Slider &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="Spinner" href="Spinner.html"/>
        <link rel="prev" title="ReactComponentControl" href="ReactComponentControl.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Slider</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/Slider.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-formcontrols-slider-default"></span><h1>Slider<a class="headerlink" href="#slider" title="Permalink to this headline">¶</a></h1>
...
<p>The component <code class="docutils literal"><span class="pre">&lt;Slider&gt;</span></code> allows numeric inputs and has following properties in addition to those
defined in <a class="reference internal" href="../../form_control_common_props.html#form-control-common-props"><span class="std std-ref">Common Properties</span></a>:</p>
...
<td>string</td>
<td>-</td>
<td>Current value for the slider</td>
</tr>
<tr class="row-odd"><td>max</td>
<td>string</td>
<td>-</td>
<td>Biggest value for the slider</td>
</tr>
<tr class="row-even"><td>min</td>
<td>string</td>
<td>-</td>
<td>Smallest value for the slider</td>
</tr>
<tr class="row-odd"><td>compact</td>
<td>bool</td>
<td>false</td>
<td>Display in compact mode without label and
bottom margin</td>
</tr>
<tr class="row-even"><td>beforeControl</td>
<td>node</td>
<td>-</td>
<td>A component or a list of components to be
placed before the input field</td>
</tr>
<tr class="row-odd"><td>afterControl</td>
<td>node</td>
<td>-</td>
<td>A component or a list of components to be
placed after the input field</td>
</tr>
<tr class="row-even"><td>onChange</td>
<td>func</td>
<td>-</td>
<td>Equivalent callback of <code class="xref py py-obj docutils literal"><span class="pre">onInput</span></code>, called
everytime the value changes</td>
</tr>
<tr class="row-odd"><td>onValueChange</td>
<td>func</td>
<td>-</td>
<td>Called everytime this.state.value changes
It’s better to use this instead of onChange</td>
</tr>
</tbody>
</table>
<p>Example:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>import {FormControl} from &#39;cs-web-components-base&#39;;
...
...
render() {
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Spinner.html" class="btn btn-neutral float-right" title="Spinner" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ReactComponentControl.html" class="btn btn-neutral" title="ReactComponentControl" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
