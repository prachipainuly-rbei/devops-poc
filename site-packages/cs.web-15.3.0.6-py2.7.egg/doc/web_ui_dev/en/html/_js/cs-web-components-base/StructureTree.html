...
<head>
  ...
  <title>StructureTree &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="prev" title="SimpleSearchAdapter" href="SearchAdapter-2.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>StructureTree</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/StructureTree.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-tree-structuretree-structuretree"></span><h1>StructureTree<a class="headerlink" href="#structuretree" title="Permalink to this headline">¶</a></h1>
...
<p>Tree class that loads and displays classic structures. It may be used
inside a ContextObjectSetter to set the contextObject of other
components according to its selection.
Additionally, parameter <code class="docutils literal"><span class="pre">structureName</span></code> should be set
to the name of the structure to be displayed.</p>
<div class="section" id="example-usage">
<h3><a class="toc-backref" href="#id2">Example Usage</a><a class="headerlink" href="#example-usage" title="Permalink to this headline">¶</a></h3>
<p>The following configuration expects an <code class="docutils literal"><span class="pre">organization</span></code> object and
displays the structure CDB_Organization, associated with that object.</p>
<div class="highlight-json"><div class="highlight"><pre><span></span><span class="p">{</span>
   <span class="nt">&quot;name&quot;</span><span class="p">:</span> <span class="s2">&quot;cs-web-components-base-ContextObjectSetter&quot;</span><span class="p">,</span>
   <span class="nt">&quot;properties&quot;</span><span class="p">:</span> <span class="p">{</span><span class="nt">&quot;setPath&quot;</span><span class="p">:</span> <span class="s2">&quot;orgTree&quot;</span><span class="p">},</span>
   <span class="nt">&quot;children&quot;</span><span class="p">:</span> <span class="p">[</span>
        <span class="p">{</span>
           <span class="nt">&quot;name&quot;</span><span class="p">:</span> <span class="s2">&quot;cs-web-components-base-StructureTree&quot;</span><span class="p">,</span>
           <span class="nt">&quot;properties&quot;</span><span class="p">:</span> <span class="p">{</span><span class="nt">&quot;structureName&quot;</span><span class="p">:</span> <span class="s2">&quot;CDB_Organization&quot;</span><span class="p">}</span>
        <span class="p">}</span>
   <span class="p">]</span>
<span class="p">}</span>
</pre></div>
...
<td>The REST API object that is the
root of the tree</td>
</tr>
<tr class="row-odd"><td>onSelect</td>
<td>function</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>Callback function that will be
invoked when a tree node is selected</td>
</tr>
<tr class="row-even"><td>structureName</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>The name of the structure to be
displayed</td>
</tr>
</tbody>
</table>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Toolbar.html" class="btn btn-neutral float-right" title="Toolbar" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="SearchAdapter-2.html" class="btn btn-neutral" title="SimpleSearchAdapter" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
