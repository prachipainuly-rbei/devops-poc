...
<head>
  ...
  <title>TypeAhead &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="RichTextEditor" href="RichTextEditor.html"/>
        <link rel="prev" title="Controlled" href="Overlay-1.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>TypeAhead</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/TypeAhead.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="typeahead">
<span id="cs-web-components-base-overlays-typeahead-default"></span><h1>TypeAhead<a class="headerlink" href="#typeahead" title="Permalink to this headline">¶</a></h1>
...
<a class="reference internal" href="Dropdown.html#cs-web-components-base-overlays-dropdown-default"><span class="std std-ref">Dropdown</span></a>-based
component to add type-ahead functionality to input fields.</p>
<p>Key differences to standard Dropdowns are:</p>
<ul class="simple">
<li>A different layout function. You can not specify a horizontal
alignment, instead the components width will always be the same
as the width of the toggle.</li>
<li>The grabFocus property is set to true, as text input fields will
usually want to keep the focus on the input field itself.</li>
</ul>
<p>For properties and usage info, see
<a class="reference internal" href="Dropdown.html#cs-web-components-base-overlays-dropdown-default"><span class="std std-ref">Dropdown</span></a>.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="RichTextEditor.html" class="btn btn-neutral float-right" title="RichTextEditor" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Overlay-1.html" class="btn btn-neutral" title="Controlled" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
