...
<head>
  ...
  <title>formcontrols/CheckBoxMenuItem &mdash; Web UI Development</title>
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>formcontrols/CheckBoxMenuItem</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/CheckBoxMenuItem.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="formcontrols-checkboxmenuitem">
<span id="cs-web-components-base-formcontrols-checkboxmenuitem-module"></span><h1>formcontrols/CheckBoxMenuItem<a class="headerlink" href="#formcontrols-checkboxmenuitem" title="Permalink to this headline">¶</a></h1>
...
<p>A <code class="docutils literal"><span class="pre">CheckBoxMenuItem</span></code> can be set in 2 states: <code class="docutils literal"><span class="pre">checked</span></code> or <code class="docutils literal"><span class="pre">unchecked</span></code>. It has one more
property in addition to those defined in <a class="reference internal" href="../../form_control_common_props.html#form-control-common-props"><span class="std std-ref">Common Properties</span></a>:</p>
...
<tbody valign="top">
<tr class="row-even"><td>checked</td>
<td>bool</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>Display the checkbox as checked</td>
</tr>
</tbody>
</table>
<p>The CheckBox’s <code class="docutils literal"><span class="pre">name</span></code> property is also used as the MenuItem’s <code class="docutils literal"><span class="pre">eventKey</span></code>.</p>
<p>Interactivity is handled somewhat different from regular checkboxes because of the MenuItem
wrapper:</p>
<ul class="simple">
<li>The <code class="docutils literal"><span class="pre">checked</span></code> state is controlled by properties only, there is no internal state</li>
<li>Thus, you have to provide the required <code class="docutils literal"><span class="pre">onChange</span></code> property, which is used as the MenuItem’s</li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Email.html" class="btn btn-neutral float-right" title="Email" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="CheckBox.html" class="btn btn-neutral" title="CheckBox" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
