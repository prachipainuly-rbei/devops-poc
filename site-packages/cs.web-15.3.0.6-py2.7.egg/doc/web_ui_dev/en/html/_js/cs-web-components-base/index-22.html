...
<head>
  ...
  <title>table/sortable/index &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="table/Table" href="Table.html"/>
        <link rel="prev" title="table/selectable/index" href="index-21.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>table/sortable/index</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/index-22.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="table-sortable-index">
<span id="cs-web-components-base-table-sortable-index-module"></span><h1>table/sortable/index<a class="headerlink" href="#table-sortable-index" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#redux-state" id="id3">Redux State</a></li>
...
<p>Provides sorting functionality in a table, by default by stringifying
cell values.</p>
<div class="section" id="options">
<h3><a class="toc-backref" href="#id2">Options</a><a class="headerlink" href="#options" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>Provider: implements sorting of rows</li>
<li>columnActions: adds a button to each column header for sorting</li>
</ul>
</div>
<div class="section" id="redux-state">
<h3><a class="toc-backref" href="#id3">Redux State</a><a class="headerlink" href="#redux-state" title="Permalink to this headline">¶</a></h3>
<p>TODO document Redux components</p>
</div>
<div class="section" id="properties">
<h3><a class="toc-backref" href="#id4">Properties</a><a class="headerlink" href="#properties" title="Permalink to this headline">¶</a></h3>
<p><code class="docutils literal"><span class="pre">Table.sortable.Provider</span></code> by default stringifies cell values to
use as a key for sorting. To change this behaviour, contentRenderers may
define an additional field <code class="docutils literal"><span class="pre">sortFunction</span></code> :</p>
<div class="highlight-javascript"><div class="highlight"><pre><span></span>
</pre></div>
</div>
<p>MyContentRenderer.sortFunction = (a, b) =&gt; myExampleCompare(a, b);</p>
<p>This function should takes two parameters to be compared and
returns -1 if the first is smaller than the second, 1 if the
second is smaller than the first and 0 if both are equal.</p>
<p>A column definition may also define <code class="docutils literal"><span class="pre">sortFunction</span></code>, which will then
override the contentRenderer’s or default functions.</p>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Table.html" class="btn btn-neutral float-right" title="table/Table" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="index-21.html" class="btn btn-neutral" title="table/selectable/index" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
