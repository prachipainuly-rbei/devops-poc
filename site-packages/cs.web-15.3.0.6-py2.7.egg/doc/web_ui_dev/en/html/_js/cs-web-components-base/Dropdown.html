...
<head>
  ...
  <title>Dropdown &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="Static" href="Dropdown-1.html"/>
        <link rel="prev" title="ContextMenu" href="ContextMenu.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Dropdown</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/Dropdown.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-overlays-dropdown-default"></span><h1>Dropdown<a class="headerlink" href="#dropdown" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#passing-children-as-facc" id="id2">Passing Children as FACC</a></li>
...
<p>A general component for rendering dropdowns.</p>
<p>Alignment on this component is as follows: Vertical Alignment dictates, wether
...
both (element.absx + element.width) will be equal for anchor and overlay.</p>
<p>The layouting algorithm used for this type of overlay takes into account
...
following:</p>
<ul class="simple">
<li>If there is enough space when using a different alignment mode (e.g. horizontal bottom
instead of horizontal top), it will used that.</li>
<li>If it does not fit in the other mode, it will use a scrollbar along that axis of
alignment and use the original alignment option.</li>
</ul>
</div>
<div class="section" id="passing-children-as-facc">
<h2><a class="toc-backref" href="#id2">Passing Children as FACC</a><a class="headerlink" href="#passing-children-as-facc" title="Permalink to this headline">¶</a></h2>
<p>To enable both the layouting component, as well as the component rendered inside
the dropdown to control the state of the dropdown, these components are passed
to Dropdown via <code class="docutils literal"><span class="pre">props.children</span></code> inside a function.</p>
...
<p>When called, <code class="docutils literal"><span class="pre">onShow</span></code> opens the dropdown if it is closed,
<code class="docutils literal"><span class="pre">onHide</span></code> closes the dropdown if it is open
and <code class="docutils literal"><span class="pre">onToggle</span></code> toggles its visibility state.</p>
<p>The parameter <code class="docutils literal"><span class="pre">visible</span></code> reflects the current state
...
<td>object</td>
<td>Optional reference to scroll container</td>
</tr>
<tr class="row-odd"><td>toggleRef</td>
<td>function</td>
<td>Called to set a reference to the
toggle component.</td>
</tr>
<tr class="row-even"><td>horizontalAlign</td>
<td>HorizontalAlignmentType</td>
<td>Horizontal Alignment of Dropdown</td>
</tr>
<tr class="row-odd"><td>verticalAlign</td>
<td>VerticalAlignmentType</td>
<td>Vertical Alignment of Dropdown</td>
</tr>
</tbody>
</table>
</div>
...
<div class="highlight-none"><div class="highlight"><pre><span></span>function MyComponent(props){
  return (
    &lt;Dropdown&gt;
      {
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Dropdown-1.html" class="btn btn-neutral float-right" title="Static" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ContextMenu.html" class="btn btn-neutral" title="ContextMenu" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
