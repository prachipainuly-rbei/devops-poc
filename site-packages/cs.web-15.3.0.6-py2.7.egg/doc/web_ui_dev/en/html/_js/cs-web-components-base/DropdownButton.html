...
<head>
  ...
  <title>overlays/DropdownButton &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="Overlays" href="index-11.html"/>
        <link rel="prev" title="overlays/Controlled" href="Controlled.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>overlays/DropdownButton</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/DropdownButton.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="overlays-dropdownbutton">
<span id="cs-web-components-base-overlays-dropdownbutton-module"></span><h1>overlays/DropdownButton<a class="headerlink" href="#overlays-dropdownbutton" title="Permalink to this headline">¶</a></h1>
...
<p>This component renders a button that displays a
<a class="reference internal" href="Dropdown.html#cs-web-components-base-overlays-dropdown-default"><span class="std std-ref">Dropdown</span></a> containing a menu if clicked.</p>
<p>Provided components are:</p>
<ul class="simple">
<li>DropdownIconButton</li>
<li>DropdownIconTextButton</li>
<li>DropdownTextButton</li>
</ul>
<p>Use the following menu child components provided by this module to display menu content:</p>
<ul class="simple">
<li><a class="reference internal" href="Menu-3.html#cs-web-components-base-overlays-menu-menuitem"><span class="std std-ref">MenuItem</span></a></li>
<li><a class="reference internal" href="Menu-2.html#cs-web-components-base-overlays-menu-menuheader"><span class="std std-ref">MenuHeader</span></a></li>
<li><a class="reference internal" href="Menu-1.html#cs-web-components-base-overlays-menu-menudivider"><span class="std std-ref">MenuDivider</span></a></li>
</ul>
</div>
<div class="section" id="react-properties">
<h2><a class="toc-backref" href="#id2">React Properties</a><a class="headerlink" href="#react-properties" title="Permalink to this headline">¶</a></h2>
...
<tbody valign="top">
<tr class="row-even"><td>buttonStyle</td>
<td>string</td>
<td>Semantic Style of the Button Component.</td>
</tr>
<tr class="row-odd"><td>verticalAlign</td>
<td>VerticalAlignmentType</td>
<td>How the Menu should be aligned in relation
to the button.</td>
</tr>
<tr class="row-even"><td>horizontalAlign</td>
<td>HorizontalAlignmentType</td>
<td>How the Menu should be aligned horizontally.</td>
</tr>
<tr class="row-odd"><td>containerRef</td>
<td>object</td>
<td>Reference to a containing component that may
cover the anchor component.</td>
</tr>
<tr class="row-even"><td>size</td>
<td>string</td>
<td>Size of the string to be displayed.</td>
</tr>
</tbody>
</table>
</div>
...
function MyMenu(props) {
  return (
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="index-11.html" class="btn btn-neutral float-right" title="Overlays" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Controlled.html" class="btn btn-neutral" title="overlays/Controlled" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
