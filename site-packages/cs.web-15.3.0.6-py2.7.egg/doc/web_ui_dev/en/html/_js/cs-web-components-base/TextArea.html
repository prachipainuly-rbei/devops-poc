...
<head>
  ...
  <title>TextArea &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="TextInput" href="TextInput.html"/>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>TextArea</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/TextArea.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-formcontrols-textarea-default"></span><h1>TextArea<a class="headerlink" href="#textarea" title="Permalink to this headline">¶</a></h1>
...
<p>The component <code class="docutils literal"><span class="pre">&lt;TextArea&gt;</span></code> allows textual inputs in multiple lines, works like a standard
<code class="docutils literal"><span class="pre">&lt;textarea&gt;</span></code> HTML tag. It has following properties besides those defined in
<a class="reference internal" href="../../form_control_common_props.html#form-control-common-props"><span class="std std-ref">Common Properties</span></a>:</p>
...
<td>To extend the size of this component to
bottom margin</td>
</tr>
<tr class="row-odd"><td>beforeControl</td>
<td>node</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
the <code class="docutils literal"><span class="pre">rows</span></code> attribute on <code class="docutils literal"><span class="pre">&lt;textare&gt;</span></code></td>
</tr>
<tr class="row-even"><td>afterControl</td>
<td>node</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>Equivalent callback of <code class="xref py py-obj docutils literal"><span class="pre">onChange</span></code>, called
with the field value instead of the event</td>
</tr>
</tbody>
</table>
<p>Example:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>import {TextArea} from &#39;cs-web-components-base&#39;;
...
render() {
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="TextInput.html" class="btn btn-neutral float-right" title="TextInput" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Spinner.html" class="btn btn-neutral" title="Spinner" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
