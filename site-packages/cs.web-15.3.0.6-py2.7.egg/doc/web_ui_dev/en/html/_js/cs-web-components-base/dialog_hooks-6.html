...
<head>
  ...
  <title>DialogHooksContext &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="FrontendDialog" href="FrontendDialog.html"/>
        <link rel="prev" title="FormWithOperations" href="FormWithOperations.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>DialogHooksContext</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/dialog_hooks-6.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="dialoghookscontext">
<span id="cs-web-components-base-form-dialog-hooks-dialoghookscontext"></span><h1>DialogHooksContext<a class="headerlink" href="#dialoghookscontext" title="Permalink to this headline">¶</a></h1>
...
<p>Context for dialog hooks: provides values and API to hook implementations.</p>
</div>
...
<div class="section" id="applybackendresult">
<span id="cs-web-components-base-form-dialog-hooks-applybackendresult"></span><h4>applyBackendResult<a class="headerlink" href="#applybackendresult" title="Permalink to this headline">¶</a></h4>
<p>Internal method: consume the backend’s answer from calling hooks.</p>
</div>
<div class="section" id="getbackendrequestdata">
<span id="cs-web-components-base-form-dialog-hooks-getbackendrequestdata"></span><h4>getBackendRequestData<a class="headerlink" href="#getbackendrequestdata" title="Permalink to this headline">¶</a></h4>
<p>Internal method: prepare data to POST to the backend when calling hooks.</p>
</div>
<div class="section" id="isfieldchanged">
<span id="cs-web-components-base-form-dialog-hooks-isfieldchanged"></span><h4>isFieldChanged<a class="headerlink" href="#isfieldchanged" title="Permalink to this headline">¶</a></h4>
<p>Determine if the original change (disregarding changes from hooks that were
already executed) included the given fieldname.</p>
</div>
<div class="section" id="ishookapplicable">
<span id="cs-web-components-base-form-dialog-hooks-ishookapplicable"></span><h4>isHookApplicable<a class="headerlink" href="#ishookapplicable" title="Permalink to this headline">¶</a></h4>
<p>Check if a hook does apply to this change: the changed attribute name is
configured, or the hook applies to all changes.</p>
</div>
<div class="section" id="preventsubmit">
<span id="cs-web-components-base-form-dialog-hooks-preventsubmit"></span><h4>preventSubmit<a class="headerlink" href="#preventsubmit" title="Permalink to this headline">¶</a></h4>
<p>Manage flags that may prevent the “Submit” action of the dialog.</p>
</div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="FrontendDialog.html" class="btn btn-neutral float-right" title="FrontendDialog" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="FormWithOperations.html" class="btn btn-neutral" title="FormWithOperations" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
