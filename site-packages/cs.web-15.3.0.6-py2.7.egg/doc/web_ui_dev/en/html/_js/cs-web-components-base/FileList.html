...
<head>
  ...
  <title>FileList &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="FileSelectionProvider" href="FileSelectionProvider.html"/>
        <link rel="prev" title="ExpandedStateHelper" href="ExpandedStateHelper.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>FileList</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/FileList.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-components-objectwidgets-filelist-filelist"></span><h1>FileList<a class="headerlink" href="#filelist" title="Permalink to this headline">¶</a></h1>
...
<p>Render a list of files attached to an object via <code class="docutils literal"><span class="pre">relship:files</span></code>.
This control can also trigger operations for these files. The available
operations are defined in the operation context <code class="docutils literal"><span class="pre">WebUIFileControl</span></code>.</p>
...
<td>JS object</td>
<td>-</td>
<td>The object whose relship:files should be
displayed</td>
</tr>
<tr class="row-odd"><td>quickAccess</td>
<td>JS Array</td>
<td><code class="docutils literal"><span class="pre">[&quot;CDB_Import&quot;,</span> <span class="pre">&quot;CDB_Export&quot;,</span> <span class="pre">&quot;CDB_Delete&quot;]</span></code></td>
<td>Names of operations to be displayed as icons
in the panel header of the filelist</td>
</tr>
<tr class="row-even"><td>uploadURL</td>
<td>JS string</td>
<td>-</td>
<td>URL to upload files to. If not provided, the
URL of the context object will be used.</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="FileSelectionProvider.html" class="btn btn-neutral float-right" title="FileSelectionProvider" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ExpandedStateHelper.html" class="btn btn-neutral" title="ExpandedStateHelper" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
