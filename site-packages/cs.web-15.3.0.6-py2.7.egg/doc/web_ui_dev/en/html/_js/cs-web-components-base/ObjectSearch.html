...
<head>
  ...
  <title>components/objectwidgets/ObjectSearch &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="components/StatusIcon" href="StatusIcon.html"/>
        <link rel="prev" title="components/objectwidgets/ObjectLabel" href="ObjectLabel.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>components/objectwidgets/ObjectSearch</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/ObjectSearch.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="components-objectwidgets-objectsearch">
<span id="cs-web-components-base-components-objectwidgets-objectsearch-module"></span><h1>components/objectwidgets/ObjectSearch<a class="headerlink" href="#components-objectwidgets-objectsearch" title="Permalink to this headline">¶</a></h1>
...
<p>A component that allows an interactive search in the EnterpriseSearch, history and favorites.</p>
...
<tr class="row-odd"><td>searchPlaceholder</td>
<td>string</td>
<td>undefined</td>
<td>Placeholder text if the search value is empty</td>
</tr>
<tr class="row-even"><td>searchClasses</td>
<td>string-array</td>
<td>undefined</td>
<td>Predefined search classes</td>
</tr>
<tr class="row-odd"><td>excludeClasses</td>
<td>string-array</td>
<td>undefined</td>
<td>Classes that should be excluded from search</td>
</tr>
<tr class="row-even"><td>hideDefaultTags</td>
<td>boolean</td>
<td>false</td>
<td>Hide predefined search classes tags in search field</td>
</tr>
<tr class="row-odd"><td>onSelectItem</td>
<td>func</td>
<td>undefined</td>
<td>A callback fired when an object from the drop down
is selected. An object with the rest url, title,
icon url and search type is passed in</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="StatusIcon.html" class="btn btn-neutral float-right" title="components/StatusIcon" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ObjectLabel.html" class="btn btn-neutral" title="components/objectwidgets/ObjectLabel" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
