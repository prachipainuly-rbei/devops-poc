...
<head>
  ...
  <title>Messages &mdash; Web UI Development</title>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Messages</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/index-7.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-messages-index-module"></span><h1>Messages<a class="headerlink" href="#messages" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#example-displaying-a-message" id="id2">Example: Displaying a message</a></li>
</ul>
</li>
...
<p>This module provides the basic API to display messages to the user.
The module provides actions and components to display messages as notifications or
banners, and can be easily extended to provide custom methods of display.</p>
<p>In order to post a message to the user, use the <code class="docutils literal"><span class="pre">Actions.post*</span></code> action creators
described in <a class="reference internal" href="actions.html#cs-web-components-base-messages-actions-module"><span class="std std-ref">Actions</span></a>.</p>
<div class="section" id="example-displaying-a-message">
<h3><a class="toc-backref" href="#id2">Example: Displaying a message</a><a class="headerlink" href="#example-displaying-a-message" title="Permalink to this headline">¶</a></h3>
<div class="highlight-none"><div class="highlight"><pre><span></span>import {Messages, Button} from &#39;cs-web-base-components&#39;;
...
<h3><a class="toc-backref" href="#id4">Modules</a><a class="headerlink" href="#modules" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li><a class="reference internal" href="actions.html#cs-web-components-base-messages-actions-module"><span class="std std-ref">Actions</span></a></li>
</ul>
</div>
<div class="section" id="classes">
<h3><a class="toc-backref" href="#id5">Classes</a><a class="headerlink" href="#classes" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li><a class="reference internal" href="index-5.html#cs-web-components-base-messages-banners-index-bannercontainer"><span class="std std-ref">BannerContainer</span></a></li>
</ul>
</div>
...
<div class="section" id="createbanner">
<span id="cs-web-components-base-messages-banners-index-createbanner"></span><h4>createBanner<a class="headerlink" href="#createbanner" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">createBanner</span><span class="p">(</span><span class="nx">arguments</span><span class="o">:</span> <span class="nx">object</span><span class="p">)</span><span class="o">:</span> <span class="nx">object</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>arguments</em>: Spread Parameter: <code class="docutils literal"><span class="pre">{bannerContainerId}</span></code></li>
</ul>
<p><strong>Returns:</strong> a displayInfo object</p>
<p>Display message inside the banner container specified by <code class="docutils literal"><span class="pre">bannerContainerId</span></code></p>
</div>
<div class="section" id="createnotification">
<span id="cs-web-components-base-messages-notifications-index-createnotification"></span><h4>createNotification<a class="headerlink" href="#createnotification" title="Permalink to this headline">¶</a></h4>
<p>Display a message as a notification in the top right corner of the viewport.
The first parameter is a spread argument, that may receive the <code class="docutils literal"><span class="pre">timeout</span></code> of
the notification.</p>
</div>
<div class="section" id="removenotification">
<span id="cs-web-components-base-messages-notifications-index-removenotification"></span><h4>removeNotification<a class="headerlink" href="#removenotification" title="Permalink to this headline">¶</a></h4>
<p>Remove the notification for the message identified by <code class="docutils literal"><span class="pre">messageId</span></code>.</p>
</div>
</div>
...
<p id="cs-web-components-base-messages-index-level"><strong>Level</strong>: The level of the message. Possible values are:</p>
<ul class="simple">
<li><code class="docutils literal"><span class="pre">EMPTY</span></code></li>
<li><code class="docutils literal"><span class="pre">PROGRESS</span></code></li>
<li><code class="docutils literal"><span class="pre">INFO</span></code></li>
<li><code class="docutils literal"><span class="pre">SUCCESS</span></code></li>
...
<li><code class="docutils literal"><span class="pre">ERROR</span></code></li>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="handlers.html" class="btn btn-neutral float-right" title="Handlers" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
