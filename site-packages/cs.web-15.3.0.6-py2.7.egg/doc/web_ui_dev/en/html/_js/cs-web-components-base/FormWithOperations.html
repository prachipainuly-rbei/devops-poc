...
<head>
  ...
  <title>FormWithOperations &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="DialogHooksContext" href="dialog_hooks-6.html"/>
        <link rel="prev" title="CreateButton" href="CreateButton.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>FormWithOperations</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/FormWithOperations.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="formwithoperations">
<span id="cs-web-components-base-form-containers-formwithoperations-formwithoperations"></span><h1>FormWithOperations<a class="headerlink" href="#formwithoperations" title="Permalink to this headline">¶</a></h1>
...
<p>This component displays the configured info mask for the provided context object.
Furthermore operations that are available for the object will be displayed as
buttons, above the form.</p>
<p>Required Properties:</p>
<ul class="simple">
<li>instanceName: A unique name identifying the component instance</li>
<li>contextObject: The object to be displayed</li>
<li>opContextName: The name of an operation contextname</li>
</ul>
<p>Optional Properties:</p>
<ul class="simple">
<li>dialogNames: An object providing alternative dialogs for operations.
This is optional.</li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="dialog_hooks-6.html" class="btn btn-neutral float-right" title="DialogHooksContext" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="CreateButton.html" class="btn btn-neutral" title="CreateButton" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
