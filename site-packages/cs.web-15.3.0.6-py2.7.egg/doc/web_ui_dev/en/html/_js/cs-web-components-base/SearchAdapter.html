...
<head>
  ...
  <title>tree/SearchAdapter &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="tree/Tree" href="Tree.html"/>
        <link rel="prev" title="tree/NodeRenderer" href="NodeRenderer.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>tree/SearchAdapter</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/SearchAdapter.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="tree-searchadapter">
<span id="cs-web-components-base-tree-searchadapter-module"></span><h1>tree/SearchAdapter<a class="headerlink" href="#tree-searchadapter" title="Permalink to this headline">¶</a></h1>
...
<p>The SearchAdapter interface is used as an Interface between the ToolbarSearch
widget and arbitrary components that want to support searching. The interface
may be used to encapsulate arbitrary search algorithms.</p>
<p>The actions provided by the widget are the following (function names in
SearchAdapter):</p>
<ul class="simple">
<li>onSendQuery: invoked when a query should be sent. returns a promise on success</li>
<li>nextResult: invoked when next result should be displayed.</li>
<li>previousResult: invoked when previous result should be displayed.</li>
<li>cancelSearch: clear results.</li>
</ul>
<p>The toolbar updates the state of the navigationstate according to the return
value of the function, which will be invoked when the promises returned by the
interface are resolved:</p>
<ul class="simple">
<li>getNavigationState: returns a JSON object containing boolean values for:<ul>
<li>previousResult</li>
<li>nextResult</li>
</ul>
</li>
</ul>
<p>TODO use immutable.map for search results</p>
</div>
...
<h3><a class="toc-backref" href="#id3">Classes</a><a class="headerlink" href="#classes" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li><a class="reference internal" href="SearchAdapter-1.html#cs-web-components-base-tree-searchadapter-backendsearchadapter"><span class="std std-ref">BackendSearchAdapter</span></a></li>
<li><a class="reference internal" href="SearchAdapter-2.html#cs-web-components-base-tree-searchadapter-simplesearchadapter"><span class="std std-ref">SimpleSearchAdapter</span></a></li>
</ul>
</div>
...
<h3><a class="toc-backref" href="#id4">Functions</a><a class="headerlink" href="#functions" title="Permalink to this headline">¶</a></h3>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Tree.html" class="btn btn-neutral float-right" title="tree/Tree" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="NodeRenderer.html" class="btn btn-neutral" title="tree/NodeRenderer" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
