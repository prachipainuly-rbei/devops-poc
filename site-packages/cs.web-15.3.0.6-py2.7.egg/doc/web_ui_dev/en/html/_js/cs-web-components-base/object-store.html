...
<head>
  ...
  <title>reducers/object-store &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="prev" title="reducers/fetching" href="fetching-2.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>reducers/object-store</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/object-store.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="reducers-object-store">
<span id="cs-web-components-base-reducers-object-store-module"></span><h1>reducers/object-store<a class="headerlink" href="#reducers-object-store" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#interaction-of-object-stores-and-meta-stores" id="id2">Interaction of Object Stores And Meta Stores</a></li>
</ul>
</li>
<li><a class="reference internal" href="#contents" id="id3">Contents</a><ul>
...
<p>This module provides access to the global object store.
The actions used to modify this store are defined in
<a class="reference internal" href="object-actions.html#cs-web-components-base-actions-object-actions-module"><span class="std std-ref">object-actions</span></a>.</p>
<p>Firstly, this module contains reducers that store certain entities
of the REST API, such as objects, types or relation.</p>
<div class="section" id="interaction-of-object-stores-and-meta-stores">
<h3><a class="toc-backref" href="#id2">Interaction of Object Stores And Meta Stores</a><a class="headerlink" href="#interaction-of-object-stores-and-meta-stores" title="Permalink to this headline">¶</a></h3>
<p>Failure and pending operations on the object store are also handled
using Redux. E.g., if an object is retrieved via
<a class="reference internal" href="object-actions.html#cs-web-components-base-actions-object-actions-fetchobject"><span class="std std-ref">fetchObject</span></a>
given an url <code class="docutils literal"><span class="pre">url</span></code>, the Promise returned by the action will be
stored in
<a class="reference internal" href="fetching-2.html#cs-web-components-base-reducers-fetching-fetchingbyid"><span class="std std-ref">fetchingById</span></a>.
The presence of this entry represents a pending request for the
given <code class="docutils literal"><span class="pre">url</span></code>.
...
put into
<a class="reference internal" href="fetching-2.html#cs-web-components-base-reducers-fetching-errorsbyid"><span class="std std-ref">errorsById</span></a>,
or the received object is put into
<a class="reference internal" href="#cs-web-components-base-reducers-object-store-objectsbyid"><span class="std std-ref">objectsById</span></a>.
Finally the Promise associated with the request is resolved.</p>
<p>An example on how to connect to a store is given in
<a class="reference internal" href="#cs-web-components-base-reducers-object-store-objectsbyid"><span class="std std-ref">objectsById</span></a></p>
</div>
</div>
...
<div class="section" id="objectsbyid">
<span id="cs-web-components-base-reducers-object-store-objectsbyid"></span><h4>objectsById<a class="headerlink" href="#objectsbyid" title="Permalink to this headline">¶</a></h4>
<p>This store is an Immutable map that stores all objects fetched via REST API
by their id.</p>
</div>
<div class="section" id="example">
<h4>Example<a class="headerlink" href="#example" title="Permalink to this headline">¶</a></h4>
<div class="highlight-none"><div class="highlight"><pre><span></span>function ExampleComponent(props) {
...
<div class="section" id="relshipsbyclass">
<span id="cs-web-components-base-reducers-object-store-relshipsbyclass"></span><h4>relshipsByClass<a class="headerlink" href="#relshipsbyclass" title="Permalink to this headline">¶</a></h4>
<p>Relationship meta data by classname</p>
</div>
<div class="section" id="relshipsbyid">
<span id="cs-web-components-base-reducers-object-store-relshipsbyid"></span><h4>relshipsById<a class="headerlink" href="#relshipsbyid" title="Permalink to this headline">¶</a></h4>
<p>Stores objects related to an entity by a relation specified by
an url.</p>
</div>
<div class="section" id="typesbyid">
<span id="cs-web-components-base-reducers-object-store-typesbyid"></span><h4>typesById<a class="headerlink" href="#typesbyid" title="Permalink to this headline">¶</a></h4>
<p>This reducer stores type information retrieved for the object-type
that can be retrieved under the url <code class="docutils literal"><span class="pre">object.get('&#64;type')</span></code>.</p>
</div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="registry.html" class="btn btn-neutral float-right" title="registry" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="fetching-2.html" class="btn btn-neutral" title="reducers/fetching" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
