...
<head>
  ...
  <title>DataContainerRow &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="DetailOutletRelationshipTable" href="DetailOutletRelationshipTable.html"/>
        <link rel="prev" title="DataContainerField" href="DataContainerField.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>DataContainerRow</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/DataContainerRow.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="datacontainerrow">
<span id="cs-web-components-base-detail-page-datacontainerrow-default"></span><h1>DataContainerRow<a class="headerlink" href="#datacontainerrow" title="Permalink to this headline">¶</a></h1>
...
<p>Component to render the data containers in the object header. This
component assumes that it is rendered inside a <code class="xref py py-obj docutils literal"><span class="pre">DisplayContextLoader</span></code>,
that provides the <code class="xref py py-obj docutils literal"><span class="pre">fields</span></code> and <code class="xref py py-obj docutils literal"><span class="pre">values</span></code> properties.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="DetailOutletRelationshipTable.html" class="btn btn-neutral float-right" title="DetailOutletRelationshipTable" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="DataContainerField.html" class="btn btn-neutral" title="DataContainerField" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
