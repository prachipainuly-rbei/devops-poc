...
<head>
  ...
  <title>Listener &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="Provider" href="Provider.html"/>
        <link rel="prev" title="SplitLayoutWithPersistence" href="SplitLayoutWithPersistence.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Listener</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/Listener.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-channel-listener-default"></span><h1>Listener<a class="headerlink" href="#listener" title="Permalink to this headline">¶</a></h1>
...
<p>The channel listener retrieves its values from the channel broadcasted by its
...
components into one listener with the same channel and mapping.</p>
...
<tbody valign="top">
<tr class="row-even"><td>channelName</td>
<td>string</td>
<td>-</td>
<td>The channel identifier for this listener to subscribe
to
This property cannot be changed after initial setup!</td>
</tr>
<tr class="row-odd"><td>channelMapping</td>
<td>object</td>
<td>-</td>
<td>A mapping that maps from property names to the keys
in the channel.
...
<td>&#160;</td>
<td>&#160;</td>
<td>A list of {channelName, channelMapping}</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Provider.html" class="btn btn-neutral float-right" title="Provider" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="SplitLayoutWithPersistence.html" class="btn btn-neutral" title="SplitLayoutWithPersistence" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
