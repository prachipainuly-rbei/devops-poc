...
<head>
  ...
  <title>FileDropzone &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="HelpReference" href="HelpReference.html"/>
        <link rel="prev" title="DisplayContextLoader" href="DisplayContextLoader.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>FileDropzone</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/FileDropzone.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-components-filedropzone-default"></span><h1>FileDropzone<a class="headerlink" href="#filedropzone" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#static-methods" id="id4">Static Methods</a></li>
<li><a class="reference internal" href="#instance-methods" id="id5">Instance Methods</a></li>
</ul>
</div>
...
<p>This component enables dropping files that dragged from file system in it, or
to select files via dialog.</p>
<div class="section" id="examples">
<h3><a class="toc-backref" href="#id2">Examples</a><a class="headerlink" href="#examples" title="Permalink to this headline">¶</a></h3>
<div class="highlight-none"><div class="highlight"><pre><span></span>class MyFiles extends React.Component {
    onDrop(files) {
...
<tbody valign="top">
<tr class="row-even"><td>onDrop</td>
<td>func</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>A callback, fired when files get dropped here</td>
</tr>
<tr class="row-odd"><td>autoHide</td>
<td>boolean</td>
<td>false</td>
<td>whether to hide content in this component
until files are being dragged</td>
</tr>
</tbody>
</table>
</div>
<div class="section" id="static-methods">
<h2><a class="toc-backref" href="#id4">Static Methods</a><a class="headerlink" href="#static-methods" title="Permalink to this headline">¶</a></h2>
<p><strong>getPreview(file)</strong>: Get the generated URL to the specific file that is dropped or chosen. The result
can be used e.g. as value to <code class="xref py py-obj docutils literal"><span class="pre">src</span></code> attribute on <code class="xref py py-obj docutils literal"><span class="pre">img</span></code> tag.</p>
</div>
<div class="section" id="instance-methods">
<h2><a class="toc-backref" href="#id5">Instance Methods</a><a class="headerlink" href="#instance-methods" title="Permalink to this headline">¶</a></h2>
<p><strong>choose()</strong>: Open the browser native file choosing dialog.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="HelpReference.html" class="btn btn-neutral float-right" title="HelpReference" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="DisplayContextLoader.html" class="btn btn-neutral" title="DisplayContextLoader" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
