...
<head>
  ...
  <title>NumericEdit &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="prev" title="GroupControl" href="GroupControl.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>NumericEdit</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/NumericEdit.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-formcontrols-numericedit-default"></span><h1>NumericEdit<a class="headerlink" href="#numericedit" title="Permalink to this headline">¶</a></h1>
...
<p>This component can be used to enter a numeric value. It can round the value up or down if
specified. Following properties in addition to properties of
&lt;<a class="reference internal" href="TextInput.html#cs-web-components-base-formcontrols-textinput-default"><span class="std std-ref">TextInput</span></a>&gt; can be set:</p>
...
<tbody valign="top">
<tr class="row-even"><td>decimalPlaces</td>
<td>number</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>Decimal places to display and round the
value up or down</td>
</tr>
...
<td>A callback fired when the numeric value
gets changed.</td>
</tr>
...
<tr class="row-even"><td>variableDecimal</td>
<td>bool</td>
<td>false</td>
<td>If true and decimalPlaces are undefined,
the number of decimal places is calculated
that the total value does not
exceed 16 characters</td>
</tr>
</tbody>
</table>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p><code class="docutils literal"><span class="pre">onValueChange</span></code> will be called with the rounded value. <code class="docutils literal"><span class="pre">onChange</span></code> should only be used if
the original user input is needed.</p>
<p class="last">Due to the double-precision floating-point format, which javascript uses to represent a number,
this component only accepts number inputs between -9007199254740991 and 9007199254740991. And
that gives 15–17 significant decimal digits precision. It means if there are more than 15
digits, the precision can not be guaranteed.</p>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Radio.html" class="btn btn-neutral float-right" title="Radio" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="GroupControl.html" class="btn btn-neutral" title="GroupControl" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
