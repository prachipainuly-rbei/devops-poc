...
<head>
  ...
  <title>tree/TreeFilter &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="tree/TreeRenderer" href="TreeRenderer.html"/>
        <link rel="prev" title="tree/TreeContainer" href="TreeContainer.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>tree/TreeFilter</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/TreeFilter.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="tree-treefilter">
<span id="cs-web-components-base-tree-treefilter-module"></span><h1>tree/TreeFilter<a class="headerlink" href="#tree-treefilter" title="Permalink to this headline">¶</a></h1>
...
<p>This module provides filter HOCs for use in tree components. A filter is a tree HOC of the form</p>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">TreeRenderer</span> <span class="p">=&gt;</span> <span class="nx">TreeRenderer</span>
</pre></div>
</div>
<p>which renders the provided TreeRenderer argument, but replaces the tree’s rootNode with a modified
version, that usually removes nodes from the tree’s model.</p>
</div>
...
<div class="section" id="showpaths">
<span id="cs-web-components-base-tree-treefilter-showpaths"></span><h4>ShowPaths<a class="headerlink" href="#showpaths" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">ShowPaths</span><span class="p">(</span><span class="nx">getNodes</span><span class="p">)</span><span class="o">:</span> <span class="kc">undefined</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>getNodes</em>: a function <code class="docutils literal"><span class="pre">props</span> <span class="pre">=&gt;</span> <span class="pre">[treeNodes]</span></code></li>
</ul>
<p><strong>Returns:</strong> a filter HOC</p>
<p>A function that creates a filter to display a subtree based on a set of nodes, that should be
included in the subtree.</p>
<p>The parameter getNodes provides a function that must return an array of nodes. Input to the
function is the trees props object. The filtered tree will only include the paths leading to
the nodes in the array returned by getNodes.</p>
</div>
<div class="section" id="showsearchresults">
<span id="cs-web-components-base-tree-treefilter-showsearchresults"></span><h4>ShowSearchResults<a class="headerlink" href="#showsearchresults" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">ShowSearchResults</span><span class="p">(</span><span class="nx">TreeRenderer</span><span class="p">)</span><span class="o">:</span> <span class="kc">undefined</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>TreeRenderer</em>: a TreeRenderer component</li>
</ul>
<p><strong>Returns:</strong> a TreeRenderer component</p>
<p>A filter HOC that displays all search results in the active search if a search is active,
or the whole tree structure if no search is active.</p>
</div>
<div class="section" id="showselectedsearchresult">
<span id="cs-web-components-base-tree-treefilter-showselectedsearchresult"></span><h4>ShowSelectedSearchResult<a class="headerlink" href="#showselectedsearchresult" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">ShowSelectedSearchResult</span><span class="p">(</span><span class="nx">TreeRenderer</span><span class="p">)</span><span class="o">:</span> <span class="kc">undefined</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
...
<p><strong>Returns:</strong> a TreeRenderer component</p>
<p>A filter HOC that displays the selected search result if a search result is selected, or
the whole tree structure if no search is active.</p>
</div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="TreeRenderer.html" class="btn btn-neutral float-right" title="tree/TreeRenderer" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="TreeContainer.html" class="btn btn-neutral" title="tree/TreeContainer" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
