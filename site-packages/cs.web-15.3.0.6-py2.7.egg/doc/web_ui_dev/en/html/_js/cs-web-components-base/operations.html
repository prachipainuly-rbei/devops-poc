...
<head>
  ...
  <title>actions/operations &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="Button" href="Button.html"/>
        <link rel="prev" title="object-actions" href="object-actions.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>actions/operations</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/operations.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="actions-operations">
<span id="cs-web-components-base-actions-operations-module"></span><h1>actions/operations<a class="headerlink" href="#actions-operations" title="Permalink to this headline">¶</a></h1>
...
<p>This module provides actions to retrieve operation information objects from the server.
...
executing operations in Web UI.</p>
</div>
...
<div class="section" id="fetchoperationcontext">
<span id="cs-web-components-base-actions-operations-fetchoperationcontext"></span><h4>fetchOperationContext<a class="headerlink" href="#fetchoperationcontext" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">fetchOperationContext</span><span class="p">(</span><span class="nx">objectType</span><span class="o">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">contextName</span><span class="o">:</span> <span class="nx">string</span><span class="p">)</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>objectType</em>: a CE classname</li>
<li><em>contextName</em>: the name of an operation context as defined in Elements</li>
</ul>
<p>Retrieve an operation context with operation info objects already resolved.</p>
</div>
<div class="section" id="fetchoperationinfo">
<span id="cs-web-components-base-actions-operations-fetchoperationinfo"></span><h4>fetchOperationInfo<a class="headerlink" href="#fetchoperationinfo" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">fetchOperationInfo</span><span class="p">(</span><span class="nx">objectType</span><span class="o">:</span> <span class="nx">string</span><span class="p">)</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
...
<p>Retrieve the operation infos for the object type provided.</p>
</div>
<div class="section" id="fetchrelshipoperationinfo">
<span id="cs-web-components-base-actions-operations-fetchrelshipoperationinfo"></span><h4>fetchRelshipOperationInfo<a class="headerlink" href="#fetchrelshipoperationinfo" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">fetchRelshipOperationInfo</span><span class="p">(</span><span class="nx">url</span><span class="o">:</span> <span class="nx">string</span><span class="p">)</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>url</em>: the URL to retireve the operations for the relationship context</li>
</ul>
<p>Retrieve the operation infos a relationship context</p>
</div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Button.html" class="btn btn-neutral float-right" title="Button" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="object-actions.html" class="btn btn-neutral" title="object-actions" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
