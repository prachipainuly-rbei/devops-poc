...
<head>
  ...
  <title>SearchField &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="Tag" href="Tag.html"/>
        <link rel="prev" title="ProgressBar" href="ProgressBar.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>SearchField</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/SearchField.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="searchfield">
<span id="cs-web-components-base-components-searchfield-searchfield"></span><h1>SearchField<a class="headerlink" href="#searchfield" title="Permalink to this headline">¶</a></h1>
...
<tbody valign="top">
<tr class="row-even"><td>productName</td>
<td>string</td>
<td>-</td>
<td>The brandable product name.</td>
</tr>
<tr class="row-odd"><td>searchCallback</td>
<td>func</td>
<td>-</td>
<td>Callback invoked when enter is pushed.</td>
</tr>
<tr class="row-even"><td>searchTextChangedCallback</td>
<td>func</td>
<td>-</td>
<td>Callback invoked when content changes.</td>
</tr>
<tr class="row-odd"><td>searchText</td>
<td>string</td>
<td>-</td>
<td>Initial content of the search field.</td>
</tr>
<tr class="row-even"><td>searchButtonSize</td>
<td>string</td>
<td>-</td>
<td>Size of the search button.</td>
</tr>
</tbody>
</table>
<p>This component is an extended TextInput component with type ahead feature that accesses the Enterprise Search.
It will open a drop down list to show possible options during typing.
<code class="docutils literal"><span class="pre">productName</span></code> is inserted into the placeholder of the field.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Tag.html" class="btn btn-neutral float-right" title="Tag" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ProgressBar.html" class="btn btn-neutral" title="ProgressBar" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
