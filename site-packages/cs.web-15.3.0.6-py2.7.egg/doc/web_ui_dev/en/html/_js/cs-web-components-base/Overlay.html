...
<head>
  ...
  <title>Overlay &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="Controlled" href="Overlay-1.html"/>
        <link rel="prev" title="MenuItem" href="Menu-3.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Overlay</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/Overlay.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-overlays-overlay-default"></span><h1>Overlay<a class="headerlink" href="#overlay" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#children" id="id2">Children</a></li>
...
<p>This provides a basic overlay implementation, without any layouting functionality.
It simply renders its child component in a div, positioned absolutely on the document
by using <code class="docutils literal"><span class="pre">React.createPortal</span></code>.</p>
</div>
<div class="section" id="children">
<h2><a class="toc-backref" href="#id2">Children</a><a class="headerlink" href="#children" title="Permalink to this headline">¶</a></h2>
...
<tbody valign="top">
<tr class="row-even"><td>onBlur</td>
<td>function</td>
...
<tr class="row-odd"><td>onFocusOut</td>
<td>function</td>
<td>Sets an onFocusOut handler on the overlay div.
Note that this uses DOM Events instead of
React Events (as of 16.3 React does not support
focusin/focusout events).</td>
</tr>
...
<tr class="row-odd"><td>positionStyle</td>
<td>object</td>
<td>This allows to set the element style of the
overlay div, use this to absolutely position
the div on the page</td>
</tr>
...
class attribute.</td>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Overlay-1.html" class="btn btn-neutral float-right" title="Controlled" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Menu-3.html" class="btn btn-neutral" title="MenuItem" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
