...
<head>
  ...
  <title>TextInput &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="TriStateCheckBox" href="TriStateCheckBox.html"/>
        <link rel="prev" title="TextArea" href="TextArea.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>TextInput</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/TextInput.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-formcontrols-textinput-default"></span><h1>TextInput<a class="headerlink" href="#textinput" title="Permalink to this headline">¶</a></h1>
...
<p>The component <code class="docutils literal"><span class="pre">&lt;TextInput&gt;</span></code> allows textual inputs and has following properties in addition to those
...
<tr class="row-even"><td>onValueChange</td>
<td>func</td>
<td>-</td>
...
<tr class="row-odd"><td>onEnter</td>
<td>func</td>
<td>-</td>
<td>Callback that is invoked when the user
pushes ‘Enter’. Function will receive
current value of the field as parameter.</td>
</tr>
</tbody>
</table>
<p>Example:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>import {TextInput} from &#39;cs-web-components-base&#39;;
...
render() {
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="TriStateCheckBox.html" class="btn btn-neutral float-right" title="TriStateCheckBox" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="TextArea.html" class="btn btn-neutral" title="TextArea" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
