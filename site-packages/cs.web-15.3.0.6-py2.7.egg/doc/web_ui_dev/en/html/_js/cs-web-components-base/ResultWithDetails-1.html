...
<head>
  ...
  <title>ResultWithDetails &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="SearchResult" href="SearchResult.html"/>
        <link rel="prev" title="Provider" href="Provider.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>ResultWithDetails</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/ResultWithDetails-1.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="resultwithdetails">
<span id="cs-web-components-base-classview-resultwithdetails-resultwithdetails"></span><h1>ResultWithDetails<a class="headerlink" href="#resultwithdetails" title="Permalink to this headline">¶</a></h1>
...
<p>Renders a search result, and possibly a detail view if one is configured. This
...
<div class="section" id="onselectionchanged">
<span id="cs-web-components-base-classview-resultwithdetails-onselectionchanged"></span><h4>onSelectionChanged<a class="headerlink" href="#onselectionchanged" title="Permalink to this headline">¶</a></h4>
<p>If a detail view is configured, propagate changes in the resault table
selection. We use setContextObjects and ContextObjectWrapper, so that the
REST objects for the selection will be loaded automatically.</p>
</div>
<div class="section" id="selectedobjectids">
<span id="cs-web-components-base-classview-resultwithdetails-selectedobjectids"></span><h4>selectedObjectIDs<a class="headerlink" href="#selectedobjectids" title="Permalink to this headline">¶</a></h4>
<p>Convert the selectionIds from the table to the object IDs for the actual
REST objects; that is what setContextObjects uses.</p>
</div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="SearchResult.html" class="btn btn-neutral float-right" title="SearchResult" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Provider.html" class="btn btn-neutral" title="Provider" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
