...
<head>
  ...
  <title>Collapsible &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="ImageViewer" href="ImageViewer.html"/>
        <link rel="prev" title="ButtonToolbar" href="ButtonToolbar.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Collapsible</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/Collapsible.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-components-collapsible-default"></span><h1>Collapsible<a class="headerlink" href="#collapsible" title="Permalink to this headline">¶</a></h1>
...
<p>A container that consists of a header and a body. Inside the body,
...
the body is collapsed/expanded.</p>
<p><a class="reference internal" href="PersistentCollapsible.html#cs-web-components-base-components-persistentcollapsible-default"><span class="std std-ref">PersistentCollapsible</span></a> is a variation of
this component, that persists its state.</p>
...
<td>string/node</td>
<td>-</td>
<td>Text to be displayed in header</td>
</tr>
<tr class="row-odd"><td>initialCollapsed</td>
<td>bool</td>
<td>true</td>
<td>Initial state of the component</td>
</tr>
<tr class="row-even"><td>onCollapsed</td>
<td>func</td>
<td>undefined</td>
<td>Callback invoked when component state
changes</td>
</tr>
<tr class="row-odd"><td>children</td>
<td>nodes</td>
<td>-</td>
<td>Components to be displayed in body</td>
</tr>
</tbody>
</table>
<div class="section" id="automation-properties">
<h4>Automation Properties<a class="headerlink" href="#automation-properties" title="Permalink to this headline">¶</a></h4>
<p><strong>CollapsibleControl</strong>: The control displayed in the header of the
...
<td>Collapsible is collapsed</td>
</tr>
<tr class="row-odd"><td>expanded</td>
<td>Collapsible is expanded</td>
</tr>
</tbody>
</table>
</div></blockquote>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="ImageViewer.html" class="btn btn-neutral float-right" title="ImageViewer" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ButtonToolbar.html" class="btn btn-neutral" title="ButtonToolbar" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
