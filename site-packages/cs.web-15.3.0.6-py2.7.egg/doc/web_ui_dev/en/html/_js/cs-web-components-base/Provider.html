...
<head>
  ...
  <title>Provider &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="ResultWithDetails" href="ResultWithDetails-1.html"/>
        <link rel="prev" title="Listener" href="Listener.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Provider</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/Provider.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-channel-provider-default"></span><h1>Provider<a class="headerlink" href="#provider" title="Permalink to this headline">¶</a></h1>
...
<p>The channel provider which sends updated values using the new channel
mechanism down to its listeners. Any values sent from parent providers are
overwritten using local properties. This component must only have one child.</p>
...
<td>string</td>
<td>-</td>
<td>The channel identifier for listeners to subscribe to.
This property cannot be changed after initial setup!</td>
</tr>
<tr class="row-odd"><td>channelValues</td>
<td>object</td>
<td>-</td>
<td>An object specifying the mapping of channel keys to actual values</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="ResultWithDetails-1.html" class="btn btn-neutral float-right" title="ResultWithDetails" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Listener.html" class="btn btn-neutral" title="Listener" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
