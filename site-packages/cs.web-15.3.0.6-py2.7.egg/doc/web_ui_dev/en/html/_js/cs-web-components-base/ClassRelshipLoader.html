...
<head>
  ...
  <title>ClassRelshipLoader &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="CompactHeader" href="CompactHeader.html"/>
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>ClassRelshipLoader</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/ClassRelshipLoader.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="classrelshiploader">
<span id="cs-web-components-base-components-objectwidgets-classrelshiploader-classrelshiploader"></span><h1>ClassRelshipLoader<a class="headerlink" href="#classrelshiploader" title="Permalink to this headline">¶</a></h1>
...
<p>Wrapper component that loads relationship metadata for a class from the backend.
The class can be given either directly via the <code class="docutils literal"><span class="pre">classname</span></code> property, or it
can be extracted from a <code class="docutils literal"><span class="pre">contextObject</span></code> property.
ClassRelshipLoader is a FACC that calls its child as a funtion, with the relship
data as parameter of type Immutable.Map.</p>
...
<td>String</td>
<td>Name of the CE class to load data for. Takes
precedence over contextObject.</td>
</tr>
<tr class="row-odd"><td>contextObject</td>
<td>Immutable.Map</td>
<td>An object whose classname is used to load
data for. Is ignored if classname is given.</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="CompactHeader.html" class="btn btn-neutral float-right" title="CompactHeader" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="History.html" class="btn btn-neutral" title="History" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
