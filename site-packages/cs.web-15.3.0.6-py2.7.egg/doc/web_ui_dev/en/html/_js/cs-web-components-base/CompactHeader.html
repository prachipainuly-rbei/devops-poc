...
<head>
  ...
  <title>CompactHeader &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="ConnectedRelationshipTable" href="ConnectedRelationshipTable.html"/>
        <link rel="prev" title="ClassRelshipLoader" href="ClassRelshipLoader.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>CompactHeader</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/CompactHeader.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="compactheader">
<span id="cs-web-components-base-components-objectwidgets-compactheader-compactheader"></span><h1>CompactHeader<a class="headerlink" href="#compactheader" title="Permalink to this headline">¶</a></h1>
...
<p>A component to show the thumbnail, type, description and operations of
an object, which will fit into e.g. a detail area.</p>
<p>It can also be used as configured component.
...
functions should be specified in order to disable the default handling .</p>
...
<td>Immutable.Map</td>
<td>-</td>
<td>The object to be showed</td>
</tr>
<tr class="row-odd"><td>onOperationSuccess</td>
<td>func</td>
<td>undefined</td>
<td>The callback function in case an
operation ends successfully</td>
</tr>
<tr class="row-even"><td>onOperationFailure</td>
<td>func</td>
<td>undefined</td>
<td>The callback function in case an
operation fails</td>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="ConnectedRelationshipTable.html" class="btn btn-neutral float-right" title="ConnectedRelationshipTable" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ClassRelshipLoader.html" class="btn btn-neutral" title="ClassRelshipLoader" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
