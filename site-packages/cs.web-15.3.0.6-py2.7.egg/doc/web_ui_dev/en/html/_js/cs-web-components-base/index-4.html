...
<head>
  ...
  <title>FormControl &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="Password" href="Password.html"/>
        <link rel="prev" title="formcontrols/FormActions" href="FormActions.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>FormControl</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/index-4.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="formcontrol">
<span id="cs-web-components-base-formcontrols-index-module"></span><h1>FormControl<a class="headerlink" href="#formcontrol" title="Permalink to this headline">¶</a></h1>
...
<p>This module provides several components that are based on the different
<code class="docutils literal"><span class="pre">&lt;input/&gt;</span></code> components that HTML5 provides:</p>
<ul class="simple">
<li><a class="reference internal" href="Button-9.html#cs-web-components-base-formcontrols-button-default"><span class="std std-ref">Button</span></a></li>
<li><a class="reference internal" href="BitmapIcon.html#cs-web-components-base-formcontrols-bitmapicon-module"><span class="std std-ref">BitmapIcon</span></a></li>
<li><a class="reference internal" href="CheckBox.html#cs-web-components-base-formcontrols-checkbox-module"><span class="std std-ref">CheckBox</span></a></li>
<li><a class="reference internal" href="ComboBox.html#cs-web-components-base-formcontrols-combobox-default"><span class="std std-ref">ComboBox</span></a></li>
<li><a class="reference internal" href="ComboBoxCatalog.html#cs-web-components-base-formcontrols-comboboxcatalog-default"><span class="std std-ref">ComboBoxCatalog</span></a></li>
<li><a class="reference internal" href="Calendar.html#cs-web-components-base-formcontrols-calendar-default"><span class="std std-ref">Calendar</span></a></li>
<li><a class="reference internal" href="Email.html#cs-web-components-base-formcontrols-email-module"><span class="std std-ref">Email</span></a></li>
<li><a class="reference internal" href="NumericEdit.html#cs-web-components-base-formcontrols-numericedit-default"><span class="std std-ref">NumericEdit</span></a></li>
<li><a class="reference internal" href="Password.html#cs-web-components-base-formcontrols-password-module"><span class="std std-ref">Password</span></a></li>
<li><a class="reference internal" href="Radio.html#cs-web-components-base-formcontrols-radio-default"><span class="std std-ref">Radio</span></a></li>
<li><a class="reference internal" href="TextArea.html#cs-web-components-base-formcontrols-textarea-default"><span class="std std-ref">TextArea</span></a></li>
<li><a class="reference internal" href="TextInput.html#cs-web-components-base-formcontrols-textinput-default"><span class="std std-ref">TextInput</span></a></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Password.html" class="btn btn-neutral float-right" title="Password" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="FormActions.html" class="btn btn-neutral" title="formcontrols/FormActions" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
