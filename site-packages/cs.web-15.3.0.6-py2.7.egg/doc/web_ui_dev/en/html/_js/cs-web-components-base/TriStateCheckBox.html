...
<head>
  ...
  <title>TriStateCheckBox &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="FixedSidebarWithEditor" href="FixedSidebarWithEditor.html"/>
        <link rel="prev" title="TextInput" href="TextInput.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>TriStateCheckBox</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/TriStateCheckBox.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="tristatecheckbox">
<span id="cs-web-components-base-formcontrols-tristatecheckbox-default"></span><h1>TriStateCheckBox<a class="headerlink" href="#tristatecheckbox" title="Permalink to this headline">¶</a></h1>
...
<p>This component extends the &lt;<a class="reference internal" href="CheckBox.html#cs-web-components-base-formcontrols-checkbox-module"><span class="std std-ref">CheckBox</span></a>&gt;
with a third state: <code class="docutils literal"><span class="pre">indeterminate</span></code>. That means its state is neither <code class="docutils literal"><span class="pre">checked</span></code> nor <code class="docutils literal"><span class="pre">unchecked</span></code>.
It has following properties in addition to those defined in <a class="reference internal" href="../../form_control_common_props.html#form-control-common-props"><span class="std std-ref">Common Properties</span></a>:</p>
...
<td><p class="first">string, one of:</p>
<ul class="last simple">
<li>“0”: unchecked</li>
<li>“1”: checked</li>
<li>“”(empty): indeterminate</li>
</ul>
</td>
<td>“”</td>
<td>To display the check box in
different states</td>
</tr>
<tr class="row-odd"><td>onStateChange</td>
<td>func</td>
<td>&#160;</td>
<td>A callback fired when state of
check box is changed.
<code class="docutils literal"><span class="pre">(nextState)</span> <span class="pre">=&gt;</span> <span class="pre">any</span></code></td>
</tr>
</tbody>
</table>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last"><code class="docutils literal"><span class="pre">onStateChange</span></code> will be called with the new state if user clicks on the check box. The states
will be set in this order: <code class="docutils literal"><span class="pre">indetermined</span></code>, <code class="docutils literal"><span class="pre">unchecked</span></code>, <code class="docutils literal"><span class="pre">checked</span></code> and back to <code class="docutils literal"><span class="pre">indetermined</span></code>.</p>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="FixedSidebarWithEditor.html" class="btn btn-neutral float-right" title="FixedSidebarWithEditor" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="TextInput.html" class="btn btn-neutral" title="TextInput" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
