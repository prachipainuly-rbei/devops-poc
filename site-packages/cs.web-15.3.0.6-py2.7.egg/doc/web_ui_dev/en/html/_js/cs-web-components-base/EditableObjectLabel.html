...
<head>
  ...
  <title>EditableObjectLabel &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="ExpandedStateHelper" href="ExpandedStateHelper.html"/>
        <link rel="prev" title="ConnectedRelationshipTreeTable" href="ConnectedRelationshipTreeTable.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>EditableObjectLabel</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/EditableObjectLabel.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="editableobjectlabel">
<span id="cs-web-components-base-components-objectwidgets-editableobjectlabel-default"></span><h1>EditableObjectLabel<a class="headerlink" href="#editableobjectlabel" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#automation-properties" id="id3">Automation Properties</a></li>
</ul>
</li>
</ul>
</div>
...
<p>A label that is used to display an object. If callbacks for editing or
...
controls triggers the respective action.</p>
...
<tbody valign="top">
<tr class="row-even"><td>data-ce-id</td>
<td>string</td>
<td>EditableObjectLabel</td>
<td>Overwrites id to retrieve this dom element</td>
</tr>
<tr class="row-odd"><td>text</td>
<td>string</td>
<td>-</td>
<td>Label text to be displayed</td>
</tr>
<tr class="row-even"><td>icon</td>
<td>string</td>
<td>undefined</td>
<td>URL to icon for this object</td>
</tr>
<tr class="row-odd"><td>onEditClicked</td>
<td>function</td>
<td>undefined</td>
<td>Callback for edit action</td>
</tr>
<tr class="row-even"><td>onDeleteClicked</td>
<td>function</td>
<td>undefined</td>
<td>Callback for delete action</td>
</tr>
</tbody>
</table>
</div>
<div class="section" id="automation-properties">
<h3><a class="toc-backref" href="#id3">Automation Properties</a><a class="headerlink" href="#automation-properties" title="Permalink to this headline">¶</a></h3>
<p><strong>EditableObjectLabel</strong>: The label itself can be retrieved using
this id. By passing in <code class="docutils literal"><span class="pre">data-ce-id</span></code> as a React Property, this value
can be overridden.</p>
<p><strong>EditButton</strong>: The control that is used to edit the object
represented by this label.</p>
<p><strong>DeleteButton</strong>: The control that is used to delete the object
represented by this label.</p>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="ExpandedStateHelper.html" class="btn btn-neutral float-right" title="ExpandedStateHelper" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ConnectedRelationshipTreeTable.html" class="btn btn-neutral" title="ConnectedRelationshipTreeTable" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
