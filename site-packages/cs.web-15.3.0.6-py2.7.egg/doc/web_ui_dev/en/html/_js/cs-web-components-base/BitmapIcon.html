...
<head>
  ...
  <title>BitmapIcon &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="CheckBox" href="CheckBox.html"/>
        <link rel="prev" title="form/dialog_hooks" href="dialog_hooks.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>BitmapIcon</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/BitmapIcon.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="bitmapicon">
<span id="cs-web-components-base-formcontrols-bitmapicon-module"></span><h1>BitmapIcon<a class="headerlink" href="#bitmapicon" title="Permalink to this headline">¶</a></h1>
...
<p>This functional component shows a picture or icon. It’s main purpose is for rendering images
inside configured forms. If you want to display images in another context, consider using
<a class="reference internal" href="SVGIcon.html#cs-web-components-base-components-svgicon-module"><span class="std std-ref">components/SVGIcon</span></a> or
<span class="xref std std-ref">cs-web-components-base-components.Icon.__module__</span> instead.</p>
...
<td>URL of the picture or icon to be shown</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="CheckBox.html" class="btn btn-neutral float-right" title="CheckBox" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="dialog_hooks.html" class="btn btn-neutral" title="form/dialog_hooks" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
