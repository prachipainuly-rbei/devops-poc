...
<head>
  ...
  <title>FlatCatalog &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="SplitLayoutWithPersistence" href="SplitLayoutWithPersistence.html"/>
        <link rel="prev" title="CatalogPreview" href="CatalogPreview.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>FlatCatalog</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/FlatCatalog.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="flatcatalog">
<span id="cs-web-components-base-catalogs-flatcatalog-default"></span><h1>FlatCatalog<a class="headerlink" href="#flatcatalog" title="Permalink to this headline">¶</a></h1>
...
<p>This component renders a catalog. You might retrieve most of the properties using the
backend function <code class="xref py py-obj docutils literal"><span class="pre">FormInfoBase.get_catalog_config</span></code>.</p>
...
<tbody valign="top">
<tr class="row-even"><td>formData</td>
<td>Immutable.Map</td>
...
<td>Form data to be used to query catalog data entries</td>
</tr>
<tr class="row-odd"><td>contextClass</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<tr class="row-even"><td>activeLanguage</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<tr class="row-odd"><td>selectURL</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>yes</td>
<td>URL to retrieve the result of the user selection</td>
</tr>
<tr class="row-even"><td>catalogTableURL</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<tr class="row-odd"><td>proposalCatalogURL</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<tr class="row-even"><td>proposalLabel</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<tr class="row-odd"><td>onCancel</td>
<td>function</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>Function that is called if the user cancels the selection. The default handler closes the tab</td>
</tr>
<tr class="row-even"><td>onSelect</td>
<td>function</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>yes</td>
<td>Called with the result of the selectURL as parameter</td>
</tr>
<tr class="row-odd"><td>userSettings</td>
<td>object</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>Additional user settings</td>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="SplitLayoutWithPersistence.html" class="btn btn-neutral float-right" title="SplitLayoutWithPersistence" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="CatalogPreview.html" class="btn btn-neutral" title="CatalogPreview" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
