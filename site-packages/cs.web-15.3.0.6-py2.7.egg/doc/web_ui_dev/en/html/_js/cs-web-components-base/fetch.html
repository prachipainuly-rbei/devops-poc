...
<head>
  ...
  <title>fetch &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="form-constants" href="constants.html"/>
        <link rel="prev" title="Dialog" href="index.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>fetch</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/fetch.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-fetch-module"></span><h1>fetch<a class="headerlink" href="#fetch" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#contents" id="id2">Contents</a><ul>
...
<p>Provide a set of wrapper functions to fetch data from the backend, or
send data to the backend. All functions return a Promise object, so callers
have a consistent way to attach follow-up actions to them.</p>
</div>
<div class="section" id="contents">
<h2><a class="toc-backref" href="#id2">Contents</a><a class="headerlink" href="#contents" title="Permalink to this headline">¶</a></h2>
<div class="section" id="functions">
<h3><a class="toc-backref" href="#id3">Functions</a><a class="headerlink" href="#functions" title="Permalink to this headline">¶</a></h3>
<div class="section" id="deleteobject">
<span id="cs-web-components-base-fetch-deleteobject"></span><h4>deleteObject<a class="headerlink" href="#deleteobject" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">deleteObject</span><span class="p">(</span><span class="nx">url</span><span class="o">:</span> <span class="nx">string</span><span class="p">)</span><span class="o">:</span> <span class="nx">thenable</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>url</em>: the URL to call</li>
</ul>
<p>Issue a DELETE request for a resource identified by the URL.</p>
</div>
<div class="section" id="fetchandcheck">
<span id="cs-web-components-base-fetch-fetchandcheck"></span><h4>fetchAndCheck<a class="headerlink" href="#fetchandcheck" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">fetchAndCheck</span><span class="p">(</span><span class="nx">url</span><span class="o">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">init</span><span class="o">:</span> <span class="nx">object</span><span class="p">)</span><span class="o">:</span> <span class="nx">thenable</span>
</pre></div>
</div>
<p>Wrapper around the standard fetch API, that throws errors for all returned
status codes not in the 2xx range.
See <a class="reference external" href="https://github.com/github/fetch#handling-http-error-statuses">https://github.com/github/fetch#handling-http-error-statuses</a>
This is a low level function that has the same arguments as the standard (to
be …) HTML5 fetch function.</p>
</div>
<div class="section" id="getjson">
<span id="cs-web-components-base-fetch-getjson"></span><h4>getJSON<a class="headerlink" href="#getjson" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">getJSON</span><span class="p">(</span><span class="nx">url</span><span class="o">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">params</span><span class="o">:</span> <span class="nb">Object</span><span class="p">)</span><span class="o">:</span> <span class="nx">thenable</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>url</em>: the URL to call. If needed, can already contain query parameters</li>
<li><em>params</em>: optional query parameters to append to the URL</li>
</ul>
<p>Issue a GET request, and interpret the result as JSON.</p>
</div>
<div class="section" id="postform">
<span id="cs-web-components-base-fetch-postform"></span><h4>postForm<a class="headerlink" href="#postform" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">postForm</span><span class="p">(</span><span class="nx">url</span><span class="o">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">formData</span><span class="o">:</span> <span class="nx">FormData</span><span class="p">)</span><span class="o">:</span> <span class="nx">thenable</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>url</em>: the URL to call</li>
<li><em>formData</em>: the request payload</li>
</ul>
<p>Issue a POST request with the payload formatted as form data, and interpret
the result as JSON.</p>
</div>
<div class="section" id="postjson">
<span id="cs-web-components-base-fetch-postjson"></span><h4>postJSON<a class="headerlink" href="#postjson" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">postJSON</span><span class="p">(</span><span class="nx">url</span><span class="o">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">data</span><span class="p">)</span><span class="o">:</span> <span class="nx">thenable</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>url</em>: the URL to call</li>
<li><em>data</em>: the request payload, will be formatted as JSON</li>
</ul>
<p>Issue a POST request with JSON formatted request body, and interpret the
result as JSON, if a response body was received.</p>
</div>
<div class="section" id="putjson">
<span id="cs-web-components-base-fetch-putjson"></span><h4>putJSON<a class="headerlink" href="#putjson" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">putJSON</span><span class="p">(</span><span class="nx">url</span><span class="o">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">data</span><span class="o">:</span> <span class="nx">object</span><span class="p">)</span><span class="o">:</span> <span class="nx">thenable</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
...
<p>Issue a PUT request with JSON formatted request body, and interpret the
result as JSON.
For responses with HTTP 204, 205 the result is undefined as these response codes
must not have a payload.</p>
</div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="constants.html" class="btn btn-neutral float-right" title="form-constants" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="index.html" class="btn btn-neutral" title="Dialog" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
