...
<head>
  ...
  <title>form-constants &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="DisplayForm" href="DisplayForm.html"/>
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>form-constants</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/constants.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="form-constants">
<span id="cs-web-components-base-form-constants-module"></span><h1>form-constants<a class="headerlink" href="#form-constants" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#constants" id="id4">Constants</a></li>
</ul>
</li>
</ul>
</div>
...
<p>This module provides constants used by the form module.</p>
</div>
...
<h3><a class="toc-backref" href="#id4">Constants</a><a class="headerlink" href="#constants" title="Permalink to this headline">¶</a></h3>
<p id="cs-web-components-base-form-constants-buttonactions"><strong>ButtonActions</strong>: The possible actions that a pre-submit dialog can associate with buttons. The
...
translation step.</p>
<p id="cs-web-components-base-form-constants-operationmode"><strong>OperationMode</strong>: Internal modes for a component that shows a UI to perform a backend operation.
The UI will typically reflect the current mode in the way it renders, and which
actions are available to the user.
<a class="reference internal" href="OperationHandler.html#cs-web-components-base-form-containers-operationhandler-module"><span class="std std-ref">OperationHandler</span></a>
Components may access the current mode of the operation via
<code class="docutils literal"><span class="pre">props.operationState.get('mode')</span></code>.</p>
<p>Possible values are:</p>
<ul class="simple">
<li>INITIAL: Default mode, no user interaction yet</li>
<li>STARTING: Set when runOperation is called, but state has not been initialized</li>
<li>STARTED: The user started an operation, interactions with the operation’s UI
are happening here</li>
<li>SUCCEEDED: The operation has been successfully completed.</li>
<li>FAILED: The execution of the operation has failed.</li>
<li>CANCELLED: The operation has been cancelled by the user.</li>
</ul>
<p>The values <code class="docutils literal"><span class="pre">SUCCEEDED</span></code>, <code class="docutils literal"><span class="pre">FAILED</span></code> and <code class="docutils literal"><span class="pre">CANCELLED</span></code> will be reset directly
after it has been propagated to the operation handler via <code class="docutils literal"><span class="pre">componentWillReceiveProps</span></code>.</p>
<p id="cs-web-components-base-form-constants-resulttype"><strong>ResultType</strong>: These constants correspond to CDB::IOperation::ResultType, defined in
src/cdbidl/CDBIOperation.idl.</p>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="DisplayForm.html" class="btn btn-neutral float-right" title="DisplayForm" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="fetch.html" class="btn btn-neutral" title="fetch" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
