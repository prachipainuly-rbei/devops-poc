...
<head>
  ...
  <title>Organizer &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="ApplicationFrame" href="ApplicationFrame.html"/>
        <link rel="prev" title="OperationToolbar" href="OperationToolbar.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Organizer</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/Organizer.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-components-organizer-default"></span><h1>Organizer<a class="headerlink" href="#organizer" title="Permalink to this headline">¶</a></h1>
...
<p>A component to allow reorganize items between different lists via
Drag &amp; Drop.</p>
...
<tbody valign="top">
<tr class="row-even"><td>itemLists</td>
<td>Immutable.List</td>
<td>-</td>
<td>Lists of items to be displayed</td>
</tr>
<tr class="row-odd"><td>placeholder</td>
<td>string</td>
<td>-</td>
<td>Placeholder text if a list is empty</td>
</tr>
<tr class="row-even"><td>onItemListsChange</td>
<td>func</td>
<td>-</td>
<td>Callback fires if the itemLists has been
changed. The changed lists is passed in.</td>
</tr>
</tbody>
</table>
<blockquote>
<div><p>Each list in the <code class="xref py py-obj docutils literal"><span class="pre">itemLists</span></code> should be an Immutable.Map and contain <code class="xref py py-obj docutils literal"><span class="pre">label</span></code>, <code class="xref py py-obj docutils literal"><span class="pre">items</span></code> and optionally,
<a class="reference external" href="https://docs.python.org/2.7/library/functions.html#id" title="(in Python v2.7)"><code class="xref py py-obj docutils literal"><span class="pre">id</span></code></a> and <code class="xref py py-obj docutils literal"><span class="pre">unsortable</span></code>. If <code class="xref py py-obj docutils literal"><span class="pre">unsortable</span></code> is set to true, the items can not be dragged to sort in its hosted
list.</p>
<p>The <code class="xref py py-obj docutils literal"><span class="pre">items</span></code> in each list should be an Immutable.List of item objects. Each such object
should be an Immutable.Map and contain <a class="reference external" href="https://docs.python.org/2.7/library/functions.html#id" title="(in Python v2.7)"><code class="xref py py-obj docutils literal"><span class="pre">id</span></code></a> and optionally, <code class="xref py py-obj docutils literal"><span class="pre">label</span></code> and <code class="xref py py-obj docutils literal"><span class="pre">renderer</span></code>.
If no <code class="xref py py-obj docutils literal"><span class="pre">renderer</span></code> exists, the item would be displayed using a default renderer. The default renderer
will render <code class="xref py py-obj docutils literal"><span class="pre">label</span></code> of that item, which can be e.g string or components. As fallback the <a class="reference external" href="https://docs.python.org/2.7/library/functions.html#id" title="(in Python v2.7)"><code class="xref py py-obj docutils literal"><span class="pre">id</span></code></a> would
be displayed.</p>
</div></blockquote>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="ApplicationFrame.html" class="btn btn-neutral float-right" title="ApplicationFrame" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="OperationToolbar.html" class="btn btn-neutral" title="OperationToolbar" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
