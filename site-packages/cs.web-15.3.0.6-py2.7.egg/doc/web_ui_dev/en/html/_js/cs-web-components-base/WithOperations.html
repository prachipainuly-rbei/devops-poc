...
<head>
  ...
  <title>WithOperations &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="containers/detail-wrapper" href="detail-wrapper.html"/>
        <link rel="prev" title="Thumbnail" href="Thumbnail.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>WithOperations</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/WithOperations.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="withoperations">
<span id="cs-web-components-base-components-withoperations-module"></span><h1>WithOperations<a class="headerlink" href="#withoperations" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#react-properties-passed-to-the-wrapped-component" id="id3">React Properties passed to the wrapped component</a></li>
<li><a class="reference internal" href="#react-properties-of-the-wrapping-component" id="id4">React Properties of the wrapping component</a></li>
<li><a class="reference internal" href="#example" id="id5">Example</a></li>
</ul>
</li>
<li><a class="reference internal" href="#contents" id="id6">Contents</a><ul>
<li><a class="reference internal" href="#functions" id="id7">Functions</a></li>
</ul>
</li>
</ul>
</div>
...
<p>This module provides the <code class="docutils literal"><span class="pre">WithOperations</span></code> Higher Order Component. This HOC
provides the wrapped component with an operations property that
contains a set of operations, selected by WithOperations based on its parameters.</p>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">Operations must be Web-UI enabled, or they will be filtered out of the list,
...
The field <code class="docutils literal"><span class="pre">submitURL</span></code> will be undefined for this operation.</p>
</div>
<p>Operations can be restricted by either giving an operation context name, or a
list of operation names (or both). The signature of WithOperations is as follows:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>WithOperations(
  Component: Component,
  {
    contextType: String,
...
<p>The structure of the args-parameter is as follows:</p>
<ul class="simple">
<li>contextType: type of the object, if not specified the components
contextObjects will be used to determine the object</li>
<li>operationContextName: string</li>
<li>operationNames: array</li>
</ul>
<p>The parameters <code class="docutils literal"><span class="pre">operationNames</span></code> and <code class="docutils literal"><span class="pre">operationContextName</span></code> specify the method
of how to determine the set of operations provided to the wrapped component and
should be considered mutually exclusive.</p>
<p>Operations always belong to an object class. This class is either given directly
as the parameter <code class="docutils literal"><span class="pre">contextType</span></code> to <code class="docutils literal"><span class="pre">WithOperations</span></code>, or – if no <code class="docutils literal"><span class="pre">contextType</span></code>
is specified – the component will use the base class of the provided
<code class="docutils literal"><span class="pre">contextObjects</span></code> as the class for which to request operations.</p>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">The context type of the objects or classes for which operations should be
fetched must be available for this component to work. If you use objects
without <a class="reference internal" href="object-actions.html#cs-web-components-base-actions-object-actions-fetchobject"><span class="std std-ref">fetchObject</span></a>,
you should use
<a class="reference internal" href="object-actions.html#cs-web-components-base-actions-object-actions-fetchtype"><span class="std std-ref">fetchType</span></a> to fetch
relevant type information.</p>
</div>
<p>The set of operations provided to the wrapped component is determined either by
providing argument <code class="docutils literal"><span class="pre">operationContextName</span></code> or <code class="docutils literal"><span class="pre">operationNames</span></code>. If an operation
...
passed.</p>
<div class="section" id="react-properties-passed-to-the-wrapped-component">
<h3><a class="toc-backref" href="#id3">React Properties passed to the wrapped component</a><a class="headerlink" href="#react-properties-passed-to-the-wrapped-component" title="Permalink to this headline">¶</a></h3>
...
<td>Immutable.List(opInfo)</td>
<td>The operations requested from the backend</td>
</tr>
</tbody>
</table>
</div>
<div class="section" id="react-properties-of-the-wrapping-component">
<h3><a class="toc-backref" href="#id4">React Properties of the wrapping component</a><a class="headerlink" href="#react-properties-of-the-wrapping-component" title="Permalink to this headline">¶</a></h3>
<table border="1" class="docutils">
<colgroup>
<col width="19%" />
<col width="19%" />
...
<tbody valign="top">
<tr class="row-even"><td>contextObject</td>
<td>Immutable.Map</td>
<td>-</td>
<td>For a single select operation on the provided
object.</td>
</tr>
<tr class="row-odd"><td>contextObjects</td>
<td><dl class="first last docutils">
<dt>Immutable.List(</dt>
<dd>contextObject)</dd>
</dl>
</td>
<td>-</td>
<td>For a multi select operation on the selected
objects.</td>
</tr>
</tbody>
</table>
<p>Note that contextObject and contextObjects are mutually exclusive, and none should be provided if a
<code class="docutils literal"><span class="pre">contextType</span></code> is specified.</p>
</div>
<div class="section" id="example">
<h3><a class="toc-backref" href="#id5">Example</a><a class="headerlink" href="#example" title="Permalink to this headline">¶</a></h3>
<div class="highlight-none"><div class="highlight"><pre><span></span>const MyOperationList = WithOperations(
  props =&gt; {
    return (
      &lt;ul&gt;
...
<h2><a class="toc-backref" href="#id6">Contents</a><a class="headerlink" href="#contents" title="Permalink to this headline">¶</a></h2>
...
<div class="section" id="cs-web-components-base-components-withoperations-withoperations">
<span id="id1"></span><h4>WithOperations<a class="headerlink" href="#cs-web-components-base-components-withoperations-withoperations" title="Permalink to this headline">¶</a></h4>
<p>Implementation of the <code class="docutils literal"><span class="pre">WithOperations</span></code> HOC.</p>
</div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="detail-wrapper.html" class="btn btn-neutral float-right" title="containers/detail-wrapper" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Thumbnail.html" class="btn btn-neutral" title="Thumbnail" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
