...
<head>
  ...
  <title>ContextObjectSetter &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="ContextObjectWrapper" href="context-wrapper-1.html"/>
        <link rel="prev" title="ConfiguredComponent" href="ConfiguredComponent.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>ContextObjectSetter</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/context-wrapper.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="contextobjectsetter">
<span id="cs-web-components-base-containers-context-wrapper-contextobjectsetter"></span><h1>ContextObjectSetter<a class="headerlink" href="#contextobjectsetter" title="Permalink to this headline">¶</a></h1>
...
<p><code class="docutils literal"><span class="pre">ContextObjectSetter</span></code> provides a callback function <code class="docutils literal"><span class="pre">onSelect</span></code> to its
single wrapped component. This callback can be used to set the selected
object(s) for a selection whose name is given in the <code class="docutils literal"><span class="pre">setPath</span></code> property.</p>
...
<tbody valign="top">
<tr class="row-even"><td>setPath</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>Path for local selection</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="context-wrapper-1.html" class="btn btn-neutral float-right" title="ContextObjectWrapper" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ConfiguredComponent.html" class="btn btn-neutral" title="ConfiguredComponent" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
