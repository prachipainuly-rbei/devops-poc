...
<head>
  ...
  <title>ContentOperationToolbar &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="DisplayContextLoader" href="DisplayContextLoader.html"/>
        <link rel="prev" title="ContentBlockGroup" href="ContentBlockGroup.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>ContentOperationToolbar</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/ContentOperationToolbar.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="contentoperationtoolbar">
<span id="cs-web-components-base-components-contentoperationtoolbar-contentoperationtoolbar"></span><h1>ContentOperationToolbar<a class="headerlink" href="#contentoperationtoolbar" title="Permalink to this headline">¶</a></h1>
...
<p>This component displays the configured operations for the provided <code class="docutils literal"><span class="pre">contextObject</span></code>
in a button toolbar. Optionally, an <code class="docutils literal"><span class="pre">operationContextName</span></code> may be provided, from
which to display operations. If a button is pressed, the operation is triggered in the
surrounding operation scope.</p>
<p>In order to disable the toolbar when an operation is running, the <code class="docutils literal"><span class="pre">isOperationRunning</span></code>
property may be used.</p>
...
<td>object</td>
<td>-</td>
<td>The object whose operation to display.</td>
</tr>
<tr class="row-odd"><td>operationContextName</td>
<td>object</td>
<td>-</td>
<td>Optional: If provided, only operations from this
context will be available.</td>
</tr>
<tr class="row-even"><td>iconSize</td>
<td>string</td>
<td>sm</td>
<td>Size of the toolbars buttons.</td>
</tr>
<tr class="row-odd"><td>isOperationRunning</td>
<td>bool</td>
<td>false</td>
<td>Buttons will be disabled while operation is
running if this is set to true.</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="DisplayContextLoader.html" class="btn btn-neutral float-right" title="DisplayContextLoader" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ContentBlockGroup.html" class="btn btn-neutral" title="ContentBlockGroup" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
