...
<head>
  ...
  <title>context-objects &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="actions/fetching" href="fetching.html"/>
        <link rel="prev" title="cs-web-components-base" href="__package_index__.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>context-objects</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/context-objects.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-actions-context-objects-module"></span><h1>context-objects<a class="headerlink" href="#context-objects" title="Permalink to this headline">¶</a></h1>
...
<div class="section" id="setcontextobjectlist">
<span id="cs-web-components-base-actions-context-objects-setcontextobjectlist"></span><h4>setContextObjectList<a class="headerlink" href="#setcontextobjectlist" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">setContextObjectList</span><span class="p">(</span><span class="nx">path</span><span class="o">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">values</span><span class="o">:</span> <span class="nx">Immutable</span><span class="p">.</span><span class="nx">List</span><span class="p">)</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>path</em>: Path to store the selection for, segments separated by ‘/’</li>
<li><dl class="first docutils">
<dt><em>values</em>: A list of (mixed) objects or strings, a string</dt>
<dd>is assumed to be the &#64;id of an object</dd>
</dl>
</li>
</ul>
<p>Store a list of selected objects for a path. The path is used to retrieve the
objects from the store. We always store the &#64;id’s of the objects, not the objects
themselves, to avoid stale object states.</p>
<p>Objects not already present in the store will be fetched, so that not every
using component has to do this.</p>
</div>
<div class="section" id="setcontextobjectsbatchload">
<span id="cs-web-components-base-actions-context-objects-setcontextobjectsbatchload"></span><h4>setContextObjectsBatchLoad<a class="headerlink" href="#setcontextobjectsbatchload" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">setContextObjectsBatchLoad</span><span class="p">(</span><span class="nx">path</span><span class="o">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">values</span><span class="o">:</span> <span class="nx">Immutable</span><span class="p">.</span><span class="nx">List</span><span class="p">)</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>path</em>: Path to store the selection for, segments separated by ‘/’</li>
<li><em>values</em>: A list of object identifiers [&#64;id, restname, keys}]</li>
</ul>
<p>Store a list of selected objects for a path. The path is used to retrieve the
objects from the store. We always store the &#64;id’s of the objects, not the objects
themselves, to avoid stale object states.</p>
<p>Objects not already present in the store will be fetched, so that not every
using component has to do this.</p>
<p>The objects will be fetched from the server by a single call.</p>
</div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="fetching.html" class="btn btn-neutral float-right" title="actions/fetching" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="__package_index__.html" class="btn btn-neutral" title="cs-web-components-base" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
