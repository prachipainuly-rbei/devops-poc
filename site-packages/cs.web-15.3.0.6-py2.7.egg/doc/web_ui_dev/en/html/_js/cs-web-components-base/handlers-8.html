...
<head>
  ...
  <title>operations/sagas/handlers &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="operations/sagas/operations" href="operations-23.html"/>
        <link rel="prev" title="operations/actions/operations" href="operations-4.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>operations/sagas/handlers</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/handlers-8.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="operations-sagas-handlers">
<span id="cs-web-components-base-operations-sagas-handlers-module"></span><h1>operations/sagas/handlers<a class="headerlink" href="#operations-sagas-handlers" title="Permalink to this headline">¶</a></h1>
...
<div class="section" id="dispatchresulthandler">
<span id="cs-web-components-base-operations-sagas-handlers-dispatchresulthandler"></span><h4>dispatchResultHandler<a class="headerlink" href="#dispatchresulthandler" title="Permalink to this headline">¶</a></h4>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">dispatchResultHandler</span><span class="p">(</span><span class="nx">handler</span><span class="p">,</span> <span class="nx">action</span><span class="p">)</span>
</pre></div>
</div>
<p><strong>Takes:</strong></p>
<ul class="simple">
<li><em>handler</em>: The action creator to be dispatched.</li>
<li><em>action</em>: The action with which the handler saga was invoked.</li>
</ul>
<p>Invoke a handler action from a handler saga.</p>
<p>This is useful, if you, e.g., want to invoke another handler from your own custom
handler saga.</p>
<p><strong>Example</strong>:</p>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="kr">import</span> <span class="p">{</span><span class="nx">ReduxSaga</span><span class="p">}</span> <span class="nx">from</span> <span class="s1">&#39;cs-web-components-externals&#39;</span><span class="p">;</span>
<span class="kr">import</span> <span class="nx">Operations</span> <span class="nx">from</span> <span class="s1">&#39;../operations&#39;</span><span class="p">;</span>
<span class="kr">import</span> <span class="p">{</span><span class="nx">Registry</span><span class="p">}</span> <span class="nx">from</span> <span class="s1">&#39;../registry.js&#39;</span><span class="p">;</span>

<span class="kr">const</span> <span class="p">{</span><span class="nx">takeEvery</span><span class="p">}</span> <span class="o">=</span> <span class="nx">ReduxSaga</span><span class="p">.</span><span class="nx">effects</span><span class="p">;</span>

<span class="kr">const</span> <span class="nx">CUSTOM_HANDLER_ACTION</span> <span class="o">=</span> <span class="s2">&quot;CUSTOM_HANDLER_ACTION&quot;</span><span class="p">;</span>

<span class="kd">function</span> <span class="o">*</span><span class="nx">myCustomHandlerSaga</span><span class="p">(</span><span class="nx">action</span><span class="p">)</span> <span class="p">{</span>
   <span class="kr">const</span> <span class="p">{</span><span class="nx">dispatchResultHandler</span><span class="p">,</span> <span class="nx">Handlers</span><span class="p">}</span> <span class="o">=</span> <span class="nx">Operations</span><span class="p">;</span>
   <span class="k">if</span> <span class="p">(</span><span class="nx">resultNeedsSpecialHandling</span><span class="p">(</span><span class="nx">action</span><span class="p">))</span> <span class="p">{</span>
      <span class="c1">// Your handler code here ...</span>
   <span class="p">}</span> <span class="k">else</span> <span class="p">{</span>
      <span class="c1">// Invoke default handler</span>
      <span class="k">yield</span> <span class="nx">call</span><span class="p">(</span>
        <span class="nx">dispatchResultHandler</span><span class="p">,</span>
        <span class="nx">Handlers</span><span class="p">.</span><span class="nx">updateObjectStore</span><span class="p">,</span>
        <span class="nx">action</span>
      <span class="p">);</span>
   <span class="p">}</span>
<span class="p">}</span>

<span class="kd">function</span> <span class="o">*</span><span class="nx">myCustomHandlerWatcher</span><span class="p">()</span> <span class="p">{</span>
   <span class="k">yield</span> <span class="nx">takeEvery</span><span class="p">(</span><span class="nx">CUSTOM_HANDLER_ACTION</span><span class="p">,</span> <span class="nx">myCustomHandlerSaga</span><span class="p">);</span>
<span class="p">}</span>

<span class="nx">Registry</span><span class="p">.</span><span class="nx">registerSaga</span><span class="p">(</span><span class="nx">myCustomHandlerWatcher</span><span class="p">);</span>
</pre></div>
</div>
<p>The custom handler in the example above to handle a result in a
custom way, if <code class="docutils literal"><span class="pre">resultNeedsSpecialHandling</span></code> evaluates to true,
else it updates the object in the store.</p>
</div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="operations-23.html" class="btn btn-neutral float-right" title="operations/sagas/operations" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="operations-4.html" class="btn btn-neutral" title="operations/actions/operations" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
