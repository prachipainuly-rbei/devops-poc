...
<head>
  ...
  <title>Favorites &mdash; Web UI Development</title>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Favorites</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/Favorites.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-components-navigation-favorites-favorites"></span><h1>Favorites<a class="headerlink" href="#favorites" title="Permalink to this headline">¶</a></h1>
...
<p>Displays the WebUI favorites of the current user. Note that these are
different from the favorites created using the Windows Client.</p>
...
<p><strong>Favorites</strong>: The view itself can be retrieved using this key.</p>
<p><strong>FavoritesEntry_n</strong>: Replace n with a number. The entries can be
retrieved using these IDs. They are numbered starting from 0.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="History.html" class="btn btn-neutral float-right" title="History" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
