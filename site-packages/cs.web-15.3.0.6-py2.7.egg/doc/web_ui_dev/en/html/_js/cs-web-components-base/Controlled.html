...
<head>
  ...
  <title>overlays/Controlled &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="overlays/DropdownButton" href="DropdownButton.html"/>
        <link rel="prev" title="Overlay-Constants" href="constants-4.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>overlays/Controlled</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/Controlled.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="overlays-controlled">
<span id="cs-web-components-base-overlays-controlled-module"></span><h1>overlays/Controlled<a class="headerlink" href="#overlays-controlled" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#removed-react-properties" id="id2">Removed React Properties</a></li>
<li><a class="reference internal" href="#added-react-properties" id="id3">Added React Properties</a></li>
</ul>
</div>
...
<p>This module provides a HOC that provides functionality to display
and hide overlays as a result of user interaction.</p>
<p>The main point of this HOC is the <code class="docutils literal"><span class="pre">onHide</span></code> callback. This will allow you to
close the overlay according to user’s expectations:</p>
<ul class="simple">
<li>Either by pressing the <code class="docutils literal"><span class="pre">Escape</span></code> key, when the overlay is focused</li>
<li>or by focusing another element.</li>
</ul>
<p>Note that the actual visibility state has to be stored by the user, so you are
able to handle the <code class="docutils literal"><span class="pre">onHide</span></code> callback to your liking.</p>
</div>
<div class="section" id="removed-react-properties">
<h2><a class="toc-backref" href="#id2">Removed React Properties</a><a class="headerlink" href="#removed-react-properties" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li>onBlur: Used for <code class="docutils literal"><span class="pre">onHide</span></code>.</li>
</ul>
</div>
<div class="section" id="added-react-properties">
<h2><a class="toc-backref" href="#id3">Added React Properties</a><a class="headerlink" href="#added-react-properties" title="Permalink to this headline">¶</a></h2>
...
<tbody valign="top">
<tr class="row-even"><td>grabFocus</td>
<td>bool, default <code class="docutils literal"><span class="pre">false</span></code></td>
<td>Should focus be set to the overlay
on show</td>
</tr>
<tr class="row-odd"><td>onHide</td>
<td>function</td>
<td>Called when the overlay should be
hidden</td>
</tr>
<tr class="row-even"><td>hideOnScroll</td>
<td>boolean</td>
<td>If set, <code class="docutils literal"><span class="pre">onHide</span></code> will be invoked when
scrolling happens in a container.</td>
</tr>
</tbody>
</table>
<div class="admonition warning">
<p class="first admonition-title">Warning</p>
<p class="last">This component is not considered part of the supported cs.web API. This documentation
...
subject to change without prior notification.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="DropdownButton.html" class="btn btn-neutral float-right" title="overlays/DropdownButton" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="constants-4.html" class="btn btn-neutral" title="Overlay-Constants" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
