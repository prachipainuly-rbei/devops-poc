...
<head>
  ...
  <title>CatalogField &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="ComboBox" href="ComboBox.html"/>
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>CatalogField</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/CatalogField.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="catalogfield">
<span id="cs-web-components-base-formcontrols-catalogfield-catalogfield"></span><h1>CatalogField<a class="headerlink" href="#catalogfield" title="Permalink to this headline">¶</a></h1>
...
<p>This component contains a text input field and a button to open a catalog, which let the user to
...
its logic in CONTACT Elements. This component has following properties in addition to properties of
&lt;<a class="reference internal" href="TextInput.html#cs-web-components-base-formcontrols-textinput-default"><span class="std std-ref">TextInput</span></a>&gt;:</p>
...
<tbody valign="top">
<tr class="row-even"><td>textReadOnly</td>
<td>bool</td>
...
<td>Whether to set the input field as readonly</td>
</tr>
<tr class="row-odd"><td>formData</td>
<td>Immutable.Map</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>Form data to be used to query catalog data entries, including the output fields the catalog should set</td>
</tr>
<tr class="row-even"><td>contextClass</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>Class of context objects for catalog data</td>
</tr>
<tr class="row-odd"><td>activeLanguage</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>In which language should catalog data be loaded</td>
</tr>
<tr class="row-even"><td>selectURL</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>URL to submit the user selection, as result the changed fields and values would be returned as mapping</td>
</tr>
<tr class="row-odd"><td>onCatalogChange</td>
<td>func</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>A callback fired when a catalog entry is selected</td>
</tr>
<tr class="row-even"><td>typeAheadURL</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>URL to load suggested entries supporting type ahead</td>
</tr>
<tr class="row-odd"><td>catalogTableURL</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>yes</td>
<td>URL to load table data and configuration for displaying the catalog entries</td>
</tr>
<tr class="row-even"><td>proposalCatalogURL</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>URL to load table data and configuration for displaying the proposal table entries</td>
</tr>
<tr class="row-odd"><td>proposalLabel</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>Proposal table title</td>
</tr>
<tr class="row-even"><td>userSettings</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>Additional user settings</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="ComboBox.html" class="btn btn-neutral float-right" title="ComboBox" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Calendar.html" class="btn btn-neutral" title="Calendar" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
