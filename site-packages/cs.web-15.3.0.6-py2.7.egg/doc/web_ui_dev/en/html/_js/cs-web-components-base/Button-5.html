...
<head>
  ...
  <title>IconTextButton &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="TextButton" href="Button-8.html"/>
        <link rel="prev" title="IconButton" href="Button-4.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>IconTextButton</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/Button-5.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="icontextbutton">
<span id="cs-web-components-base-components-button-icontextbutton"></span><h1>IconTextButton<a class="headerlink" href="#icontextbutton" title="Permalink to this headline">¶</a></h1>
...
<p>This button renders both an icon and a text label. Depending on the source you want to use,
either use the property <code class="docutils literal"><span class="pre">iconName</span></code> for fetching from the backend or <code class="docutils literal"><span class="pre">iconSrc</span></code>
for an arbitrary source url.
In addition to the properties in <a class="reference internal" href="Button.html#cs-web-components-base-components-button-module"><span class="std std-ref">Button</span></a>,
it receives the following properties:</p>
...
<td>string</td>
<td>“outline”</td>
<td>Determines the button style</td>
</tr>
<tr class="row-odd"><td>label</td>
<td>string</td>
<td>-</td>
<td>The label that is displayed in the button</td>
</tr>
<tr class="row-even"><td>iconName</td>
<td>string</td>
<td>-</td>
<td>Load an icon defined in the backend by its
resource id</td>
</tr>
<tr class="row-odd"><td>iconSrc</td>
<td>string</td>
<td>-</td>
<td>Load an icon by the provided URL.</td>
</tr>
<tr class="row-even"><td>onClick</td>
<td>func</td>
<td>-</td>
<td>A callback function, which is executed when the
button is pushed.</td>
</tr>
</tbody>
</table>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Button-8.html" class="btn btn-neutral float-right" title="TextButton" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Button-4.html" class="btn btn-neutral" title="IconButton" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
