...
<head>
  ...
  <title>ContentBlock &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="ContentBlockGroup" href="ContentBlockGroup.html"/>
        <link rel="prev" title="ImageViewer" href="ImageViewer.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>ContentBlock</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/ContentBlock.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-components-contentblock-default"></span><h1>ContentBlock<a class="headerlink" href="#contentblock" title="Permalink to this headline">¶</a></h1>
...
<p>The ContentBlock component provides a unified way to enhance a component
...
can contain an icon, if specified.</p>
<div class="section" id="examples">
<h3><a class="toc-backref" href="#id2">Examples</a><a class="headerlink" href="#examples" title="Permalink to this headline">¶</a></h3>
<div class="highlight-none"><div class="highlight"><pre><span></span>&lt;ContentBlock collapsible={true}
              expanded={true}
...
component</td>
<td>“”</td>
<td>A title string or component to be displayed
on the upper left of the component</td>
</tr>
<tr class="row-odd"><td>icon</td>
<td>component</td>
<td>null</td>
<td>A component to be displayed in the header</td>
</tr>
<tr class="row-even"><td>contentStyle</td>
<td>string</td>
<td>‘default’</td>
<td>A semantic style, according to Bootstrap
states. One of ‘default’, ‘primary’,
‘warning’, ‘danger’, ‘info’, ‘success’.</td>
</tr>
<tr class="row-odd"><td>collapsible</td>
<td>boolean</td>
<td>true</td>
<td>true if the component should be collapsible</td>
</tr>
<tr class="row-even"><td>expanded</td>
<td>boolean</td>
<td>true</td>
<td>true if the initial/current state should
be expanded</td>
</tr>
<tr class="row-odd"><td>onExpansionChanged</td>
<td>function</td>
<td>-</td>
<td>Invoked when components expansion state has
changed. Receives new expansion state as
argument.</td>
</tr>
<tr class="row-even"><td>headerDragger</td>
<td>function</td>
<td>Identity</td>
<td>A function that will be wrapped around the
header to make it draggable. The function is
typically a property injected by DragSource()</td>
</tr>
<tr class="row-odd"><td>children</td>
<td>[components]</td>
<td>-</td>
<td>the child components in the ContentBlock</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="ContentBlockGroup.html" class="btn btn-neutral float-right" title="ContentBlockGroup" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ImageViewer.html" class="btn btn-neutral" title="ImageViewer" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
