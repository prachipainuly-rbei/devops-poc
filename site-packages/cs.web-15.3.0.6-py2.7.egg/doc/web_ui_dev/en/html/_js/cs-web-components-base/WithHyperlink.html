...
<head>
  ...
  <title>formcontrols/WithHyperlink &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="formcontrols/WithTypeAhead" href="WithTypeAhead.html"/>
        <link rel="prev" title="Password" href="Password.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>formcontrols/WithHyperlink</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/WithHyperlink.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="formcontrols-withhyperlink">
<span id="cs-web-components-base-formcontrols-withhyperlink-module"></span><h1>formcontrols/WithHyperlink<a class="headerlink" href="#formcontrols-withhyperlink" title="Permalink to this headline">¶</a></h1>
...
<p>This component enhances another &lt;<a class="reference internal" href="TextInput.html#cs-web-components-base-formcontrols-textinput-default"><span class="std std-ref">TextInput</span></a>&gt;-based
form control, so that it will be possible to open a hyperlink from there. The extended
component has following additional properties:</p>
...
<tbody valign="top">
<tr class="row-even"><td>targetLink</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>The link of the target, usually an URL</td>
</tr>
<tr class="row-odd"><td>targetWindow</td>
<td>string</td>
<td>_blank</td>
<td>Where to open the <code class="docutils literal"><span class="pre">targetLink</span></code>, compare
the <code class="docutils literal"><span class="pre">target</span></code> attribute on <code class="docutils literal"><span class="pre">&lt;a&gt;</span></code> tag</td>
</tr>
<tr class="row-even"><td>onNavigateLink</td>
<td>func</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>If given, this function will be called with <code class="docutils literal"><span class="pre">targetLink</span></code> as argument
to navigate, instead of opening the link automatically. <code class="docutils literal"><span class="pre">targetWindow</span></code>
is ignored.</td>
</tr>
</tbody>
</table>
<p>Example:</p>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="kr">import</span> <span class="p">{</span><span class="nx">TextInput</span><span class="p">,</span> <span class="nx">WithHyperlink</span><span class="p">}</span> <span class="nx">from</span> <span class="s1">&#39;cs-web-components-base&#39;</span><span class="p">;</span>
<span class="c1">// the new extended component</span>
<span class="kr">const</span> <span class="nx">LinkedTextInput</span> <span class="o">=</span> <span class="nx">WithHyperlink</span><span class="p">(</span><span class="nx">TextInput</span><span class="p">);</span>
<span class="p">...</span>
<span class="c1">// in render method of some component</span>
<span class="nx">render</span><span class="p">()</span> <span class="p">{</span>
    <span class="k">return</span> <span class="p">(</span>
        <span class="o">&lt;</span><span class="nx">LinkedTextInput</span> <span class="nx">label</span><span class="o">=</span><span class="s2">&quot;Some Field&quot;</span>
                         <span class="nx">value</span><span class="o">=</span><span class="p">{</span><span class="k">this</span><span class="p">.</span><span class="nx">state</span><span class="p">.</span><span class="nx">someText</span><span class="p">}</span>
                         <span class="nx">targetLink</span><span class="o">=</span><span class="p">{</span><span class="k">this</span><span class="p">.</span><span class="nx">state</span><span class="p">.</span><span class="nx">someURL</span><span class="p">}</span> <span class="o">/&gt;</span><span class="p">);</span>
<span class="p">}</span>
</pre></div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="WithTypeAhead.html" class="btn btn-neutral float-right" title="formcontrols/WithTypeAhead" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Password.html" class="btn btn-neutral" title="Password" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
