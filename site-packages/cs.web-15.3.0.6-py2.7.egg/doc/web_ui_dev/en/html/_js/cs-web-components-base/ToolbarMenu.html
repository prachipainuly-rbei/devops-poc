...
<head>
  ...
  <title>ToolbarMenu &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="RestTree" href="RestTree.html"/>
        <link rel="prev" title="Fixed" href="Fixed.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>ToolbarMenu</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/ToolbarMenu.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="toolbarmenu">
<span id="cs-web-components-base-table-toolbarmenu-toolbarmenu"></span><h1>ToolbarMenu<a class="headerlink" href="#toolbarmenu" title="Permalink to this headline">¶</a></h1>
...
<p>Usage:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>class MenuExample extends React.Component {
    render() {
        return (
...
const SpecialTable = Table.Manager({
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="RestTree.html" class="btn btn-neutral float-right" title="RestTree" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Fixed.html" class="btn btn-neutral" title="Fixed" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
