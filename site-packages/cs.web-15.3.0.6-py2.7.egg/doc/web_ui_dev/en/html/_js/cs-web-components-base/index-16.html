...
<head>
  ...
  <title>table/column_search/index &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="table/filterable/index" href="index-17.html"/>
        <link rel="prev" title="table/column_resizer/index" href="index-15.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>table/column_search/index</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/index-16.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="table-column-search-index">
<span id="cs-web-components-base-table-column-search-index-module"></span><h1>table/column_search/index<a class="headerlink" href="#table-column-search-index" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#components" id="id2">Components</a></li>
...
<p>Provides columns search functionality in a table.</p>
<div class="section" id="components">
<h3><a class="toc-backref" href="#id2">Components</a><a class="headerlink" href="#components" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>Provider: Is required for column search</li>
<li>ColumnActions: Adds a search input control (FormControl), if configured for the column, to the column header</li>
<li><dl class="first docutils">
<dt>ToolbarButton: Is required for column search.</dt>
<dd>Adds a button to show/hide column header search input controls
Adds a button to excecute search if search input controls are visible</dd>
</dl>
</li>
</ul>
</div>
<div class="section" id="properties">
<h3><a class="toc-backref" href="#id3">Properties</a><a class="headerlink" href="#properties" title="Permalink to this headline">¶</a></h3>
...
<tbody valign="top">
<tr class="row-even"><td>initURL</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>TODO: equal to initURL from ConfiguredForm</td>
</tr>
<tr class="row-odd"><td>initValues</td>
<td>Immutable.Map</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>Values to initial fill search input controls</td>
</tr>
<tr class="row-even"><td>onSearchHeaderSubmit</td>
<td>func</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>Callback to start search operation</td>
</tr>
</tbody>
</table>
</div>
<div class="section" id="remarks">
<h3><a class="toc-backref" href="#id4">Remarks</a><a class="headerlink" href="#remarks" title="Permalink to this headline">¶</a></h3>
<p>TODO:</p>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="index-17.html" class="btn btn-neutral float-right" title="table/filterable/index" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="index-15.html" class="btn btn-neutral" title="table/column_resizer/index" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
