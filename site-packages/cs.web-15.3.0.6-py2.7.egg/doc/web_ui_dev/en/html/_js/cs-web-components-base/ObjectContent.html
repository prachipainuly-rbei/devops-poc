...
<head>
  ...
  <title>ObjectContent &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="RelatedObjects" href="RelatedObjects.html"/>
        <link rel="prev" title="PersistentCollapsible" href="PersistentCollapsible.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>ObjectContent</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/ObjectContent.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-components-plugin-containers-objectcontent-default"></span><h1>ObjectContent<a class="headerlink" href="#objectcontent" title="Permalink to this headline">¶</a></h1>
...
<p>A plugin container component that displays the “content” of an object in the
...
file format.</p>
<p>The plugin components receive the URL of the file they should render in the
<code class="docutils literal"><span class="pre">url</span></code> property, and the name of the file as <code class="docutils literal"><span class="pre">filename</span></code>.</p>
...
<td>Immutable.Map</td>
<td>-</td>
<td>The object whose content is shown</td>
</tr>
<tr class="row-odd"><td>pluginContextName</td>
<td>string</td>
<td>‘content-view’</td>
<td>The plugin ID for the configuration</td>
</tr>
<tr class="row-even"><td>showPlaceholder</td>
<td>bool</td>
<td>-</td>
<td>Whether to show an empty view if no
context object selected</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="RelatedObjects.html" class="btn btn-neutral float-right" title="RelatedObjects" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="PersistentCollapsible.html" class="btn btn-neutral" title="PersistentCollapsible" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
