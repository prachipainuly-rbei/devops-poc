...
<head>
  ...
  <title>RelatedObjects &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="prev" title="ObjectContent" href="ObjectContent.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>RelatedObjects</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/RelatedObjects.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-components-plugin-containers-relatedobjects-relatedobjects"></span><h1>RelatedObjects<a class="headerlink" href="#relatedobjects" title="Permalink to this headline">¶</a></h1>
...
<p>A plugin container component to show objects related in some way to the
contextObject. Which objects should be displayed is configured in the backend
in the ‘Assigned objects’ configuration.</p>
<p>The objects are displayed as small ‘tiles’, where the tiles are dynamically
determined React components, based on the class of the objects (ie. the
<code class="docutils literal"><span class="pre">discriminator</span></code> in the plugin configuration must be a class name, see
<a class="reference internal" href="../../web_ui_plugins.html#web-ui-plugins"><span class="std std-ref">Frontend Plugins</span></a> for details). The tile components receive the object
they must render in their <code class="docutils literal"><span class="pre">contextObject</span></code> property.</p>
...
<td>Immutable.Map</td>
<td>-</td>
<td>The object that is the origin
of the relations shown</td>
</tr>
<tr class="row-odd"><td>pluginContextName</td>
<td>string</td>
<td>‘class-tile-small’</td>
<td>The plugin ID that configures
the tiles</td>
</tr>
</tbody>
</table>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="ProgressBar.html" class="btn btn-neutral float-right" title="ProgressBar" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ObjectContent.html" class="btn btn-neutral" title="ObjectContent" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
