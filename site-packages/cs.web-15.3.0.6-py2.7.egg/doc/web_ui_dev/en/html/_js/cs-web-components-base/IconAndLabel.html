...
<head>
  ...
  <title>IconAndLabel &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="components/navigation/Link" href="Link.html"/>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>IconAndLabel</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/IconAndLabel.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-components-iconandlabel-module"></span><h1>IconAndLabel<a class="headerlink" href="#iconandlabel" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#react-properties" id="id5">React Properties</a></li>
</ul>
</li>
...
<li><a class="reference internal" href="#id1" id="id9">React Properties</a></li>
<li><a class="reference internal" href="#id2" id="id10">React Properties</a></li>
<li><a class="reference internal" href="#id3" id="id11">React Properties</a></li>
</ul>
</li>
</ul>
</div>
...
<p>The IconAndLabel module provides a basic layout components for rendering an icon and a text label.
In addition convenience components are provided for SVGIcon and Link rendering.</p>
<div class="section" id="react-properties">
<h3><a class="toc-backref" href="#id5">React Properties</a><a class="headerlink" href="#react-properties" title="Permalink to this headline">¶</a></h3>
...
<td>node</td>
<td>-</td>
<td>Label to be displayed</td>
</tr>
<tr class="row-even"><td>allowEmptyIcon</td>
<td>bool</td>
<td>-</td>
<td>If true and icon cannot be rendered, renders a
white space instead. Else only label is rendered.</td>
</tr>
</tbody>
</table>
</div>
...
<h3><a class="toc-backref" href="#id8">Constants</a><a class="headerlink" href="#constants" title="Permalink to this headline">¶</a></h3>
<p id="cs-web-components-base-components-iconandlabel-iconandlabel"><strong>IconAndLabel</strong>: Basic component that expects an icon and label node.</p>
</div>
<div class="section" id="id1">
<h3><a class="toc-backref" href="#id9">React Properties</a><a class="headerlink" href="#id1" title="Permalink to this headline">¶</a></h3>
<table border="1" class="docutils">
<colgroup>
<col width="18%" />
<col width="13%" />
...
<p id="cs-web-components-base-components-iconandlabel-svgiconandlabel"><strong>SVGIconAndLabel</strong>: Convenience component for rendering a SVG icon label.</p>
</div>
<div class="section" id="id2">
<h3><a class="toc-backref" href="#id10">React Properties</a><a class="headerlink" href="#id2" title="Permalink to this headline">¶</a></h3>
<table border="1" class="docutils">
<colgroup>
<col width="18%" />
<col width="13%" />
...
<td>string</td>
<td>-</td>
<td>See SVGIcon property “src”.</td>
</tr>
<tr class="row-odd"><td>name</td>
<td>string</td>
<td>-</td>
<td>See SVGIcon property “name”.</td>
</tr>
<tr class="row-even"><td>size</td>
<td>string</td>
<td>“sm”</td>
<td>See SVGIcon property “size”.</td>
</tr>
</tbody>
</table>
<p id="cs-web-components-base-components-iconandlabel-svgiconandlink"><strong>SVGIconAndLink</strong>: Convenience component for rendering a SVG icon with a link.</p>
</div>
<div class="section" id="id3">
<h3><a class="toc-backref" href="#id11">React Properties</a><a class="headerlink" href="#id3" title="Permalink to this headline">¶</a></h3>
<table border="1" class="docutils">
<colgroup>
<col width="18%" />
<col width="13%" />
...
<td>See Link property “to”.</td>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Link.html" class="btn btn-neutral float-right" title="components/navigation/Link" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Button.html" class="btn btn-neutral" title="Button" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
