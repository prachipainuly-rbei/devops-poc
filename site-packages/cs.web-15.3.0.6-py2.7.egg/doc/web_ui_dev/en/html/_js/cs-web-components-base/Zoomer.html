...
<head>
  ...
  <title>Zoomer &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="ConfiguredComponent" href="ConfiguredComponent.html"/>
        <link rel="prev" title="Throbber" href="Throbber.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Zoomer</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/Zoomer.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="zoomer">
<span id="cs-web-components-base-components-zoomer-default"></span><h1>Zoomer<a class="headerlink" href="#zoomer" title="Permalink to this headline">¶</a></h1>
...
<p>This Component provides basic controls for zooming in and out of embedded media
...
best fit its container.</p>
<p>Note that this component does not handle zooming logic, manipulation of zoom level
depends on the content that is modified, and should be implemented in the
component that renders the content.</p>
<p>The following properties should be provided to Zoomer:</p>
...
<tbody valign="top">
<tr class="row-even"><td>currentScale</td>
<td>number</td>
<td>-</td>
<td>The current scale of the associated content, this
should be stored in the state of a parent
component.</td>
</tr>
<tr class="row-odd"><td>onZoomIn</td>
<td>func</td>
<td>-</td>
<td>Increase the zoom level, and zoom into the
associated content.</td>
</tr>
<tr class="row-even"><td>onZoomOut</td>
<td>func</td>
<td>-</td>
<td>Decrease the zoom level, and zoom out of the
associated content.</td>
</tr>
<tr class="row-odd"><td>onReset</td>
<td>func</td>
<td>-</td>
<td>Reset the zoom level to a default value.</td>
</tr>
<tr class="row-even"><td>onZoomToFit</td>
<td>func</td>
<td>-</td>
<td>Set the zoom level to a value that best fits the
layout in which the content is rendered.</td>
</tr>
<tr class="row-odd"><td>onZoomToFitHorizontal</td>
<td>func</td>
<td>-</td>
<td>Set the zoom level to a value that best fits the
width of the layout.</td>
</tr>
<tr class="row-even"><td>onZoomToFitVertical</td>
<td>func</td>
<td>-</td>
<td>Set the zoom level to a value that best fits the
height of the layout.</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="ConfiguredComponent.html" class="btn btn-neutral float-right" title="ConfiguredComponent" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Throbber.html" class="btn btn-neutral" title="Throbber" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
