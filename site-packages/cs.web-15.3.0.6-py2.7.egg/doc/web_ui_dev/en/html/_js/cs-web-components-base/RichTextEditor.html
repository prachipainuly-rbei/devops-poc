...
<head>
  ...
  <title>RichTextEditor &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="ColumnContent" href="ColumnContent.html"/>
        <link rel="prev" title="TypeAhead" href="TypeAhead.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>RichTextEditor</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/RichTextEditor.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="richtexteditor">
<span id="cs-web-components-base-richtext-richtexteditor-default"></span><h1>RichTextEditor<a class="headerlink" href="#richtexteditor" title="Permalink to this headline">¶</a></h1>
...
<p>RichTextEditor provides the possibility to enter enhanced text with properties of color, size, etc.
...
<td>string</td>
<td>-</td>
<td>The content as stringified json to be shown in the
editor.</td>
</tr>
<tr class="row-odd"><td>readOnly</td>
<td>bool</td>
<td>false</td>
<td>Specifies if the editor is shown in readonly mode</td>
</tr>
<tr class="row-even"><td>styleMap</td>
<td>map</td>
<td>{}</td>
<td>Additional styles like font color, sizes, etc.</td>
</tr>
<tr class="row-odd"><td>additionalButtons</td>
<td>list</td>
<td>[]</td>
<td>Additional buttons for new entities, styles, etc.</td>
</tr>
<tr class="row-even"><td>additionalDecorators</td>
<td>list</td>
<td>[]</td>
<td>Additional decorators for additional entities</td>
</tr>
...
<td>Specifies the height of the editor. Normally that
is 100vh - 34 px. In case height is set to 0 the
styling is removed.</td>
</tr>
...
<td>When using the RichTextEditor component inside a
...
container here.</td>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="ColumnContent.html" class="btn btn-neutral float-right" title="ColumnContent" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="TypeAhead.html" class="btn btn-neutral" title="TypeAhead" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
