...
<head>
  ...
  <title>RelationshipGroup &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="RelationshipTable" href="RelationshipTable.html"/>
        <link rel="prev" title="RelationshipFetcher" href="RelationshipFetcher.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>RelationshipGroup</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/RelationshipGroup.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-components-objectwidgets-relationshipgroup-default"></span><h1>RelationshipGroup<a class="headerlink" href="#relationshipgroup" title="Permalink to this headline">¶</a></h1>
...
<p>Render a control that contains relationships of an object. The relationships
that are usable have to be provided in the app setup.</p>
...
<td>A list of relationship REST names. These
relationships will be displayed. If the
array is undefined the relationships that
are configured as dialog registers are used</td>
</tr>
...
<td>A list of relationship REST names. These
relationships will not be displayed.</td>
</tr>
<tr class="row-even"><td>tableHeight</td>
<td>string</td>
<td><code class="docutils literal"><span class="pre">300px</span></code></td>
<td>The height of each relationship table.</td>
</tr>
<tr class="row-odd"><td>tableClassName</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>Style classes of each relationship table.</td>
</tr>
<tr class="row-even"><td>specOptions</td>
<td>object</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>A mapping of relationship specific options.
Indexed by the relationship name. Each value
is also a mapping of possible properties of
<code class="xref py py-obj docutils literal"><span class="pre">RelationshipTable</span></code> component.</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="RelationshipTable.html" class="btn btn-neutral float-right" title="RelationshipTable" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="RelationshipFetcher.html" class="btn btn-neutral" title="RelationshipFetcher" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
