...
<head>
  ...
  <title>Dialog &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="InputDialog" href="InputDialog.html"/>
        <link rel="prev" title="ObjectDetails" href="ObjectDetails.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Dialog</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/Dialog.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-dialogs-dialog-dialog"></span><h1>Dialog<a class="headerlink" href="#dialog" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#dialog-sizes" id="id2">Dialog Sizes</a></li>
<li><a class="reference internal" href="#keyboard-control" id="id3">Keyboard Control</a></li>
<li><a class="reference internal" href="#react-properties" id="id4">React Properties</a></li>
</ul>
</li>
...
<p>This module provides the base dialog component, on which both stock dialogs
and custom dialogs are based.</p>
<div class="section" id="dialog-sizes">
<h3><a class="toc-backref" href="#id2">Dialog Sizes</a><a class="headerlink" href="#dialog-sizes" title="Permalink to this headline">¶</a></h3>
<p>Dialogs may either be resizable or fixed size. The properties <code class="docutils literal"><span class="pre">sizes</span></code> and
<code class="docutils literal"><span class="pre">size</span></code> (of which at most one should be specified), allow you to specify
either an <code class="docutils literal"><span class="pre">Immutable.Map</span></code> with all sizes possible for this dialog or one
size constant that represents the dialogs fixed size.</p>
<p>Available size values are:</p>
<ul class="simple">
<li><code class="docutils literal"><span class="pre">Dialog.SIZE_SMALL</span></code></li>
<li><code class="docutils literal"><span class="pre">Dialog.SIZE_MEDIUM</span></code></li>
<li><code class="docutils literal"><span class="pre">Dialog.SIZE_LARGE</span></code></li>
</ul>
<p>If different sizes are provided, a button will be displayed in the dialog’s
titlebar, which allows to toggle the possible sizes of the dialog.</p>
</div>
<div class="section" id="keyboard-control">
<h3><a class="toc-backref" href="#id3">Keyboard Control</a><a class="headerlink" href="#keyboard-control" title="Permalink to this headline">¶</a></h3>
<p>The Dialog Component defines two shortcuts it handles:</p>
<ul class="simple">
<li>When pressing Enter, the Function specified with the property <code class="docutils literal"><span class="pre">onAction</span></code> will be executed.
This should correspond to the action that is executed when the main button action of the
dialog will be executed.</li>
<li>When pressing Escape the Function specified with the property <code class="docutils literal"><span class="pre">onHide</span></code> will be executed.
This should correspond to the action when the user presses a Cancel or Close Button.</li>
</ul>
</div>
<div class="section" id="react-properties">
<h3><a class="toc-backref" href="#id4">React Properties</a><a class="headerlink" href="#react-properties" title="Permalink to this headline">¶</a></h3>
...
<tbody valign="top">
<tr class="row-even"><td>buttons</td>
<td>node</td>
<td>-</td>
<td>The buttons displayed in the modals footer</td>
</tr>
<tr class="row-odd"><td>dialogClassName</td>
<td>string</td>
<td>-</td>
<td>Custom CSS Class attached to the modal</td>
</tr>
<tr class="row-even"><td>hideFooter</td>
<td>bool</td>
<td><code class="docutils literal"><span class="pre">false</span></code></td>
<td>Footer will not be displayed. Use this for
dialogs that will only display a cancel
button.</td>
</tr>
<tr class="row-odd"><td>fixedHeight</td>
<td>bool</td>
<td><code class="docutils literal"><span class="pre">false</span></code></td>
<td>If set, dialog will have a fixed height,
relative to screen height</td>
</tr>
<tr class="row-even"><td>onAction</td>
<td>func</td>
<td>-</td>
<td>Executed when the user presses Enter.</td>
</tr>
<tr class="row-odd"><td>onHide</td>
<td>func</td>
<td>-</td>
<td>Executed when the user presses the Close
button or Escape key.</td>
</tr>
<tr class="row-even"><td>size</td>
<td>DialogPropTypes.size</td>
<td>-</td>
<td>If set the dialog will be displayed in
this size and changing size is disabled.</td>
</tr>
<tr class="row-odd"><td>sizes</td>
<td>Immutable.list</td>
<td>All three sizes</td>
<td>The available sizes for the dialog.</td>
</tr>
<tr class="row-even"><td>show</td>
<td>bool</td>
<td><code class="docutils literal"><span class="pre">true</span></code></td>
<td>If set, the dialog will be displayed.</td>
</tr>
<tr class="row-odd"><td>showCancel</td>
<td>bool</td>
<td><code class="docutils literal"><span class="pre">false</span></code></td>
<td>If set, display a close button in the
header.</td>
</tr>
<tr class="row-even"><td>title</td>
<td>string</td>
<td>-</td>
<td>Title of the dialog, displayed in the
header</td>
</tr>
</tbody>
</table>
...
<div class="highlight-none"><div class="highlight"><pre><span></span>import {Dialog} from &#39;cs-web-components-base&#39;;
...
const SimpleDialog = props =&gt; (
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="InputDialog.html" class="btn btn-neutral float-right" title="InputDialog" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ObjectDetails.html" class="btn btn-neutral" title="ObjectDetails" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
