...
<head>
  ...
  <title>ColumnContent &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="Fixed" href="Fixed.html"/>
        <link rel="prev" title="RichTextEditor" href="RichTextEditor.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>ColumnContent</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/ColumnContent.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="columncontent">
<span id="cs-web-components-base-table-columncontent-columncontent"></span><h1>ColumnContent<a class="headerlink" href="#columncontent" title="Permalink to this headline">¶</a></h1>
...
<p>Default content renderer component used by ./Table.jsx.
+——————+————–+————–+———————————————+
| Property         | Type         | Default      | Use                                         |
+==================+==============+==============+=============================================+
| value            | any          | -            | Value of the content to be rendered. If     |
|                  |              |              | Value is a map that contains the key        |
|                  |              |              | <code class="docutils literal"><span class="pre">text</span></code> this text is taken as table        |
|                  |              |              | content. If value contains the key <code class="docutils literal"><span class="pre">link</span></code> |
|                  |              |              | the value of <code class="docutils literal"><span class="pre">link</span></code> is a map that has to  |
|                  |              |              | contain the key <code class="docutils literal"><span class="pre">to</span></code> and can contain the  |
|                  |              |              | key <code class="docutils literal"><span class="pre">title</span></code>. The content will be rendered |
|                  |              |              | as link for this case.                      |
|                  |              |              | If value contains the key <code class="docutils literal"><span class="pre">icon</span></code> the value|
|                  |              |              | of <code class="docutils literal"><span class="pre">icon</span></code> is a map that conatins either   |
|                  |              |              | <code class="docutils literal"><span class="pre">src</span></code> with the icon url or <code class="docutils literal"><span class="pre">name</span></code>. The  |
...
+——————+————–+————–+———————————————+</p>
<p>The <code class="docutils literal"><span class="pre">column</span></code> map might have this keys:</p>
<ul class="simple">
<li><code class="docutils literal"><span class="pre">getFormattedValue</span></code>: A function that gets the value and should return
the user representation of the value.</li>
<li><code class="docutils literal"><span class="pre">sortFunction</span></code>: A function that compares to values of the column. The
function will be called in the way <code class="xref py py-obj docutils literal"><span class="pre">cmp(v1,</span> <span class="pre">v2)</span></code> where v1 and v2  are
lists of two elements. The first element is the value to be compared. The
second contains all entries of the row where the value resides.</li>
<li><code class="docutils literal"><span class="pre">getLink</span></code>: A function that will be called with the value, row and column
as parameter and should return the url of the link.</li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Fixed.html" class="btn btn-neutral float-right" title="Fixed" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="RichTextEditor.html" class="btn btn-neutral" title="RichTextEditor" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
