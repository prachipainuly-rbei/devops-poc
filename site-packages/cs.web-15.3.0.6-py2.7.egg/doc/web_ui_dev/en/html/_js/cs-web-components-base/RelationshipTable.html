...
<head>
  ...
  <title>RelationshipTable &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="RelationshipTableConfig" href="RelationshipTableConfig.html"/>
        <link rel="prev" title="RelationshipGroup" href="RelationshipGroup.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>RelationshipTable</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/RelationshipTable.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-components-objectwidgets-relationshiptable-default"></span><h1>RelationshipTable<a class="headerlink" href="#relationshiptable" title="Permalink to this headline">¶</a></h1>
...
<p>A Control to show the result of a relationship navigation in a table.</p>
...
<td>Immutable.Map</td>
<td>-</td>
<td>The parent object of the relationship</td>
</tr>
<tr class="row-odd"><td>relshipName</td>
<td>string</td>
<td>undefined</td>
<td>The <span class="guilabel">Semantical Name</span>  of the
relationship as configured in the system</td>
</tr>
<tr class="row-even"><td>tableName</td>
<td>string</td>
<td>undefined</td>
<td>The name of the table that is used to
display the result. If the name is not
defined the system will use the table that
is configured for the given relationship</td>
</tr>
<tr class="row-odd"><td>singleSelection</td>
<td>bool</td>
<td>false</td>
<td>Allow only single or multi selection</td>
</tr>
<tr class="row-even"><td>height</td>
<td>string</td>
<td>-</td>
<td>Height of the control. If set to ‘auto’,
the table size will auto fit its rows.</td>
</tr>
<tr class="row-odd"><td>hideTableHeaderPanels</td>
<td>bool</td>
<td>false</td>
<td>If true, the feature panels over the
table would be turned off to save places.</td>
</tr>
<tr class="row-even"><td>tableClassName</td>
<td>string</td>
<td>-</td>
<td>Style classes of the table component.</td>
</tr>
<tr class="row-odd"><td>columnAggregator</td>
<td>object</td>
<td>-</td>
<td>Settings for an aggregation row.</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="RelationshipTableConfig.html" class="btn btn-neutral float-right" title="RelationshipTableConfig" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="RelationshipGroup.html" class="btn btn-neutral" title="RelationshipGroup" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
