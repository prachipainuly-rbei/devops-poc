...
<head>
  ...
  <title>Overlay-Constants &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="overlays/Controlled" href="Controlled.html"/>
        <link rel="prev" title="operations/sagas/operations" href="operations-23.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Overlay-Constants</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/constants-4.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="overlay-constants">
<span id="cs-web-components-base-overlays-constants-module"></span><h1>Overlay-Constants<a class="headerlink" href="#overlay-constants" title="Permalink to this headline">¶</a></h1>
...
<p>Constants for use with overlays.</p>
<p>These are exported as fields of
<a class="reference internal" href="index-11.html#cs-web-components-base-overlays-index-module"><span class="std std-ref">Overlays</span></a>.
Use them like:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>import {Overlays} from &#39;cs-web-components-base&#39;;
...
<p id="cs-web-components-base-overlays-constants-horizontalalignment"><strong>HorizontalAlignment</strong>: An enumeration for specifying horizontal alignment for
aligned/layouted overlays. Values are</p>
<ul class="simple">
<li><code class="docutils literal"><span class="pre">HorizontalAlignment.LEFT</span></code></li>
<li><code class="docutils literal"><span class="pre">HorizontalAlignment.RIGHT</span></code></li>
</ul>
<p id="cs-web-components-base-overlays-constants-horizontalalignmenttype"><strong>HorizontalAlignmentType</strong>: PropType for HorizontalAlignment property.</p>
<p id="cs-web-components-base-overlays-constants-verticalalignment"><strong>VerticalAlignment</strong>: An enumeration for specifying vertical alignment for
aligned/layouted overlays. Values are</p>
<ul class="simple">
<li><code class="docutils literal"><span class="pre">VerticalAlignment.BOTTOM</span></code></li>
<li><code class="docutils literal"><span class="pre">VerticalAlignment.TOP</span></code></li>
</ul>
<p id="cs-web-components-base-overlays-constants-verticalalignmenttype"><strong>VerticalAlignmentType</strong>: PropType for VerticalAlignment property.</p>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Controlled.html" class="btn btn-neutral float-right" title="overlays/Controlled" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="operations-23.html" class="btn btn-neutral" title="operations/sagas/operations" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
