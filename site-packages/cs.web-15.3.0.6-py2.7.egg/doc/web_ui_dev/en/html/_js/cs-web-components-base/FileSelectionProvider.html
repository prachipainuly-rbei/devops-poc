...
<head>
  ...
  <title>FileSelectionProvider &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="RelationshipFetcher" href="RelationshipFetcher.html"/>
        <link rel="prev" title="FileList" href="FileList.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>FileSelectionProvider</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/FileSelectionProvider.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="fileselectionprovider">
<span id="cs-web-components-base-components-objectwidgets-fileselectionprovider-default"></span><h1>FileSelectionProvider<a class="headerlink" href="#fileselectionprovider" title="Permalink to this headline">¶</a></h1>
...
<p>A convenience component, that wraps a <code class="xref py py-obj docutils literal"><span class="pre">Provider</span></code> useful for file selections
around its children. This provider supplies an <code class="xref py py-obj docutils literal"><span class="pre">onSelect</span></code> function and the
current <code class="xref py py-obj docutils literal"><span class="pre">selection</span></code> to any <code class="xref py py-obj docutils literal"><span class="pre">Listener</span></code> present in the wrapped children.
All props given to this component beside <code class="xref py py-obj docutils literal"><span class="pre">className</span></code> and <code class="xref py py-obj docutils literal"><span class="pre">channelName</span></code> will be
propagated to the children.</p>
...
<td>String</td>
<td>-</td>
<td>CSS class to use on the wrapper</td>
</tr>
<tr class="row-odd"><td>channelName</td>
<td>String</td>
<td>fileSelection</td>
<td>The name of the channel to use</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="RelationshipFetcher.html" class="btn btn-neutral float-right" title="RelationshipFetcher" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="FileList.html" class="btn btn-neutral" title="FileList" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
