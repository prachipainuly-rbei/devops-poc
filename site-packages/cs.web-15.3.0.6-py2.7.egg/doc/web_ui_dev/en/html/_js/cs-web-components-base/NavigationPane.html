...
<head>
  ...
  <title>NavigationPane &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="CDBTitleBarContent" href="TitleBar.html"/>
        <link rel="prev" title="ApplicationFrame" href="ApplicationFrame.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>NavigationPane</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/NavigationPane.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="navigationpane">
<span id="cs-web-components-base-components-pageframe-navigationpane-navigationpane"></span><h1>NavigationPane<a class="headerlink" href="#navigationpane" title="Permalink to this headline">¶</a></h1>
...
<p>The component that is usually displayed on the left side of
the CONTACT Elements Web UI.  This component shouldn’t be directly used, as
it is rendered as part of
<a class="reference internal" href="ApplicationFrame.html#cs-web-components-base-components-pageframe-applicationframe-applicationframe"><span class="std std-ref">ApplicationFrame</span></a>.</p>
...
<p><strong>ApplicationSidebar</strong>: This element represents the sidebar as a
whole. The <code class="docutils literal"><span class="pre">data-ce-state</span></code> allows to determine if the sidebar is
currently visible.</p>
<blockquote>
...
<td>Sidebar is expanded</td>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="TitleBar.html" class="btn btn-neutral float-right" title="CDBTitleBarContent" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ApplicationFrame.html" class="btn btn-neutral" title="ApplicationFrame" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
