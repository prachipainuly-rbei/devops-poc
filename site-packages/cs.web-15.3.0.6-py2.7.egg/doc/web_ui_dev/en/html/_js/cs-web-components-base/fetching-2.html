...
<head>
  ...
  <title>reducers/fetching &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="reducers/object-store" href="object-store.html"/>
        <link rel="prev" title="Overlays" href="index-11.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>reducers/fetching</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/fetching-2.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="reducers-fetching">
<span id="cs-web-components-base-reducers-fetching-module"></span><h1>reducers/fetching<a class="headerlink" href="#reducers-fetching" title="Permalink to this headline">¶</a></h1>
...
<p>This module  provides meta entities, such as
<a class="reference internal" href="#cs-web-components-base-reducers-fetching-errorsbyid"><span class="std std-ref">errorsById</span></a>,
that stores failed requests and
<a class="reference internal" href="#cs-web-components-base-reducers-fetching-fetchingbyid"><span class="std std-ref">fetchingById</span></a>,
which stores pending requests.</p>
</div>
...
<div class="section" id="errorsbyid">
<span id="cs-web-components-base-reducers-fetching-errorsbyid"></span><h4>errorsById<a class="headerlink" href="#errorsbyid" title="Permalink to this headline">¶</a></h4>
<p>Stores errors that occured during communication with the REST API by
the REST URL used.</p>
</div>
<div class="section" id="fetchingbyid">
<span id="cs-web-components-base-reducers-fetching-fetchingbyid"></span><h4>fetchingById<a class="headerlink" href="#fetchingbyid" title="Permalink to this headline">¶</a></h4>
<p>Stores the Promise associated with a pending requests
by the request URL. Completed or failed requests will
be removed from this store.</p>
</div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="object-store.html" class="btn btn-neutral float-right" title="reducers/object-store" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="index-11.html" class="btn btn-neutral" title="Overlays" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
