...
<head>
  ...
  <title>VerticalBlockLayout &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="BannerContainer" href="index-5.html"/>
        <link rel="prev" title="Bar" href="Tab-1.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>VerticalBlockLayout</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/VerticalBlockLayout.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="verticalblocklayout">
<span id="cs-web-components-base-layouts-verticalblocklayout-default"></span><h1>VerticalBlockLayout<a class="headerlink" href="#verticalblocklayout" title="Permalink to this headline">¶</a></h1>
...
<dl class="docutils">
<dt>Layout that renders 1, 2, or 3 vertical blocks and behaves as following:</dt>
<dd><ul class="first last simple">
<li>each of the children components will be rendered into a block</li>
<li>if there are more than 3 children components passed in, only the first three
ones get rendered</li>
<li>in case the height of this layout component changes, it will change the
height of the last block to fit in, and fix the heights of the other
blocks</li>
</ul>
</dd>
</dl>
<p>This component will hide the overflowed content and not show scrollbar.
...
and overflow.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="index-5.html" class="btn btn-neutral float-right" title="BannerContainer" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Tab-1.html" class="btn btn-neutral" title="Bar" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
