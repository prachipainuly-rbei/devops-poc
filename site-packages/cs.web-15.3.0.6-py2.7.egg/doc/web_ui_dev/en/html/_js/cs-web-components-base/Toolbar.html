...
<head>
  ...
  <title>Toolbar &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="cs-web-components-externals" href="../cs-web-components-externals/__package_index__.html"/>
        <link rel="prev" title="StructureTree" href="StructureTree.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Toolbar</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/Toolbar.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-tree-toolbar-toolbar"></span><h1>Toolbar<a class="headerlink" href="#toolbar" title="Permalink to this headline">¶</a></h1>
...
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="p">{</span>
  <span class="nx">type</span><span class="o">:</span> <span class="s2">&quot;search&quot;</span>
  <span class="nx">adapter</span><span class="o">:</span> <span class="nx">SearchAdapter</span> <span class="nx">instance</span>
  <span class="nx">mode</span><span class="o">:</span> <span class="nx">SEARCH_MODE_TYPE_AHEAD</span> <span class="o">||</span> <span class="nx">SEARCH_MODE_CONFIRM</span>
<span class="p">}</span>
</pre></div>
</div>
<p>Buttons:</p>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="p">{</span>
  ...
  <span class="nx">icon</span><span class="o">:</span> <span class="nx">string</span>
  <span class="nx">func</span><span class="o">:</span> <span class="kd">function</span>
<span class="p">}</span>

<span class="p">{</span>
  <span class="nx">type</span><span class="o">:</span> <span class="s2">&quot;button&quot;</span><span class="p">,</span>
  <span class="nx">icon</span><span class="o">:</span> <span class="s2">&quot;euro&quot;</span><span class="p">,</span>
  <span class="nx">func</span><span class="o">:</span> <span class="p">()</span> <span class="p">=&gt;</span> <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s2">&quot;Hello World&quot;</span><span class="p">)</span>
<span class="p">}</span>
</pre></div>
</div>
<p>Menu:</p>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="p">{</span>
  <span class="nx">type</span><span class="o">:</span> <span class="s2">&quot;menu&quot;</span>
  <span class="nx">icon</span><span class="o">:</span> <span class="nx">string</span>
  <span class="nx">conf</span><span class="o">:</span> <span class="p">[</span>
     <span class="p">{</span>
       <span class="nx">type</span><span class="o">:</span> <span class="s2">&quot;item&quot;</span>
       <span class="nx">icon</span><span class="o">:</span> <span class="nx">string</span>
...
<span class="p">}</span>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="../cs-web-components-externals/__package_index__.html" class="btn btn-neutral float-right" title="cs-web-components-externals" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="StructureTree.html" class="btn btn-neutral" title="StructureTree" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
