...
<head>
  ...
  <title>components/SVGIcon &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="components/TableWrapper" href="TableWrapper.html"/>
        <link rel="prev" title="components/StatusIcon" href="StatusIcon.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>components/SVGIcon</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/SVGIcon.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="components-svgicon">
<span id="cs-web-components-base-components-svgicon-module"></span><h1>components/SVGIcon<a class="headerlink" href="#components-svgicon" title="Permalink to this headline">¶</a></h1>
...
<p>The component display SVG icon in predefined sizes.</p>
...
<td>URL to load the icon</td>
</tr>
<tr class="row-even"><td>size</td>
<td>string</td>
<td>sm</td>
<td>Size of that image. Can be:
sm, md, lg</td>
</tr>
<tr class="row-odd"><td>fallbackSVG</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>URL to load the fallbackSVG</td>
</tr>
</tbody>
</table>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">If <code class="docutils literal"><span class="pre">src</span></code> is given, it will be used to load the icon. Otherwise the component tries
to generate the url for configured icon according to the <code class="docutils literal"><span class="pre">name</span></code>.
If <code class="docutils literal"><span class="pre">src</span></code> is not an SVG, the component renders <code class="docutils literal"><span class="pre">fallbackSVG</span></code>. If <code class="docutils literal"><span class="pre">fallbackSVG</span></code> is not given,
the component renders <code class="docutils literal"><span class="pre">src</span></code> as an image.</p>
</div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="TableWrapper.html" class="btn btn-neutral float-right" title="components/TableWrapper" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="StatusIcon.html" class="btn btn-neutral" title="components/StatusIcon" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
