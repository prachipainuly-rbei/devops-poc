...
<head>
  ...
  <title>Tree &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="tree/NodeRenderer" href="NodeRenderer.html"/>
        <link rel="prev" title="TileHelpers" href="TileHelpers.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Tree</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/index-25.rst.txt" rel="nofollow"> View page source</a>
...
<span id="cs-web-components-base-tree-index-module"></span><h1>Tree<a class="headerlink" href="#tree" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#ready-to-use-components" id="id2">Ready-To-Use Components</a></li>
<li><a class="reference internal" href="#creating-custom-tree-components" id="id3">Creating custom tree components</a></li>
</ul>
</li>
</ul>
</div>
...
<p>This module provides diverse components to generically render tree
widgets. The module provides ready-to-use components to display structure
and object data provided by the CONTACT Elements server (see
<a class="reference internal" href="#cs-web-components-base-tree-ready-to-use"><span class="std std-ref">Ready-To-Use Components</span></a>), as well as an API to create
custom tree components (see <a class="reference internal" href="#cs-web-components-base-tree-custom-trees"><span class="std std-ref">Creating custom tree components</span></a>).</p>
<div class="section" id="ready-to-use-components">
<span id="cs-web-components-base-tree-ready-to-use"></span><h3><a class="toc-backref" href="#id2">Ready-To-Use Components</a><a class="headerlink" href="#ready-to-use-components" title="Permalink to this headline">¶</a></h3>
<div class="toctree-wrapper compound">
</div>
<ul class="simple">
<li><a class="reference internal" href="StructureTree.html#cs-web-components-base-tree-structuretree-structuretree"><span class="std std-ref">StructureTree</span></a></li>
<li><a class="reference internal" href="RestTree.html#cs-web-components-base-tree-resttree-resttree"><span class="std std-ref">RestTree</span></a></li>
</ul>
</div>
<div class="section" id="creating-custom-tree-components">
<span id="cs-web-components-base-tree-custom-trees"></span><h3><a class="toc-backref" href="#id3">Creating custom tree components</a><a class="headerlink" href="#creating-custom-tree-components" title="Permalink to this headline">¶</a></h3>
<p>Custom trees are created based on the
<a class="reference internal" href="Tree.html#cs-web-components-base-tree-tree-module"><span class="std std-ref">tree/Tree</span></a> component. Details for
configuring this component can be taken from the components documentation.</p>
<ul class="simple">
<li><a class="reference internal" href="Tree.html#cs-web-components-base-tree-tree-module"><span class="std std-ref">tree/Tree</span></a></li>
<li><a class="reference internal" href="TreeFilter.html#cs-web-components-base-tree-treefilter-module"><span class="std std-ref">tree/TreeFilter</span></a></li>
<li><a class="reference internal" href="TreeContainer.html#cs-web-components-base-tree-treecontainer-module"><span class="std std-ref">tree/TreeContainer</span></a></li>
<li><a class="reference internal" href="TreeRenderer.html#cs-web-components-base-tree-treerenderer-module"><span class="std std-ref">tree/TreeRenderer</span></a></li>
<li><a class="reference internal" href="NodeRenderer.html#cs-web-components-base-tree-noderenderer-module"><span class="std std-ref">tree/NodeRenderer</span></a></li>
<li><a class="reference internal" href="SearchAdapter.html#cs-web-components-base-tree-searchadapter-module"><span class="std std-ref">tree/SearchAdapter</span></a></li>
</ul>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="NodeRenderer.html" class="btn btn-neutral float-right" title="tree/NodeRenderer" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="TileHelpers.html" class="btn btn-neutral" title="TileHelpers" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
