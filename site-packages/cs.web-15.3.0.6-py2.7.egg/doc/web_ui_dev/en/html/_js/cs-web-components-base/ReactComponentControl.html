...
<head>
  ...
  <title>ReactComponentControl &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="prev" title="Radio" href="Radio.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>ReactComponentControl</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/ReactComponentControl.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="reactcomponentcontrol">
<span id="cs-web-components-base-formcontrols-reactcomponentcontrol-default"></span><h1>ReactComponentControl<a class="headerlink" href="#reactcomponentcontrol" title="Permalink to this headline">¶</a></h1>
...
<p>The component <code class="docutils literal"><span class="pre">&lt;ReactComponentControl&gt;</span></code> allows custom controls. It has following properties:</p>
...
<td>The component that is used to render this
control. The following properties are
passed through: value, readOnly, label,
tooltip, contentType, onValueChange</td>
</tr>
...
<td>Control should be read only</td>
</tr>
...
<td>Tooltip of the control</td>
</tr>
<tr class="row-odd"><td>contentType</td>
<td>string</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>Content type of the value</td>
</tr>
...
<td>Line number from mask configuration</td>
</tr>
...
<td>Equivalent callback of <code class="xref py py-obj docutils literal"><span class="pre">onChange</span></code>, called</td>
</tr>
<tr class="row-even"><td>contextObjects</td>
<td>Immutable.list</td>
<td><ul class="first last simple">
<li></li>
</ul>
</td>
<td>List of context objects</td>
</tr>
<tr class="row-odd"><td>operationState</td>
<td>Immutable.map</td>
<td><ul class="first last simple">
<li></li>
</ul>
...
<td>Operation state</td>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="Slider.html" class="btn btn-neutral float-right" title="Slider" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="Radio.html" class="btn btn-neutral" title="Radio" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
