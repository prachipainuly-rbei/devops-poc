...
<head>
  ...
  <title>AlignedOverlay &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="Controlled" href="AlignedOverlay-1.html"/>
        <link rel="prev" title="BannerContainer" href="index-5.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>AlignedOverlay</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/AlignedOverlay.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="alignedoverlay">
<span id="cs-web-components-base-overlays-alignedoverlay-default"></span><h1>AlignedOverlay<a class="headerlink" href="#alignedoverlay" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#layout-function" id="id2">Layout Function</a></li>
<li><a class="reference internal" href="#children" id="id3">Children</a></li>
...
<p>Extended Overlay that handles layouting. A layouting function needs to be provided to
calculate the styling/positioning of the overlay. The overlay will then be positioned
in relation to the property <code class="docutils literal"><span class="pre">parentRef</span></code>. Exact positioning is determined by
<code class="docutils literal"><span class="pre">layoutFunc</span></code>.</p>
</div>
<div class="section" id="layout-function">
<h2><a class="toc-backref" href="#id2">Layout Function</a><a class="headerlink" href="#layout-function" title="Permalink to this headline">¶</a></h2>
<p>Functions provided as a layouting function to this component must accept the following
parameters:</p>
<ul class="simple">
<li><strong>layoutConfig</strong>: Parameters that depend on the layout function used</li>
<li><strong>horizontalAlign</strong>: The horizontal alignment of the overlay</li>
<li><strong>verticalAlign</strong>: The vertical alignment of the overlay</li>
<li><strong>parentRect</strong>: An object with the absolute position and the dimensions of the parent component.</li>
<li><strong>overlayRect</strong>: An object with the dimensions of the content of the overlay.</li>
</ul>
<p>The return value should be an object, containing at least properties <code class="docutils literal"><span class="pre">top</span></code> and <code class="docutils literal"><span class="pre">left</span></code>,
which specify the absolute position of the overlay in <code class="docutils literal"><span class="pre">document.body</span></code>. Since the return value
is passed as the element-style of the overlay diff, it is also possible to use CSS for advanced
options, like enabling scrolling.</p>
</div>
<div class="section" id="children">
<h2><a class="toc-backref" href="#id3">Children</a><a class="headerlink" href="#children" title="Permalink to this headline">¶</a></h2>
<p>As children a single element should be passed. This element will be rendered as the content
of the overlay.</p>
</div>
<div class="section" id="react-properties">
<h2><a class="toc-backref" href="#id4">React Properties</a><a class="headerlink" href="#react-properties" title="Permalink to this headline">¶</a></h2>
...
<tbody valign="top">
<tr class="row-even"><td>parentRef</td>
<td>element</td>
<td>The element to which the overlay will be
aligned.</td>
</tr>
<tr class="row-odd"><td>onBlur</td>
<td>function</td>
<td>Sets an <code class="docutils literal"><span class="pre">onBlur</span></code> handler on the overlay div
...
<tr class="row-even"><td>setOverlayRef</td>
<td>function</td>
<td>Callback to receive a reference to the overlay
DOM element, e.g., to request the focus, when
it is rendered.</td>
</tr>
<tr class="row-odd"><td>setContentRef</td>
<td>function</td>
<td>Callback to receive a reference to the content
of the overlay.</td>
</tr>
<tr class="row-even"><td>visible</td>
<td>boolean</td>
<td>The overlay is only rendered if this flag is
<code class="docutils literal"><span class="pre">true</span></code></td>
</tr>
<tr class="row-odd"><td>className</td>
<td>string</td>
<td>Append additional classes to the overlay’s
class attribute.</td>
</tr>
<tr class="row-even"><td>useTimer</td>
<td>boolean</td>
<td>If set, a timer will check for responsive
changes and trigger relayouting if necessary</td>
</tr>
<tr class="row-odd"><td>layoutFunc</td>
<td>function</td>
<td>A function that calculates the position/layout
of the overlay, based on its content, the
window dimensions and an optional container</td>
</tr>
<tr class="row-even"><td>horizontalAlign</td>
<td>HorizontalAlignmentType</td>
<td>The horizontal alignment of the component.
Will be passed as a parameter to the layout
function.</td>
</tr>
<tr class="row-odd"><td>verticalAlign</td>
<td>VerticalAlignmentType</td>
<td>The vertical alignment of the component.
Will be passed as a parameter to the layout
function.</td>
</tr>
</tbody>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="AlignedOverlay-1.html" class="btn btn-neutral float-right" title="Controlled" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="index-5.html" class="btn btn-neutral" title="BannerContainer" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
