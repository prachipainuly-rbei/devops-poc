...
<head>
  ...
  <title>ContentBlockGroup &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="ContentOperationToolbar" href="ContentOperationToolbar.html"/>
        <link rel="prev" title="ContentBlock" href="ContentBlock.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>ContentBlockGroup</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../../_sources/_js/cs-web-components-base/ContentBlockGroup.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="contentblockgroup">
<span id="cs-web-components-base-components-contentblockgroup-contentblockgroup"></span><h1>ContentBlockGroup<a class="headerlink" href="#contentblockgroup" title="Permalink to this headline">¶</a></h1>
<p>extends React.Component</p>
...
<li><a class="reference internal" href="#react-properties" id="id3">React Properties</a></li>
</ul>
</div>
...
<p>ContentBlockGroup can be used to group several <a class="reference internal" href="ContentBlock.html#cs-web-components-base-components-contentblock-default"><span class="std std-ref">ContentBlock</span></a>
instances. Grouping such elements will lead to an accordion like layout. All panels inside this layout group
can be expanded independently. The default expansion state of each component is defined due to its property (see
<a class="reference internal" href="ContentBlock.html#cs-web-components-base-components-contentblock-default"><span class="std std-ref">ContentBlock</span></a>).</p>
<div class="section" id="examples">
<h3><a class="toc-backref" href="#id2">Examples</a><a class="headerlink" href="#examples" title="Permalink to this headline">¶</a></h3>
<p>The ContentBlockGroup can be used to group <a class="reference internal" href="ContentBlock.html#cs-web-components-base-components-contentblock-default"><span class="std std-ref">ContentBlock</span></a>
or self defined components based on <a class="reference internal" href="ContentBlock.html#cs-web-components-base-components-contentblock-default"><span class="std std-ref">ContentBlock</span></a>.</p>
<div class="section" id="using-cs-web-components-base-components-contentblock-default">
<h4>Using <a class="reference internal" href="ContentBlock.html#cs-web-components-base-components-contentblock-default"><span class="std std-ref">ContentBlock</span></a><a class="headerlink" href="#using-cs-web-components-base-components-contentblock-default" title="Permalink to this headline">¶</a></h4>
<div class="highlight-none"><div class="highlight"><pre><span></span>&lt;ContentBlockGroup&gt;
   &lt;ContentBlock ...&gt;
      ...
   &lt;/ContentBlock&gt;
   &lt;ContentBlock ...&gt;
...
<div class="section" id="using-self-defined-components">
<h4>Using self defined components<a class="headerlink" href="#using-self-defined-components" title="Permalink to this headline">¶</a></h4>
<p>If using self defined components, these ones must return an element of type
<a class="reference internal" href="ContentBlock.html#cs-web-components-base-components-contentblock-default"><span class="std std-ref">ContentBlock</span></a>. If so, they can be embedded in ContentBlockGroup
as well.</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>&lt;ContentBlockGroup&gt;
   &lt;MyComponentX ... /&gt;
   &lt;MyComponentY ... /&gt;
...
<h2><a class="toc-backref" href="#id3">React Properties</a><a class="headerlink" href="#react-properties" title="Permalink to this headline">¶</a></h2>
...
<td>[components]</td>
<td>-</td>
<td>the child components of the ContentBlockGroup
(only
<a class="reference internal" href="ContentBlock.html#cs-web-components-base-components-contentblock-default"><span class="std std-ref">ContentBlock</span></a>
types are supported)</td>
</tr>
</tbody>
</table>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="ContentOperationToolbar.html" class="btn btn-neutral float-right" title="ContentOperationToolbar" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="ContentBlock.html" class="btn btn-neutral" title="ContentBlock" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
