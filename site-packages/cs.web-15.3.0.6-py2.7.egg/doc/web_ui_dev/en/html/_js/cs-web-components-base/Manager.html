...
<head>
  ...
  <title>table/Manager &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="../../index.html"/>
        ...
        <link rel="next" title="table/pagination/index" href="index-20.html"/>
        <link rel="prev" title="Table" href="index-19.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="../../web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>table/Manager</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../_sources/_js/cs-web-components-base/Manager.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="table-manager">
<span id="cs-web-components-base-table-manager-module"></span><h1>table/Manager<a class="headerlink" href="#table-manager" title="Permalink to this headline">¶</a></h1>
...
<li><a class="reference internal" href="#writing-custom-extensions" id="id2">Writing custom extensions</a></li>
</ul>
</li>
</ul>
</div>
...
<p>The Manager function is responsible for creating a table component based
on a set of options, that control the different features and controls of
this component.</p>
<p>The components used in specifying options are usually feature modules, that
...
<a class="reference internal" href="#cs-web-components-base-table-manager-sec-custom-ext"><span class="std std-ref">Writing custom extensions</span></a>.</p>
<p>options are provided as an Object that contains an entry for each type of
feature that may be activated. The different types for which feature components
may be specified are:</p>
<ul class="simple">
<li><strong>Table:</strong> The <strong>Table</strong> option allows to specify a React component that
overrides the default  table renderer component. The default component used
here is <a class="reference internal" href="Table.html#cs-web-components-base-table-table-module"><span class="std std-ref">table/Table</span></a>. Usually you do not
want to provide your own component here.</li>
<li><strong>providers:</strong> A list of <strong>Providers</strong>. These omponents alter the way in
which table data is rendered. Providers are HOCs which are instantiated in
reverse order in which they occur in the provided list, with <strong>Table</strong> as
the base component. As a result of this,. properties flow from the first
listed provider to the last, which finally passes it to the <strong>Table</strong>
component.</li>
<li><strong>columnActions:</strong></li>
<li><strong>toolbarButtons:</strong></li>
</ul>
<div class="section" id="writing-custom-extensions">
<span id="cs-web-components-base-table-manager-sec-custom-ext"></span><h3><a class="toc-backref" href="#id2">Writing custom extensions</a><a class="headerlink" href="#writing-custom-extensions" title="Permalink to this headline">¶</a></h3>
<p>A table feature such as
<a class="reference internal" href="index-22.html#cs-web-components-base-table-sortable-index-module"><span class="std std-ref">table/sortable/index</span></a> is usually provided
as a module which exports the different options provided to realize the
feature, such as column actions or a provider.</p>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="index-20.html" class="btn btn-neutral float-right" title="table/pagination/index" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="index-19.html" class="btn btn-neutral" title="Table" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
