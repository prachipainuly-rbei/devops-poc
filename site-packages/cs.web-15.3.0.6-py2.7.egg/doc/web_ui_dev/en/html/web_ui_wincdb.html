...
<head>
  ...
  <title>Embedded Web Applications &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="index.html"/>
        <link rel="next" title="Recently Used Objects" href="web_ui_history.html"/>
        <link rel="prev" title="Examples" href="web_ui_operations_examples.html"/> 
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Embedded Web Applications</a><ul>
<li class="toctree-l2"><a class="reference internal" href="#handling-modifications-in-embedded-web-applications">Handling Modifications in Embedded Web Applications</a></li>
</ul>
</li>
...
<li class="toctree-l1"><a class="reference internal" href="web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Embedded Web Applications</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/web_ui_wincdb.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="embedded-web-applications">
<span id="wincdb-webui"></span><h1>Embedded Web Applications<a class="headerlink" href="#embedded-web-applications" title="Permalink to this headline">¶</a></h1>
<p>Web applications may be used in the context of the desktop
...
how it can be improved by application developers.</p>
<div class="section" id="handling-modifications-in-embedded-web-applications">
<h2>Handling Modifications in Embedded Web Applications<a class="headerlink" href="#handling-modifications-in-embedded-web-applications" title="Permalink to this headline">¶</a></h2>
<p>Embedding web applications as ELinkControls in dialogs allows the user
to modify data. If, however, the dialog is closed or reloaded, all
changes that are not persisted get lost.</p>
<p>The behaviour of the desktop client is to notify the user of such
...
modify data, the custom code needs to signal ongoing modifications.</p>
<p>This is achieved by dispatching into the Redux store
<code class="docutils literal"><span class="pre">modifications</span></code>.  Let’s look at a simple example of a component that
changes its modification state:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span> import React from &#39;react&#39;;
...
<p>The component <code class="docutils literal"><span class="pre">ModificationDemo</span></code> provides a simple checkbox which
...
connecting to the store.</p>
<p>Note that a component must actively reset its modification state if
changes are discarded or persisted.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="web_ui_history.html" class="btn btn-neutral float-right" title="Recently Used Objects" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="web_ui_operations_examples.html" class="btn btn-neutral" title="Examples" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
