...
<head>
  ...
  <title>Web UI Development &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="#"/>
        <link rel="next" title="Web UI technical background" href="web_ui_technical.html"/> 
  ...
  <div class="wy-grid-for-nav">
    ...
    <nav data-toggle="wy-nav-shift" class="wy-nav-side">
      <div class="wy-side-nav-search">
          ...
          <a href="#" class="icon icon-home"> Web UI Development
...
<li class="toctree-l1"><a class="reference internal" href="web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <div class="section" id="web-ui-development">
<span id="web-ui-dev"></span><h1>Web UI Development<a class="headerlink" href="#web-ui-development" title="Permalink to this headline">¶</a></h1>
<p>This document describes the libraries, tools and mechanisms provided by
CONTACT Elements to create web applications running in a web browser. They are used
by CONTACT Software to develop solutions, but are also available to customers and
3rd party developers.</p>
<div class="section" id="concepts">
<h2>Concepts<a class="headerlink" href="#concepts" title="Permalink to this headline">¶</a></h2>
<p>The CONTACT Elements Web UI consists of applications, components that are used to
assemble applications, and tools to build both of these. In more detail, the
Web UI provides</p>
<ul class="simple">
<li>A generic UI running in a web browser.</li>
<li>Components that implement generally useful functionality for CONTACT Elements
applications.</li>
<li>Methods to configure applications. This applies not only to the configuration
of single components, but also to the assembly of applications out of these
components.</li>
<li>Tools, guidelines and templates for the development of components and
applications.</li>
<li>Backwards compatibility with the native client: re-use of existing UI
configuration (dialogs, tables, catalogs etc.) in web applications.</li>
</ul>
...
<li class="toctree-l1"><a class="reference internal" href="web_ui_dev_glossary.html">Glossary</a></li>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="web_ui_technical.html" class="btn btn-neutral float-right" title="Web UI technical background" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
