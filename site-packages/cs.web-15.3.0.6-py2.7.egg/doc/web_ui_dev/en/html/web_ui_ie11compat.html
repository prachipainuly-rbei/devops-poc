...
<head>
  ...
  <title>Text Input in Internet Explorer 11 &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="index.html"/>
        <link rel="up" title="App Development References" href="web_ui_jsdoc.html"/>
        <link rel="next" title="Conflicting Properties in configured Components" href="web_ui_property_conflict.html"/>
        <link rel="prev" title="The BaseApp Morepath application" href="base_app.html"/> 
...
<li class="toctree-l2 current"><a class="reference internal" href="web_ui_jsdoc.html#known-problems">Known Problems</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Text Input in Internet Explorer 11</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/web_ui_ie11compat.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="text-input-in-internet-explorer-11">
<span id="cs-web-components-base-web-ui-ie11compat"></span><h1>Text Input in Internet Explorer 11<a class="headerlink" href="#text-input-in-internet-explorer-11" title="Permalink to this headline">¶</a></h1>
<p>Due to a bug in the key handling for text fields in Internet Explorer
11, the input of text fields may become corrupted. The issue is
explained in <code class="xref py py-obj docutils literal"><span class="pre">Issue</span> <span class="pre">7027</span></code>
of the React project.</p>
<p>If the components state is update in parallel to a change to a text
...
overwritten with old data.</p>
<p>As a workaround it is necessary to synchronize state changes that are
...
look as follows:</p>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">onValueChange</span><span class="p">(</span><span class="nx">newValue</span><span class="p">)</span> <span class="p">{</span>
   <span class="nx">setState</span><span class="p">(</span>
       <span class="p">{</span><span class="nx">value</span><span class="o">:</span> <span class="nx">newValue</span><span class="p">},</span>
       <span class="p">()</span> <span class="p">=&gt;</span> <span class="nx">doAsynchronousStateChange</span><span class="p">()</span>
   <span class="p">);</span>
<span class="p">}</span>

<span class="nx">render</span><span class="p">()</span> <span class="p">{</span>
   <span class="k">return</span> <span class="p">(</span>
      <span class="o">&lt;</span><span class="nx">TextInput</span> <span class="nx">onValueChange</span><span class="o">=</span><span class="p">{</span><span class="k">this</span><span class="p">.</span><span class="nx">onValueChange</span><span class="p">}</span>
...
<span class="p">}</span>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="web_ui_property_conflict.html" class="btn btn-neutral float-right" title="Conflicting Properties in configured Components" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="base_app.html" class="btn btn-neutral" title="The BaseApp Morepath application" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
