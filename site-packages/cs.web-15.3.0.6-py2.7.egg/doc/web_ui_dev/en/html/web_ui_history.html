...
<head>
  ...
  <title>Recently Used Objects &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="index.html"/>
        <link rel="next" title="Frontend Plugins" href="web_ui_plugins.html"/>
        <link rel="prev" title="Embedded Web Applications" href="web_ui_wincdb.html"/> 
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Recently Used Objects</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Recently Used Objects</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/web_ui_history.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="recently-used-objects">
<span id="web-ui-history"></span><h1>Recently Used Objects<a class="headerlink" href="#recently-used-objects" title="Permalink to this headline">¶</a></h1>
<p>The system provides a REST call to store objects that have been recently used
...
<span class="menuselection">Administration/Configuration ‣ Configuration ‣ User interface
‣ Web UI ‣ User Settings/Data ‣ Recently Used</span> in the navigation menu.</p>
<p>There are 2 <span class="guilabel">Default Dettings</span> that change the behaviour of <span class="guilabel">Recently Used</span>.
The setting <code class="docutils literal"><span class="pre">csweb.max_history_objs</span></code> defines the maximum number
of <span class="guilabel">Recently Used</span> entries for each user. The setting <code class="docutils literal"><span class="pre">csweb.history_objs_per_class</span></code>
defines the number of <span class="guilabel">Recently Used</span> entries per class.</p>
<p>The standard settings allow the user to overwrite these entries using the
<span class="guilabel">Personal Settings</span> operation.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="web_ui_plugins.html" class="btn btn-neutral float-right" title="Frontend Plugins" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="web_ui_wincdb.html" class="btn btn-neutral" title="Embedded Web Applications" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
