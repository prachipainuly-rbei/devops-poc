...
<head>
  ...
  <title>Broadcast &mdash; Web UI Development</title>
...
<li class="toctree-l1"><a class="reference internal" href="web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Broadcast</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/web_ui_dev_broadcast.rst.txt" rel="nofollow"> View page source</a>
  ...
  <p id="web-ui-dev-broadcast"><em>CONCEPT ONLY, WIP</em></p>
...
<ul class="simple">
<li>One global data object<ul>
<li>separation of data object into “namespaces”</li>
</ul>
</li>
<li>Values overwritable inside the hierarchy</li>
<li>independent of shouldComponentUpdate()</li>
<li>rerendering on update of relevant data object keys</li>
<li>implicit propagation to children using React context</li>
</ul>
</div>
<div class="section" id="architecture">
<h2>Architecture<a class="headerlink" href="#architecture" title="Permalink to this headline">¶</a></h2>
<div class="section" id="example-hierarchy">
<h3>Example Hierarchy<a class="headerlink" href="#example-hierarchy" title="Permalink to this headline">¶</a></h3>
<div class="highlight-none"><div class="highlight"><pre><span></span>&lt;App&gt; /* context = Immutable.Map() */
...
<ul class="simple">
<li>creates / overrides data objects</li>
<li>“Listener” at the same time</li>
<li><strong>NO</strong> shouldComponentUpdate. Check in willReceiveProps and Listener</li>
<li>overrides “register callback” for children to be notified of listeners</li>
</ul>
</div>
<div class="section" id="listener">
<h3>Listener<a class="headerlink" href="#listener" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li>Mapping namespace and keys (in data object) -&gt; props</li>
<li>register callback is stored in react context</li>
<li>initial values retrieved by calling register callback</li>
<li>unregister on unmount</li>
<li>local state for updates / rerendering</li>
</ul>
</div>
</div>
...
<ul class="simple">
<li>Immutable Map as data structure<ul>
<li>Nested Maps using keypaths</li>
</ul>
</li>
<li>NO HoCs</li>
<li>Update merging using Immutable equality<ul>
<li>setState and rerending only on relevant changes</li>
<li>Example:</li>
</ul>
</li>
</ul>
<div class="highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">nextState</span> <span class="o">=</span> <span class="nx">currentState</span><span class="p">.</span><span class="nx">merge</span><span class="p">(</span><span class="nx">parentState</span><span class="p">.</span><span class="nx">merge</span><span class="p">(</span><span class="nx">overrides</span><span class="p">));</span>
<span class="k">if</span><span class="p">(</span><span class="nx">nextState</span> <span class="o">!==</span> <span class="nx">currentState</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">setState</span><span class="p">({...});</span>
</pre></div>
</div>
<ul class="simple">
<li>empty “root data object” starting at the root of the hierarchy</li>
</ul>
</div>
</div>
