...
<head>
  ...
  <title>Internationalization &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="index.html"/>
        <link rel="up" title="Implementing Web Applications" href="web_ui_app_impl_tut.html"/>
        <link rel="next" title="Customizing BaseApp" href="web_ui_app_impl_tut_customize.html"/>
        <link rel="prev" title="Frontend-specific tasks" href="web_ui_app_impl_tut_frontend.html"/> 
...
<li class="toctree-l1 current"><a class="reference internal" href="web_ui_app_impl_tut.html">Implementing Web Applications</a><ul class="current">
...
<li class="toctree-l1"><a class="reference internal" href="web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    <li><a href="index.html">Docs</a> &raquo;</li>
          ...
          <li><a href="web_ui_app_impl_tut.html">Implementing Web Applications</a> &raquo;</li>
      
    <li>Internationalization</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/web_ui_app_impl_tut_i18n.rst.txt" rel="nofollow"> View page source</a>
...
<span id="web-ui-app-impl-tut-i18n"></span><h1>Internationalization<a class="headerlink" href="#internationalization" title="Permalink to this headline">¶</a></h1>
<p>Internationalization is based on labels configured in CONTACT Elements. The labels
that can be used by the Web UI must have labels ids that consist of three parts,
separated by <code class="docutils literal"><span class="pre">.</span></code>. The parts are:</p>
<ul class="simple">
<li>The constant <code class="docutils literal"><span class="pre">web</span></code>, as a marker that the label should be made available to
the frontend.</li>
<li>A domain id, that serves as a namespace to separate labels for different
applications.</li>
<li>The actual label id used by the frontend.</li>
</ul>
<div class="section" id="using-localized-strings">
<h2>Using localized strings<a class="headerlink" href="#using-localized-strings" title="Permalink to this headline">¶</a></h2>
<p class="rubric">i18n helpers</p>
<p>The following code can be used to create i18n helpers, that contain the domain
for the current JavaScript library as default. The method described in
<a class="reference internal" href="web_ui_make_create.html#web-ui-age-create"><span class="std std-ref">Creating an application template</span></a> generates this code into a file named <code class="file docutils literal"><span class="pre">i18n.js</span></code>.</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>import {i18ndb} from &#39;cs-web-components-base&#39;;

export const Format = i18ndb.makeFormat(&#39;my-domain&#39;);
export const formatStr = i18ndb.makeFormatStr(&#39;my-domain&#39;);
</pre></div>
</div>
<p class="rubric">Using the i18n helpers</p>
<p>The following example renders the same label twice, once by getting the string
to render, and once through a React component. The React component has an optional
property <code class="docutils literal"><span class="pre">domainId</span></code>, that can be set to access labels from other domains.</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>import {Format, formatStr} from &#39;./i18n.js&#39;;
...
<p class="rubric">Localized strings without helpers</p>
<p>To access localized string from other domains, the function <code class="docutils literal"><span class="pre">formatString</span></code>
allows to supply the domain as a parameter:</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>import {i18ndb} from &#39;cs-web-components-base&#39;;
...
function MyComponent(props) {
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="web_ui_app_impl_tut_customize.html" class="btn btn-neutral float-right" title="Customizing BaseApp" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="web_ui_app_impl_tut_frontend.html" class="btn btn-neutral" title="Frontend-specific tasks" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
