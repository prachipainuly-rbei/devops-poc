...
<head>
  ...
  <title>Web UI Operation Config &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="index.html"/>
        ...
        <link rel="next" title="Dialog Hooks" href="web_ui_operations_hooks.html"/>
        <link rel="prev" title="Kernel operations and the Web UI" href="web_ui_operations.html"/> 
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Web UI Operation Config</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Web UI Operation Config</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/web_ui_operations_config.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="web-ui-operation-config">
<span id="operations-webui-activation"></span><span id="helpid-cs-operations-webui"></span><h1>Web UI Operation Config<a class="headerlink" href="#web-ui-operation-config" title="Permalink to this headline">¶</a></h1>
<p>Some components, e.g.
...
run kernel operations in a way similar to the Windows client. Because of
some <a class="reference internal" href="web_ui_operations_restrictions.html#operations-webui-restrictions"><span class="std std-ref">restrictions</span></a> you have to activate
...
behaviour. The configuration resides in the register <span class="guilabel">Web UI</span> of
the standard operation configuration.</p>
<p>The register has these members:</p>
<ul class="simple">
<li><span class="guilabel">Available with Web UI</span>: If you want to use the operation you have to
...
delete the configuration object instead.</li>
<li><span class="guilabel">Essential/Frequently used</span>: A hint for the implementation of the
UI. Operations that have been marked this way might be displayed more prominently,
e.g. with an extra button in a title bar.</li>
<li><span class="guilabel">Prefer classic UI with hybrid client</span>: A hint that the
Windows client should handle the execution of the operation if possible.</li>
<li><span class="guilabel">Presentation ID</span>: The ID of a component that is able to render the
form of the form based operation. See section <a class="reference internal" href="#operations-presentation-ids"><span class="std std-ref">Presentation IDs</span></a>.</li>
<li><span class="guilabel">Mask name</span>: Allows you to set a dialog for the
...
optimized forms for displaying in a web context.</li>
</ul>
<div class="section" id="presentation-ids">
<span id="operations-presentation-ids"></span><h2>Presentation IDs<a class="headerlink" href="#presentation-ids" title="Permalink to this headline">¶</a></h2>
<p>This field defines a default way of how the operation should present
...
the value <code class="docutils literal"><span class="pre">modal</span></code> should be appropriate, you may want to learn about
the possible options. Sensible default values for this field are:</p>
<ul class="simple">
<li><code class="docutils literal"><span class="pre">modal</span></code>: if the operation displays a configured form to the user,
it will be displayed in a modal dialog, disabling interaction with
the rest of the user interface.</li>
<li><code class="docutils literal"><span class="pre">navigate-new-tab</span></code>: the operation’s result will be displayed in a
new tab.</li>
<li><code class="docutils literal"><span class="pre">no-form</span></code>: the display of a form will be supressed, even if one is
...
may interfere with certain features like execution of wizard logic.</li>
<li><code class="docutils literal"><span class="pre">delete</span></code>: Special case for <code class="docutils literal"><span class="pre">CDB_Delete</span></code>: the display of a form
...
operation will be executed.</li>
</ul>
<p>Note that usually the <code class="docutils literal"><span class="pre">no-form</span></code> option will usually not be
necessary, since the operation execution will skip the <code class="docutils literal"><span class="pre">Show</span> <span class="pre">Dialog</span></code>
stage, if the operations form contains no registers.</p>
<p>You may enter different values into the field, if your application
provides special operation handlers (see
<a class="reference internal" href="web_ui_operations_ui.html#operations-frontend-execution"><span class="std std-ref">Executing operations</span></a>), which you want your operations
to use. Note, that if a presentation id is not set in the current
scope, it will behave as if the <code class="docutils literal"><span class="pre">modal</span></code> option has been set.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="web_ui_operations_hooks.html" class="btn btn-neutral float-right" title="Dialog Hooks" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="web_ui_operations.html" class="btn btn-neutral" title="Kernel operations and the Web UI" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
