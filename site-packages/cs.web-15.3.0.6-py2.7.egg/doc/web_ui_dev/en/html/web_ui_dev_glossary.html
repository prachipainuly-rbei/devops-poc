...
<head>
  ...
  <title>Glossary &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="index.html"/>
        <link rel="prev" title="cs-web-search" href="_js/cs-web-search/__package_index__.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Glossary</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/web_ui_dev_glossary.rst.txt" rel="nofollow"> View page source</a>
...
<span id="web-ui-glossary"></span><h1>Glossary<a class="headerlink" href="#glossary" title="Permalink to this headline">¶</a></h1>
<dl class="glossary docutils">
<dt id="term-resource">Resource</dt>
<dd>A single file that is accessible from the frontend through an HTTP request.
Typically JavaScript, CSS, image files etc.</dd>
<dt id="term-library">Library</dt>
<dd>A set of resources that are used together. Libraries have a name and a
version, and possibly dependencies on other libraries.</dd>
<dt id="term-component">Component</dt>
<dd>A named artifact in JavaScript code, mostly used for React components.
Components are contained in libraries. They can use other components, and so
imply a dependency between the corresponding libraries.</dd>
<dt id="term-application">Application<dt id="term-web-application">Web Application</dt>
<dd>From a users perspective, this is an HTML page visible through a web
...
the JavaScript libraries that are loaded by this document.</dd>
<dt id="term-jsx">JSX</dt>
<dd>A JavaScript extension that is used to implement React components.</dd>
<dt id="term-hoc">HOC<dt id="term-higher-order-component">Higher Order Component</dt>
<dd><p class="first">A Higher Order Component is a function that takes a React Component as
parameter and returns a React Component. A generic signature is</p>
<div class="last highlight-javascript"><div class="highlight"><pre><span></span><span class="nx">hoc</span><span class="p">(</span><span class="nx">component</span><span class="o">:</span> <span class="nx">ReactComponent</span><span class="p">)</span><span class="o">:</span> <span class="nx">ReactComponent</span>
</pre></div>
</div>
</dd>
</dl>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="_js/cs-web-search/__package_index__.html" class="btn btn-neutral" title="cs-web-search" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
