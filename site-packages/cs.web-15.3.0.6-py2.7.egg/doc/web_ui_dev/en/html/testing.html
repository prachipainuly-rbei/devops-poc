...
<head>
  ...
  <title>Testing cs.web Web Applications &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="index.html"/>
        <link rel="next" title="App Development References" href="web_ui_jsdoc.html"/>
        <link rel="prev" title="Customizing BaseApp" href="web_ui_app_impl_tut_customize.html"/> 
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Testing cs.web Web Applications</a><ul>
<li class="toctree-l2"><a class="reference internal" href="#testing-with-selenium">Testing with Selenium</a></li>
</ul>
</li>
...
<li class="toctree-l1"><a class="reference internal" href="web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Testing cs.web Web Applications</li>
  ...
  <div class="section" id="testing-cs-web-web-applications">
<h1>Testing cs.web Web Applications<a class="headerlink" href="#testing-cs-web-web-applications" title="Permalink to this headline">¶</a></h1>
<div class="section" id="testing-with-selenium">
<span id="testing-selenium-modal"></span><h2>Testing with Selenium<a class="headerlink" href="#testing-with-selenium" title="Permalink to this headline">¶</a></h2>
<p>Frontend Tests can be implemented using the Selenium Framework for
Browser Automation (c.f. <a class="reference external" href="http://www.seleniumhq.org/">http://www.seleniumhq.org/</a>). <code class="docutils literal"><span class="pre">cs.web</span></code>
provides several utilities to ease this task.</p>
<p>If testing of an application is already planned upon creation of the
application, <code class="docutils literal"><span class="pre">webmake</span> <span class="pre">create</span></code> can be invoked with the parameter
<code class="docutils literal"><span class="pre">--templates</span> <span class="pre">tests</span></code>, which will create a template in
<code class="docutils literal"><span class="pre">tests/test_main.py</span></code></p>
<div class="section" id="testing-selenium-properties">
<span id="identifying-cs-web-components-using-selenium"></span><h3>Identifying <code class="docutils literal"><span class="pre">cs.web</span></code> components using Selenium<a class="headerlink" href="#testing-selenium-properties" title="Permalink to this headline">¶</a></h3>
<p>In order to run tests based on Browser-Automation with the Selenium
...
be collapsed or expanded) in order to interact with them.</p>
<p>The UI components provided by <code class="docutils literal"><span class="pre">cs.web</span></code> provide the attributes
<code class="docutils literal"><span class="pre">data-ce-id</span></code> and <code class="docutils literal"><span class="pre">data-ce-state</span></code>, which can be used to query the
DOM.</p>
<p>When subclassing <code class="docutils literal"><span class="pre">cs.web.automation.WebTest</span></code> it is easy to
interact with elements using these attributes.</p>
<div class="highlight-python"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">WebTest</span><span class="p">(</span><span class="o">...</span><span class="p">):</span>
    <span class="k">def</span> <span class="nf">get_ce_element</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">elements_id</span><span class="p">,</span> <span class="n">parent</span><span class="o">=</span><span class="bp">None</span><span class="p">):</span>
        <span class="k">return</span> <span class="n">CeElement</span><span class="p">(</span><span class="o">...</span><span class="p">)</span>

<span class="k">class</span> <span class="nc">CeElement</span><span class="p">(</span><span class="o">...</span><span class="p">):</span>
    <span class="k">def</span> <span class="nf">get_ce_state</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="k">return</span> <span class="o">...</span>
</pre></div>
</div>
<p>The following code opens the sidebar and waits for the animation to
finish:</p>
<div class="highlight-python"><div class="highlight"><pre><span></span><span class="n">sidebar_element</span> <span class="o">=</span> <span class="n">web_test</span><span class="o">.</span><span class="n">get_ce_element</span><span class="p">(</span><span class="s1">&#39;ApplicationSidebar&#39;</span><span class="p">)</span>
<span class="k">if</span> <span class="n">sidebar_element</span><span class="o">.</span><span class="n">get_ce_state</span><span class="p">()</span> <span class="o">==</span> <span class="s1">&#39;collapsed&#39;</span><span class="p">:</span>
    <span class="n">burger_element</span> <span class="o">=</span> <span class="n">web_test</span><span class="o">.</span><span class="n">get_ce_element</span><span class="p">(</span><span class="s1">&#39;Burger&#39;</span><span class="p">)</span>
    <span class="n">burger_element</span><span class="o">.</span><span class="n">click</span><span class="p">()</span>
</pre></div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="web_ui_jsdoc.html" class="btn btn-neutral float-right" title="App Development References" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="web_ui_app_impl_tut_customize.html" class="btn btn-neutral" title="Customizing BaseApp" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
