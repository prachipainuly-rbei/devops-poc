...
<head>
  ...
  <title>Examples &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="index.html"/>
        ...
        <link rel="next" title="Embedded Web Applications" href="web_ui_wincdb.html"/>
        <link rel="prev" title="Integrating Operation Handling into User Interfaces" href="web_ui_operations_ui.html"/> 
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Examples</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/web_ui_operations_examples.rst.txt" rel="nofollow"> View page source</a>
...
<p>Since your web application contains an operation scope and two
...
e.g. a button that will call startOperation in its <code class="docutils literal"><span class="pre">onClick</span></code>-handler.</p>
<div class="section" id="simply-triggering-an-operation">
<h2>Simply Triggering an Operation<a class="headerlink" href="#simply-triggering-an-operation" title="Permalink to this headline">¶</a></h2>
<div class="highlight-none"><div class="highlight"><pre><span></span>import ImmutablePropTypes from &#39;cs-web-components-externals&#39;;
...
<p>The button-component defined above may be instantiated with an operation,
e.g., provided by
...
and a <code class="docutils literal"><span class="pre">contextObject</span></code>, on which the operation is executed.</p>
<div class="highlight-none"><div class="highlight"><pre><span></span>class MyComponent extends React.Component {
    constructor(props) {
       super(props);
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="web_ui_wincdb.html" class="btn btn-neutral float-right" title="Embedded Web Applications" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="web_ui_operations_ui.html" class="btn btn-neutral" title="Integrating Operation Handling into User Interfaces" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
