...
<head>
  ...
  <title>Conflicting Properties in configured Components &mdash; Web UI Development</title>
    ...
    <link rel="top" title="Web UI Development" href="index.html"/>
        ...
        <link rel="next" title="Index" href="_js/toctree.html"/>
        <link rel="prev" title="Text Input in Internet Explorer 11" href="web_ui_ie11compat.html"/> 
...
<li class="toctree-l1"><a class="reference internal" href="web_ui_dev_glossary.html">Glossary</a></li>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Conflicting Properties in configured Components</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/web_ui_property_conflict.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="conflicting-properties-in-configured-components">
<span id="cs-web-components-base-web-ui-property-conflict"></span><h1>Conflicting Properties in configured Components<a class="headerlink" href="#conflicting-properties-in-configured-components" title="Permalink to this headline">¶</a></h1>
<p>Note that when developing applications using the json-based
configuration for pages, the components that are directly configured
into the site are automatically provided with several properties,
e.g. from <code class="docutils literal"><span class="pre">react-router</span></code> or the <code class="docutils literal"><span class="pre">contextObject</span></code> property. These
properties may clash with locally defined properties that are not
specified for the components. If properties are passed down via the
Spread-Operator, even components further down in the component
hierarchy may be affected. If you experience unusual behaviour due to
properties having unexpected value, you should have a look at the
properties passed to your components from the configuration framework.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="_js/toctree.html" class="btn btn-neutral float-right" title="Index" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="web_ui_ie11compat.html" class="btn btn-neutral" title="Text Input in Internet Explorer 11" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
