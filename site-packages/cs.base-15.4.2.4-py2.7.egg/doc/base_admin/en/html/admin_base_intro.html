...
<head>
  ...
  <title>Introduction &mdash; Basics</title>
    ...
    <link rel="top" title="Basics" href="index.html"/>
        <link rel="next" title="Calendar" href="admin_calendar.html"/>
...
<span id="admin-base-intro"></span><h1>Introduction<a class="headerlink" href="#einleitung" title="Permalink to this headline">¶</a></h1>
<p id="base-teaser"><em>CONTACT Basics</em> provides carefully selected cross-application functions such as calendars, currencies, batch operations, semantic links and the Audit Trail.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="admin_calendar.html" class="btn btn-neutral float-right" title="Calendar" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
