...
<head>
  ...
  <title>Einleitung &mdash; Basics</title>
    ...
    <link rel="top" title="Basics" href="index.html"/>
        <link rel="next" title="Kalender" href="admin_calendar.html"/>
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Einleitung</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/admin_base_intro.rst.txt" rel="nofollow"> View page source</a>
...
<span id="admin-base-intro"></span><h1>Einleitung<a class="headerlink" href="#einleitung" title="Link zu dieser Überschrift">¶</a></h1>
<p id="base-teaser"><em>CONTACT Basics</em> stellt ausgewählte anwendungsübergreifende Querschnittsfunktionen wie Kalender, Währungen, Sammeloperationen, semantische Verknüpfungen und den Audit Trail zur Verfügung.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="admin_calendar.html" class="btn btn-neutral float-right" title="Kalender" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
